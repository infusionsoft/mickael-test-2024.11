...
namespace Keap.Sdk.Core.Api
{
    ...
    public partial class CompanyApi : ICompanyApi
    {
        ...
        public Keap.Sdk.Core.Client.ApiResponse<Company> PatchCompanyUsingPATCHWithHttpInfo(string companyId, List<string>? updateMask = default(List<string>?), PatchCompanyRequest? patchCompanyRequest = default(PatchCompanyRequest?), int operationIndex = 0)
        {
            ...
            if (companyId == null)
            {
                throw new Keap.Sdk.Core.Client.ApiException(400, "Missing required parameter 'companyId' when calling CompanyApi->PatchCompanyUsingPATCH");
            }
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PatchCompanyUsingPATCH", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
