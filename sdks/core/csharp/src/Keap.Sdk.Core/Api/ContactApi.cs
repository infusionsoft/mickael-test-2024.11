...
namespace Keap.Sdk.Core.Api
{
    ...
    public partial class ContactApi : IContactApi
    {
        ...
        {
            Keap.Sdk.Core.Client.ApiResponse<Contact> localVarResponse = CreateContactUsingPOST1WithHttpInfo(createUpdateContactRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Contact</returns>
        public Keap.Sdk.Core.Client.ApiResponse<Contact> CreateContactUsingPOST1WithHttpInfo(CreateUpdateContactRequest? createUpdateContactRequest = default(CreateUpdateContactRequest?), int operationIndex = 0)
        {
            Keap.Sdk.Core.Client.RequestOptions localVarRequestOptions = new Keap.Sdk.Core.Client.RequestOptions();
        ...
        {
            Keap.Sdk.Core.Client.ApiResponse<Contact> localVarResponse = await CreateContactUsingPOST1WithHttpInfoAsync(createUpdateContactRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Contact)</returns>
        public async System.Threading.Tasks.Task<Keap.Sdk.Core.Client.ApiResponse<Contact>> CreateContactUsingPOST1WithHttpInfoAsync(CreateUpdateContactRequest? createUpdateContactRequest = default(CreateUpdateContactRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        {
            Keap.Sdk.Core.Client.ApiResponse<Contact> localVarResponse = UpdateContactUsingPATCHWithHttpInfo(contactId, updateMask, createUpdateContactRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Contact</returns>
        public Keap.Sdk.Core.Client.ApiResponse<Contact> UpdateContactUsingPATCHWithHttpInfo(string contactId, List<string>? updateMask = default(List<string>?), CreateUpdateContactRequest? createUpdateContactRequest = default(CreateUpdateContactRequest?), int operationIndex = 0)
        {
            // verify the required parameter 'contactId' is set
            if (contactId == null)
            {
                throw new Keap.Sdk.Core.Client.ApiException(400, "Missing required parameter 'contactId' when calling ContactApi->UpdateContactUsingPATCH");
            }
        ...
        {
            Keap.Sdk.Core.Client.ApiResponse<Contact> localVarResponse = await UpdateContactUsingPATCHWithHttpInfoAsync(contactId, updateMask, createUpdateContactRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Contact)</returns>
        public async System.Threading.Tasks.Task<Keap.Sdk.Core.Client.ApiResponse<Contact>> UpdateContactUsingPATCHWithHttpInfoAsync(string contactId, List<string>? updateMask = default(List<string>?), CreateUpdateContactRequest? createUpdateContactRequest = default(CreateUpdateContactRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'contactId' is set
            if (contactId == null)
            {
