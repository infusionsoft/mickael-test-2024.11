...
namespace Keap.Sdk.Core.Api
{
    ...
    public partial class PaymentMethodConfigApi : IPaymentMethodConfigApi
    {
        ...
        /// <returns></returns>
        public PaymentMethodConfigApi(Keap.Sdk.Core.Client.Configuration configuration)
        {
        ...
        public PaymentMethodConfigApi(Keap.Sdk.Core.Client.ISynchronousClient client, Keap.Sdk.Core.Client.IAsynchronousClient asyncClient, Keap.Sdk.Core.Client.IReadableConfiguration configuration)
        {
