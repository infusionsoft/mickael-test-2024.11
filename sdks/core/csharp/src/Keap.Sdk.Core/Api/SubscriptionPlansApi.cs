...
namespace Keap.Sdk.Core.Api
{
    ...
    public partial class SubscriptionPlansApi : ISubscriptionPlansApi
    {
        ...
        /// <returns></returns>
        public SubscriptionPlansApi(Keap.Sdk.Core.Client.Configuration configuration)
        {
        ...
        public SubscriptionPlansApi(Keap.Sdk.Core.Client.ISynchronousClient client, Keap.Sdk.Core.Client.IAsynchronousClient asyncClient, Keap.Sdk.Core.Client.IReadableConfiguration configuration)
        {
        ...
        public Keap.Sdk.Core.Client.ApiResponse<RestSubscriptionV2> CreateSubscriptionV2UsingPOSTWithHttpInfo(CreateSubscriptionV2 createSubscriptionV2, int operationIndex = 0)
        {
            ...
            {
                throw new Keap.Sdk.Core.Client.ApiException(400, "Missing required parameter 'createSubscriptionV2' when calling SubscriptionPlansApi->CreateSubscriptionV2UsingPOST");
            }
            ...
            localVarRequestOptions.Operation = "SubscriptionPlansApi.CreateSubscriptionV2UsingPOST";
