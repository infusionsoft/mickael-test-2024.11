...
namespace Keap.Sdk.Core.Api
{
    ...
    public partial class TagsApi : ITagsApi
    {
        ...
        public Keap.Sdk.Core.Client.ApiResponse<UpdateTagCategoryResponse> PatchTagCategoryUsingPATCHWithHttpInfo(string tagCategoryId, List<string>? updateMask = default(List<string>?), CreateUpdateTagCategoryRequest? tagCategory = default(CreateUpdateTagCategoryRequest?), int operationIndex = 0)
        {
            ...
            if (tagCategoryId == null)
            {
                throw new Keap.Sdk.Core.Client.ApiException(400, "Missing required parameter 'tagCategoryId' when calling TagsApi->PatchTagCategoryUsingPATCH");
            }
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PatchTagCategoryUsingPATCH", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public Keap.Sdk.Core.Client.ApiResponse<UpdateTagResponse> PatchTagUsingPATCHWithHttpInfo(string tagId, List<string>? updateMask = default(List<string>?), CreateUpdateTagRequest? tag = default(CreateUpdateTagRequest?), int operationIndex = 0)
        {
            ...
            if (tagId == null)
            {
                throw new Keap.Sdk.Core.Client.ApiException(400, "Missing required parameter 'tagId' when calling TagsApi->PatchTagUsingPATCH");
            }
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PatchTagUsingPATCH", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
