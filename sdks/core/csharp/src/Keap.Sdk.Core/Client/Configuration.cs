...
namespace Keap.Sdk.Core.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.0.137";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("core-service-core-csharp/0.0.137");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.70.0.772697-hf-202501311118\n";
            report += "    SDK Package Version: 0.0.137\n";
