...
namespace Keap.Sdk.Core.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.0.100";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("core-service-core-csharp/0.0.100");
        ...
        {
            string report = "C# SDK (Keap.Sdk.Core) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2.70.0.767807-hf-202501161156\n";
            report += "    SDK Package Version: 0.0.100\n";
