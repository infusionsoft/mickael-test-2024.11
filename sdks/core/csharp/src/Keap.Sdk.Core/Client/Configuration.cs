...
namespace Keap.Sdk.Core.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.0.139";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("core-service-core-csharp/0.0.139");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.70.0.772488\n";
            report += "    SDK Package Version: 0.0.139\n";
