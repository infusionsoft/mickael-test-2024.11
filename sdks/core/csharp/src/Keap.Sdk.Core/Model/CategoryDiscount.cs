...
namespace Keap.Sdk.Core.Model
{
    ...
    public partial class CategoryDiscount : IValidatableObject
    {
        ...
        public CategoryDiscount(int applyToCommissions = default(int), string categoryId = default(string), List<Criteria> criteria = default(List<Criteria>), string description = default(string), double discountPercent = default(double), string name = default(string), List<string> productCategories = default(List<string>))
        {
        ...
        /// </summary>
        [DataMember(Name = "apply_to_commissions", EmitDefaultValue = false)]
        public int ApplyToCommissions { get; set; }
