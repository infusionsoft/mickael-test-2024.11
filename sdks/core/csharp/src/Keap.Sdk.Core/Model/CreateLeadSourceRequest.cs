...
namespace Keap.Sdk.Core.Model
{
    ...
    public partial class CreateLeadSourceRequest : IValidatableObject
    {
        ...
        public CreateLeadSourceRequest(LeadSourceCategory category = default(LeadSourceCategory), string description = default(string), string endTime = default(string), string medium = default(string), string message = default(string), string name = default(string), string startTime = default(string), bool statusIsActive = default(bool), string vendor = default(string))
        {
