...
namespace Keap.Sdk.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateOrPatchAffiliateLinkRequest")]
    public partial class CreateOrPatchAffiliateLinkRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrPatchAffiliateLinkRequest" /> class.
        /// </summary>
        ...
        public CreateOrPatchAffiliateLinkRequest(string affiliateId = default(string), string code = default(string), string name = default(string), List<string> programIds = default(List<string>), string websiteAddress = default(string))
        {
