...
namespace Keap.Sdk.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreatePatchContactRequest")]
    public partial class CreatePatchContactRequest : IValidatableObject
    {
        /// <summary>
        /// Defines SourceType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePatchContactRequest" /> class.
        /// </summary>
        /// <param name="addresses">If an empty array is specified, all existing values will be removed..</param>
        /// <param name="anniversaryDate">anniversaryDate.</param>
        /// <param name="birthDate">birthDate.</param>
        /// <param name="company">company.</param>
        /// <param name="contactType">contactType.</param>
        /// <param name="customFields">If an empty array is specified, all existing values will be removed..</param>
        /// <param name="emailAddresses">If an empty array is specified, all existing values will be removed..</param>
        /// <param name="familyName">familyName.</param>
        /// <param name="faxNumbers">If an empty array is specified, all existing values will be removed..</param>
        ...
        /// <param name="phoneNumbers">If an empty array is specified, all existing values will be removed..</param>
        ...
        /// <param name="socialAccounts">If an empty array is specified, all existing values will be removed..</param>
        ...
        public CreatePatchContactRequest(List<Address> addresses = default(List<Address>), string anniversaryDate = default(string), string birthDate = default(string), BasicCompany company = default(BasicCompany), string contactType = default(string), List<CustomFieldValue> customFields = default(List<CustomFieldValue>), List<EmailAddressRequest> emailAddresses = default(List<EmailAddressRequest>), string familyName = default(string), List<FaxNumber> faxNumbers = default(List<FaxNumber>), string givenName = default(string), string jobTitle = default(string), string leadsourceId = default(string), string middleName = default(string), OriginRequest origin = default(OriginRequest), string ownerId = default(string), List<PhoneNumber> phoneNumbers = default(List<PhoneNumber>), string preferredLocale = default(string), string preferredName = default(string), string prefix = default(string), string referralCode = default(string), List<SocialAccount> socialAccounts = default(List<SocialAccount>), SourceTypeEnum? sourceType = default(SourceTypeEnum?), string spouseName = default(string), string suffix = default(string), string varTimeZone = default(string), CreateContactUtmPropertiesRequest utmParameters = default(CreateContactUtmPropertiesRequest), string website = default(string))
        {
        ...
        /// </summary>
        /// <value>If an empty array is specified, all existing values will be removed.</value>
