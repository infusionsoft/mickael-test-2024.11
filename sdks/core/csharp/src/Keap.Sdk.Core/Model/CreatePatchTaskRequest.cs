...
namespace Keap.Sdk.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreatePatchTaskRequest")]
    public partial class CreatePatchTaskRequest : IValidatableObject
    {
        /// <summary>
        /// Defines Priority
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePatchTaskRequest" /> class.
        /// </summary>
        ...
        public CreatePatchTaskRequest(string assignedToUserId = default(string), bool completed = default(bool), string completionTime = default(string), string contactId = default(string), string description = default(string), string dueTime = default(string), PriorityEnum? priority = default(PriorityEnum?), int remindTimeMins = default(int), string title = default(string), TypeEnum? type = default(TypeEnum?))
        {
