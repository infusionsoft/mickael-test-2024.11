...
namespace Keap.Sdk.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Deal_allOf_stage")]
    public partial class DealAllOfStage : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DealAllOfStage" /> class.
        /// </summary>
        ...
        public DealAllOfStage(string id = default(string), string name = default(string), string pipelineId = default(string))
        {
            this.Id = id;
            this.Name = name;
