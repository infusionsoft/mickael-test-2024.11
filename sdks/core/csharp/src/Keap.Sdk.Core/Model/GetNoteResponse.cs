...
namespace Keap.Sdk.Core.Model
{
    ...
    /// GetNoteResponse
    /// </summary>
    [DataContract(Name = "GetNoteResponse")]
    public partial class GetNoteResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetNoteResponse" /> class.
        /// </summary>
        ...
        public GetNoteResponse(BasicUser assignedToUser = default(BasicUser), string contactId = default(string), string createTime = default(string), string createdByUserId = default(string), string id = default(string), string lastUpdatedByUserId = default(string), string text = default(string), string title = default(string), string type = default(string), string updateTime = default(string))
        {
