...
namespace Keap.Sdk.Core.Model
{
    ...
    public partial class GetNoteResponse : IValidatableObject
    {
        ...
        public GetNoteResponse(BasicUser assignedToUser = default(BasicUser), string contactId = default(string), string createTime = default(string), string id = default(string), string lastUpdatedByUserId = default(string), string text = default(string), string title = default(string), string type = default(string), string updateTime = default(string))
        {
