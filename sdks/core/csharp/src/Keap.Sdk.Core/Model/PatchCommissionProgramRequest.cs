...
namespace Keap.Sdk.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PatchCommissionProgramRequest")]
    public partial class PatchCommissionProgramRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchCommissionProgramRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PatchCommissionProgramRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchCommissionProgramRequest" /> class.
        /// </summary>
        ...
        public PatchCommissionProgramRequest(string name = default(string), string notes = default(string), int priority = default(int))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PatchCommissionProgramRequest and cannot be null");
            }
            this.Name = name;
            this.Notes = notes;
