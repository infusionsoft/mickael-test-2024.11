...
namespace Keap.Sdk.Core.Model
{
    ...
    public partial class RestAffiliate : IValidatableObject
    {
        ...
        public RestAffiliate(string code = default(string), string contactId = default(string), string id = default(string), string name = default(string), string status = default(string), string uniqueSiteId = default(string))
        {
            this.Code = code;
