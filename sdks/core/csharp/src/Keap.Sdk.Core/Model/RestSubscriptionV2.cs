...
namespace Keap.Sdk.Core.Model
{
    ...
    public partial class RestSubscriptionV2 : IValidatableObject
    {
        ...
        public RestSubscriptionV2(bool active = default(bool), bool allowTax = default(bool), bool autoCharge = default(bool), double billingAmount = default(double), BillingCycleEnum? billingCycle = default(BillingCycleEnum?), int billingFrequency = default(int), string contactId = default(string), DateOnly endDate = default(DateOnly), string id = default(string), DateOnly nextBillDate = default(DateOnly), string paymentGatewayId = default(string), long paymentMethodId = default(long), string productId = default(string), long quantity = default(long), string saleAffiliateId = default(string), DateOnly startDate = default(DateOnly), string subscriptionPlanId = default(string))
        {
            this.Active = active;
