...
namespace Keap.Sdk.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RestV2PatchOrderRequest")]
    public partial class RestV2PatchOrderRequest : IValidatableObject
    {
        /// <summary>
        /// Defines OrderType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RestV2PatchOrderRequest" /> class.
        /// </summary>
        ...
        public RestV2PatchOrderRequest(string contactId = default(string), string leadAffiliateId = default(string), string orderTime = default(string), string orderTitle = default(string), OrderTypeEnum? orderType = default(OrderTypeEnum?), List<string> promoCodes = default(List<string>), string salesAffiliateId = default(string), AddressInformation shippingAddress = default(AddressInformation))
        {
