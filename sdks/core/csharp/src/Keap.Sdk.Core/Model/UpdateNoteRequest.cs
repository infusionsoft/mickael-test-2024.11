...
namespace Keap.Sdk.Core.Model
{
    ...
    public partial class UpdateNoteRequest : IValidatableObject
    {
        ...
        public UpdateNoteRequest(string contactId = default(string), string text = default(string), string title = default(string), string type = default(string), string userId = default(string))
        {
