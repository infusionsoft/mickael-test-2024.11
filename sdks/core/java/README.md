...
<dependency>
  ...
  <version>dev-2024.1125.0009-a0bbb4902f</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.keap:core -service-core-java-sdk:dev-2024.1125.0009-a0bbb4902f"
```
...
- `target/core -service-core-java-sdk-dev-2024.1125.0009-a0bbb4902f.jar`
- `target/lib/*.jar`
