...
| [**adjustInventoryUsingPOSTWithHttpInfo**](ProductApi.md#adjustInventoryUsingPOSTWithHttpInfo) | **POST** /v2/products/{product_id}:adjustInventory | Adjust Inventory of a Product |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ProductApi#adjustInventoryUsingPOST");
...
## adjustInventoryUsingPOSTWithHttpInfo

> ApiResponse<RestV2Product> adjustInventoryUsingPOST adjustInventoryUsingPOSTWithHttpInfo(productId, updateProductInventoryRequest)
