...
import com.keap.sdk.core.model.GetBusinessProfileResponse;
import com.keap.sdk.core.model.PatchBusinessProfileRequest;
...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.9.0")public class BusinessProfileApi {
  ...
  public ApiResponse<GetBusinessProfileResponse> patchBusinessProfileUsingPATCHWithHttpInfo(List<String> updateMask, PatchBusinessProfileRequest businessProfile) throws ApiException {
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("patchBusinessProfileUsingPATCH", localVarResponse);
        }
        return new ApiResponse<GetBusinessProfileResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
