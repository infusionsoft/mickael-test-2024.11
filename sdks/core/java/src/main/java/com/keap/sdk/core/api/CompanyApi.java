...
import com.keap.sdk.core.model.Company;
import com.keap.sdk.core.model.CreateCompanyRequest;
import com.keap.sdk.core.model.Error;
import com.keap.sdk.core.model.ListCompaniesResponse;
import com.keap.sdk.core.model.PatchCompanyRequest;
...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.9.0")public class CompanyApi {
  ...
  public ApiResponse<Company> patchCompanyUsingPATCHWithHttpInfo(String companyId, List<String> updateMask, PatchCompanyRequest company) throws ApiException {
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("patchCompanyUsingPATCH", localVarResponse);
        }
        return new ApiResponse<Company>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
