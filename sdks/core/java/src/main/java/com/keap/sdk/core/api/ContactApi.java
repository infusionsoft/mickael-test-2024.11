...
import com.keap.sdk.core.model.Contact;
import com.keap.sdk.core.model.ContactLink;
import com.keap.sdk.core.model.ContactLinkType;
import com.keap.sdk.core.model.CreateContactLinkTypeRequest;
import com.keap.sdk.core.model.CreatePatchContactRequest;
import com.keap.sdk.core.model.Error;
import com.keap.sdk.core.model.LinkContactsRequest;
import com.keap.sdk.core.model.ListBasicContactResponse;
import com.keap.sdk.core.model.ListContactLinkTypesResponse;
import com.keap.sdk.core.model.ListContactLinksResponse;
import com.keap.sdk.core.model.ListContactsResponse;
import com.keap.sdk.core.model.ObjectModel;
import com.keap.sdk.core.model.PaymentMethodList;
...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.9.0")public class ContactApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ListBasicContactResponse getContactsBySearchTermUsingGET_0(String searchParam) throws ApiException {
    ApiResponse<ListBasicContactResponse> localVarResponse = getContactsBySearchTermUsingGET_0WithHttpInfo(searchParam);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ListBasicContactResponse> getContactsBySearchTermUsingGET_0WithHttpInfo(String searchParam) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getContactsBySearchTermUsingGET_0RequestBuilder(searchParam);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getContactsBySearchTermUsingGET_0", localVarResponse);
        }
  ...
  private HttpRequest.Builder getContactsBySearchTermUsingGET_0RequestBuilder(String searchParam) throws ApiException {
    // verify the required parameter 'searchParam' is set
    if (searchParam == null) {
      throw new ApiException(400, "Missing the required parameter 'searchParam' when calling getContactsBySearchTermUsingGET_0");
    }
