...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.9.0")public class LandingPagesApi {
   ...
   */
  public ListLandingPagesResponse listLandingPagesUsingGET_0(String filter, String orderBy, Integer pageSize, String pageToken) throws ApiException {
    ApiResponse<ListLandingPagesResponse> localVarResponse = listLandingPagesUsingGET_0WithHttpInfo(filter, orderBy, pageSize, pageToken);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ListLandingPagesResponse> listLandingPagesUsingGET_0WithHttpInfo(String filter, String orderBy, Integer pageSize, String pageToken) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = listLandingPagesUsingGET_0RequestBuilder(filter, orderBy, pageSize, pageToken);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("listLandingPagesUsingGET_0", localVarResponse);
        }
  ...
  private HttpRequest.Builder listLandingPagesUsingGET_0RequestBuilder(String filter, String orderBy, Integer pageSize, String pageToken) throws ApiException {
