...
import com.keap.sdk.core.model.CreateNoteRequest;
import com.keap.sdk.core.model.CustomFieldMetaData;
import com.keap.sdk.core.model.Error;
import com.keap.sdk.core.model.GetNoteResponse;
import com.keap.sdk.core.model.ListNotesResponse;
import com.keap.sdk.core.model.Note;
import com.keap.sdk.core.model.ObjectModel;
import com.keap.sdk.core.model.UpdateCustomFieldMetaDataRequest;
import com.keap.sdk.core.model.UpdateNoteRequest;
import com.keap.sdk.core.model.UpdateNoteResponse;
...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.9.0")public class NoteApi {
   ...
   */
  public CustomFieldMetaData createNoteCustomFieldUsingPOST1_0(CreateCustomFieldRequest customField) throws ApiException {
    ApiResponse<CustomFieldMetaData> localVarResponse = createNoteCustomFieldUsingPOST1_0WithHttpInfo(customField);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CustomFieldMetaData> createNoteCustomFieldUsingPOST1_0WithHttpInfo(CreateCustomFieldRequest customField) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = createNoteCustomFieldUsingPOST1_0RequestBuilder(customField);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("createNoteCustomFieldUsingPOST1_0", localVarResponse);
        }
  ...
  private HttpRequest.Builder createNoteCustomFieldUsingPOST1_0RequestBuilder(CreateCustomFieldRequest customField) throws ApiException {
    // verify the required parameter 'customField' is set
    if (customField == null) {
      throw new ApiException(400, "Missing the required parameter 'customField' when calling createNoteCustomFieldUsingPOST1_0");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public ObjectModel retrieveNoteModelUsingGET1_0() throws ApiException {
    ApiResponse<ObjectModel> localVarResponse = retrieveNoteModelUsingGET1_0WithHttpInfo();
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ObjectModel> retrieveNoteModelUsingGET1_0WithHttpInfo() throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = retrieveNoteModelUsingGET1_0RequestBuilder();
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("retrieveNoteModelUsingGET1_0", localVarResponse);
        }
  ...
  private HttpRequest.Builder retrieveNoteModelUsingGET1_0RequestBuilder() throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public CustomFieldMetaData updateNotesCustomFieldUsingPATCH_0(String customFieldId, UpdateCustomFieldMetaDataRequest request, List<String> updateMask) throws ApiException {
    ApiResponse<CustomFieldMetaData> localVarResponse = updateNotesCustomFieldUsingPATCH_0WithHttpInfo(customFieldId, request, updateMask);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CustomFieldMetaData> updateNotesCustomFieldUsingPATCH_0WithHttpInfo(String customFieldId, UpdateCustomFieldMetaDataRequest request, List<String> updateMask) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = updateNotesCustomFieldUsingPATCH_0RequestBuilder(customFieldId, request, updateMask);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("updateNotesCustomFieldUsingPATCH_0", localVarResponse);
        }
        return new ApiResponse<CustomFieldMetaData>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder updateNotesCustomFieldUsingPATCH_0RequestBuilder(String customFieldId, UpdateCustomFieldMetaDataRequest request, List<String> updateMask) throws ApiException {
    // verify the required parameter 'customFieldId' is set
    if (customFieldId == null) {
      throw new ApiException(400, "Missing the required parameter 'customFieldId' when calling updateNotesCustomFieldUsingPATCH_0");
    }
    // verify the required parameter 'request' is set
    if (request == null) {
      throw new ApiException(400, "Missing the required parameter 'request' when calling updateNotesCustomFieldUsingPATCH_0");
    }
