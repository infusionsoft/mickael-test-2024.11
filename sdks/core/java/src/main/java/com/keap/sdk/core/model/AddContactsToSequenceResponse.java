...
public class AddContactsToSequenceResponse implements Serializable {
  ...
  private Map<String, String> addToSequenceResults = new HashMap<>();

  public AddContactsToSequenceResponse() { 
  }

  public AddContactsToSequenceResponse addToSequenceResults(Map<String, String> addToSequenceResults) {
  ...
  @JsonProperty(JSON_PROPERTY_ADD_TO_SEQUENCE_RESULTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAddToSequenceResults(Map<String, String> addToSequenceResults) {
    this.addToSequenceResults = addToSequenceResults;
  }
