...
public class AddressInformation implements Serializable {
  ...
  private Boolean isInvoiceToCompany;
  ...
  public AddressInformation company(String company) {
  ...
  public AddressInformation countryCode(String countryCode) {
  ...
  public AddressInformation firstName(String firstName) {
  ...
  public AddressInformation isInvoiceToCompany(Boolean isInvoiceToCompany) {
  ...
  @JsonProperty(JSON_PROPERTY_IS_INVOICE_TO_COMPANY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsInvoiceToCompany(Boolean isInvoiceToCompany) {
    this.isInvoiceToCompany = isInvoiceToCompany;
  }


  public AddressInformation lastName(String lastName) {
  ...
  public AddressInformation line1(String line1) {
    this.line1 = line1;
    return this;
  }
  ...
  public AddressInformation line2(String line2) {
    this.line2 = line2;
    return this;
  }
  ...
  public AddressInformation middleName(String middleName) {
  ...
  public AddressInformation zipCode(String zipCode) {
  ...
  public AddressInformation zipFour(String zipFour) {
