...
import com.keap.sdk.core.model.DefaultCommission;
import com.keap.sdk.core.model.ProductCommission;
import com.keap.sdk.core.model.SubscriptionCommission;
...
public class AffiliateProgramV2 implements Serializable {
  ...
  private List<@Valid ProductCommission> productCommissions = new ArrayList<>();

  public static final String JSON_PROPERTY_SUBSCRIPTION_COMMISSIONS = "subscription_commissions";
  private List<@Valid SubscriptionCommission> subscriptionCommissions = new ArrayList<>();

  public AffiliateProgramV2() { 
  }

  public AffiliateProgramV2 affiliateId(String affiliateId) {
  ...
  @Schema(example = "123", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The affiliate_Id for Affiliate commission program")
  ...
  public AffiliateProgramV2 createTime(ZonedDateTime createTime) {
  ...
  @jakarta.annotation.Nullable
  @Valid
  @Schema(example = "2019-08-24T14:15:22Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The created time of affiliate commission program")
  ...
  public AffiliateProgramV2 defaultCommission(DefaultCommission defaultCommission) {
  ...
  @JsonProperty(JSON_PROPERTY_DEFAULT_COMMISSION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDefaultCommission(DefaultCommission defaultCommission) {
    this.defaultCommission = defaultCommission;
  }


  public AffiliateProgramV2 id(String id) {
    this.id = id;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(example = "1", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The affiliate commission program name")
  ...
  public AffiliateProgramV2 name(String name) {
    this.name = name;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(example = "commission program", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The affiliate commission program name")
  ...
  public AffiliateProgramV2 notes(String notes) {
    this.notes = notes;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(example = "notes for the commission program", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The affiliate commission program notes")
  ...
  public AffiliateProgramV2 priority(String priority) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(example = "0", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The Affiliate commission program priority")
  ...
  public AffiliateProgramV2 productCommissions(List<@Valid ProductCommission> productCommissions) {
  ...
  @JsonProperty(JSON_PROPERTY_PRODUCT_COMMISSIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProductCommissions(List<@Valid ProductCommission> productCommissions) {
    this.productCommissions = productCommissions;
  }


  public AffiliateProgramV2 subscriptionCommissions(List<@Valid SubscriptionCommission> subscriptionCommissions) {
  ...
  @JsonProperty(JSON_PROPERTY_SUBSCRIPTION_COMMISSIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubscriptionCommissions(List<@Valid SubscriptionCommission> subscriptionCommissions) {
    this.subscriptionCommissions = subscriptionCommissions;
  }
    ...
    public static class Builder {
        ...
        public AffiliateProgramV2.Builder affiliateId(String affiliateId) {
          ...
          return this;
            ...
            public AffiliateProgramV2.Builder createTime(ZonedDateTime createTime) {
