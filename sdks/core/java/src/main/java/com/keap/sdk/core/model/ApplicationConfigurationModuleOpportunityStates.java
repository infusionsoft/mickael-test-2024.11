...
import com.keap.sdk.core.model.ApplicationConfigurationModuleOpportunityStatesActive;
import com.keap.sdk.core.model.ApplicationConfigurationModuleOpportunityStatesLoss;
import com.keap.sdk.core.model.ApplicationConfigurationModuleOpportunityStatesWin;
...
public class ApplicationConfigurationModuleOpportunityStates implements Serializable {
  ...
  private ApplicationConfigurationModuleOpportunityStatesActive active;

  public static final String JSON_PROPERTY_LOSS = "loss";
  private ApplicationConfigurationModuleOpportunityStatesLoss loss;

  public static final String JSON_PROPERTY_WIN = "win";
  private ApplicationConfigurationModuleOpportunityStatesWin win;

  public ApplicationConfigurationModuleOpportunityStates() { 
  }

  public ApplicationConfigurationModuleOpportunityStates active(ApplicationConfigurationModuleOpportunityStatesActive active) {
    this.active = active;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ACTIVE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setActive(ApplicationConfigurationModuleOpportunityStatesActive active) {
    this.active = active;
  }


  public ApplicationConfigurationModuleOpportunityStates loss(ApplicationConfigurationModuleOpportunityStatesLoss loss) {
    this.loss = loss;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LOSS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLoss(ApplicationConfigurationModuleOpportunityStatesLoss loss) {
    this.loss = loss;
  }


  public ApplicationConfigurationModuleOpportunityStates win(ApplicationConfigurationModuleOpportunityStatesWin win) {
    this.win = win;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_WIN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setWin(ApplicationConfigurationModuleOpportunityStatesWin win) {
    this.win = win;
  }
