...
import com.keap.sdk.core.model.AutomationLockStatus;
...
public class Automation implements Serializable {
  ...
  private AutomationLockStatus currentEditLockStatus;
  ...
  public Automation activeContacts(Integer activeContacts) {
  ...
  public Automation categories(List<String> categories) {
  ...
  public Automation currentEditLockStatus(AutomationLockStatus currentEditLockStatus) {
  ...
  @JsonProperty(JSON_PROPERTY_CURRENT_EDIT_LOCK_STATUS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCurrentEditLockStatus(AutomationLockStatus currentEditLockStatus) {
    this.currentEditLockStatus = currentEditLockStatus;
  }


  public Automation errorMessage(String errorMessage) {
  ...
  public Automation locked(Boolean locked) {
    this.locked = locked;
    return this;
  }
  ...
  public Automation publishedBy(String publishedBy) {
  ...
  public Automation publishedDate(ZonedDateTime publishedDate) {
  ...
  public Automation publishedTimezone(String publishedTimezone) {
  ...
  public Automation status(String status) {
    this.status = status;
    return this;
  }
