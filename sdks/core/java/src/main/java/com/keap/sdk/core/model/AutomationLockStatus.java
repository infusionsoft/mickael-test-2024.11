...
public class AutomationLockStatus implements Serializable {
  ...
  public AutomationLockStatus locked(Boolean locked) {
    this.locked = locked;
    return this;
  }
  ...
  public AutomationLockStatus userFirstname(String userFirstname) {
  ...
  public AutomationLockStatus userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public AutomationLockStatus userName(String userName) {
