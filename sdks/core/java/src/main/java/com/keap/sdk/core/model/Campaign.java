...
import com.keap.sdk.core.model.Goal;
import com.keap.sdk.core.model.Sequence;
...
public class Campaign implements Serializable {
  ...
  private String createdByGlobalId;
  ...
  private List<@Valid Sequence> sequences = new ArrayList<>();
  ...
  public Campaign activeContactCount(Integer activeContactCount) {
  ...
  public Campaign completedContactCount(Integer completedContactCount) {
  ...
  public Campaign createdByGlobalId(String createdByGlobalId) {
  ...
  @JsonProperty(JSON_PROPERTY_CREATED_BY_GLOBAL_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCreatedByGlobalId(String createdByGlobalId) {
    this.createdByGlobalId = createdByGlobalId;
  }


  public Campaign dateCreated(String dateCreated) {
  ...
  public Campaign errorMessage(String errorMessage) {
  ...
  public Campaign goals(List<@Valid Goal> goals) {
    this.goals = goals;
    return this;
  }
  ...
  public Campaign locked(Boolean locked) {
    this.locked = locked;
    return this;
  }
  ...
  public Campaign publishedDate(ZonedDateTime publishedDate) {
  ...
  public Campaign publishedStatus(Boolean publishedStatus) {
  ...
  public Campaign publishedTimeZone(String publishedTimeZone) {
  ...
  public Campaign sequences(List<@Valid Sequence> sequences) {
  ...
  @JsonProperty(JSON_PROPERTY_SEQUENCES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSequences(List<@Valid Sequence> sequences) {
    this.sequences = sequences;
  }
