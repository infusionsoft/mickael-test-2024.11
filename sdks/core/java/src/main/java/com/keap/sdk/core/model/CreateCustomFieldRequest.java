...
import com.keap.sdk.core.model.CreateCustomFieldOptionRequest;
...
public class CreateCustomFieldRequest implements Serializable {
  ...
  private List<@Valid CreateCustomFieldOptionRequest> options = new ArrayList<>();
  ...
  public CreateCustomFieldRequest fieldType(FieldTypeEnum fieldType) {
  ...
  public CreateCustomFieldRequest groupId(String groupId) {
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "An optional tab group to place the field under in the interface.  If not specified, will default to the 'Custom Fields' tab.")
  ...
  public CreateCustomFieldRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public CreateCustomFieldRequest options(List<@Valid CreateCustomFieldOptionRequest> options) {
  ...
  @JsonProperty(JSON_PROPERTY_OPTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOptions(List<@Valid CreateCustomFieldOptionRequest> options) {
    this.options = options;
  }


  public CreateCustomFieldRequest userGroupId(String userGroupId) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "An optional user group to choose from when selecting values for User or UserListBox fields.")
