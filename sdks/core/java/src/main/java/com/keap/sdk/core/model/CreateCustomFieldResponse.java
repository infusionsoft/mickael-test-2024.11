...
public class CreateCustomFieldResponse implements Serializable {
  ...
  private CustomFieldMetaData customField;

  public CreateCustomFieldResponse() { 
  }

  public CreateCustomFieldResponse customField(CustomFieldMetaData customField) {
  ...
  @JsonProperty(JSON_PROPERTY_CUSTOM_FIELD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCustomField(CustomFieldMetaData customField) {
    this.customField = customField;
  }
