...
public class CreateDefaultCommissionProgramRequest implements Serializable {
  ...
  public CreateDefaultCommissionProgramRequest dollarAmount(String dollarAmount) {
  ...
  public CreateDefaultCommissionProgramRequest percentage(String percentage) {
