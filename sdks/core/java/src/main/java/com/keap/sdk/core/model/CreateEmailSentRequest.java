...
public class CreateEmailSentRequest implements Serializable {
  ...
  public CreateEmailSentRequest clickedTime(String clickedTime) {
  ...
  public CreateEmailSentRequest contactId(String contactId) {
  ...
  public CreateEmailSentRequest headers(String headers) {
  ...
  public CreateEmailSentRequest htmlContent(String htmlContent) {
  ...
  public CreateEmailSentRequest openedTime(String openedTime) {
  ...
  public CreateEmailSentRequest originalProvider(OriginalProviderEnum originalProvider) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Provider that sent the email, defaults to UNKNOWN")
  ...
  public CreateEmailSentRequest originalProviderId(String originalProviderId) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Provider id that sent the email, must be unique when combined with provider.  If omitted a UUID without dashes is autogenerated for the record.")
  ...
  public CreateEmailSentRequest plainContent(String plainContent) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Base64 encoded text")
  ...
  public CreateEmailSentRequest providerSourceId(String providerSourceId) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The email address of the synced email account that generated this message.")
  ...
  public CreateEmailSentRequest receivedTime(String receivedTime) {
  ...
  public CreateEmailSentRequest sentFromAddress(String sentFromAddress) {
  ...
  public CreateEmailSentRequest sentFromReplyAddress(String sentFromReplyAddress) {
  ...
  public CreateEmailSentRequest sentTime(String sentTime) {
  ...
  public CreateEmailSentRequest sentToAddress(String sentToAddress) {
  ...
  public CreateEmailSentRequest sentToBccAddressList(List<String> sentToBccAddressList) {
  ...
  public CreateEmailSentRequest sentToCcAddressList(List<String> sentToCcAddressList) {
  ...
  public CreateEmailSentRequest subject(String subject) {
