...
public class CreateEmailsSentRequest implements Serializable {
  ...
  private List<@Valid CreateEmailSentRequest> emails = new ArrayList<>();

  public CreateEmailsSentRequest() { 
  }

  public CreateEmailsSentRequest emails(List<@Valid CreateEmailSentRequest> emails) {
    this.emails = emails;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EMAILS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEmails(List<@Valid CreateEmailSentRequest> emails) {
    this.emails = emails;
  }
