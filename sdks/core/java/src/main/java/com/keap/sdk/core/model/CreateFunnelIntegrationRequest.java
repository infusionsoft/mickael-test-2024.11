...
import com.keap.sdk.core.model.FunnelIntegrationAction;
...
public class CreateFunnelIntegrationRequest implements Serializable {
  ...
  private List<@Valid FunnelIntegrationAction> funnelIntegrationActions = new ArrayList<>();

  public static final String JSON_PROPERTY_FUNNEL_INTEGRATION_TRIGGERS = "funnel_integration_triggers";
  private List<@Valid FunnelIntegrationAction> funnelIntegrationTriggers = new ArrayList<>();
  ...
  public CreateFunnelIntegrationRequest baseUrl(String baseUrl) {
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The base URL of the integration, that will be used to call the integration related REST endpoints.")
  ...
  public CreateFunnelIntegrationRequest context(String context) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The context of the integration, that will be used internally to identify the integration.")
  ...
  public CreateFunnelIntegrationRequest enabled(Boolean enabled) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The flag to enable or disable the integration.")
  ...
  public CreateFunnelIntegrationRequest funnelIntegrationActions(List<@Valid FunnelIntegrationAction> funnelIntegrationActions) {
  ...
  @JsonProperty(JSON_PROPERTY_FUNNEL_INTEGRATION_ACTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFunnelIntegrationActions(List<@Valid FunnelIntegrationAction> funnelIntegrationActions) {
    this.funnelIntegrationActions = funnelIntegrationActions;
  }


  public CreateFunnelIntegrationRequest funnelIntegrationTriggers(List<@Valid FunnelIntegrationAction> funnelIntegrationTriggers) {
  ...
  @JsonProperty(JSON_PROPERTY_FUNNEL_INTEGRATION_TRIGGERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFunnelIntegrationTriggers(List<@Valid FunnelIntegrationAction> funnelIntegrationTriggers) {
    this.funnelIntegrationTriggers = funnelIntegrationTriggers;
  }


  public CreateFunnelIntegrationRequest name(String name) {
    this.name = name;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(example = "My Integration, MyIntegration, My 1 New Very Exciting Integration", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The name of the integration, that will be used internally to identify the integration.")
