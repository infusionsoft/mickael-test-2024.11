...
import com.keap.sdk.core.model.FunnelIntegrationTriggerEventDTO;
...
public class CreateFunnelIntegrationTriggerEvents implements Serializable {
  ...
  private List<@Valid FunnelIntegrationTriggerEventDTO> funnelIntegrationTriggerEvents = new ArrayList<>();

  public CreateFunnelIntegrationTriggerEvents() { 
  }

  public CreateFunnelIntegrationTriggerEvents funnelIntegrationTriggerEvents(List<@Valid FunnelIntegrationTriggerEventDTO> funnelIntegrationTriggerEvents) {
  ...
  @JsonProperty(JSON_PROPERTY_FUNNEL_INTEGRATION_TRIGGER_EVENTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFunnelIntegrationTriggerEvents(List<@Valid FunnelIntegrationTriggerEventDTO> funnelIntegrationTriggerEvents) {
    this.funnelIntegrationTriggerEvents = funnelIntegrationTriggerEvents;
  }
