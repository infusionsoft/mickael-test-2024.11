...
public class CreateOpportunityRequest implements Serializable {
  ...
  public CreateOpportunityRequest affiliateId(String affiliateId) {
  ...
  public CreateOpportunityRequest contactId(String contactId) {
  ...
  public CreateOpportunityRequest customFields(List<@Valid CustomField> customFields) {
  ...
  public CreateOpportunityRequest estimatedCloseTime(String estimatedCloseTime) {
  ...
  public CreateOpportunityRequest includeInForecast(Boolean includeInForecast) {
  ...
  public CreateOpportunityRequest nextActionNotes(String nextActionNotes) {
  ...
  public CreateOpportunityRequest nextActionTime(String nextActionTime) {
  ...
  public CreateOpportunityRequest opportunityNotes(String opportunityNotes) {
  ...
  public CreateOpportunityRequest opportunityTitle(String opportunityTitle) {
  ...
  public CreateOpportunityRequest projectedRevenueHigh(Double projectedRevenueHigh) {
  ...
  public CreateOpportunityRequest projectedRevenueLow(Double projectedRevenueLow) {
  ...
  public CreateOpportunityRequest stageId(String stageId) {
  ...
  public CreateOpportunityRequest userId(String userId) {
    this.userId = userId;
    return this;
  }
