...
public class CreatePaymentRequest implements Serializable {
  ...
  private Boolean applyToCommissions;
  ...
  public CreatePaymentRequest applyToCommissions(Boolean applyToCommissions) {
  ...
  public CreatePaymentRequest date(ZonedDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public CreatePaymentRequest notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public CreatePaymentRequest paymentAmount(String paymentAmount) {
  ...
  public CreatePaymentRequest paymentMethodId(Long paymentMethodId) {
