...
public class CreateRestOrderItemRequest implements Serializable {
  ...
  public CreateRestOrderItemRequest description(String description) {
  ...
  public CreateRestOrderItemRequest price(Double price) {
    this.price = price;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Overridable price of the product. If not specified, the default will be used. Must be greater than or equal to 0.")
  ...
  public CreateRestOrderItemRequest productId(String productId) {
  ...
  public CreateRestOrderItemRequest productType(ProductTypeEnum productType) {
  ...
  public CreateRestOrderItemRequest quantity(Integer quantity) {
