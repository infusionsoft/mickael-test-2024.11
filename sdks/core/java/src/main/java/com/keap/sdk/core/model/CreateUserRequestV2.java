...
public class CreateUserRequestV2 implements Serializable {
  ...
  public CreateUserRequestV2 admin(Boolean admin) {
    this.admin = admin;
    return this;
  }
  ...
  public CreateUserRequestV2 emailAddress(EmailAddressRequest emailAddress) {
  ...
  public CreateUserRequestV2 givenName(String givenName) {
  ...
  public CreateUserRequestV2 partner(Boolean partner) {
