...
public class CustomFieldMetaData implements Serializable {
  ...
  public CustomFieldMetaData defaultValue(String defaultValue) {
  ...
  public CustomFieldMetaData fieldName(String fieldName) {
  ...
  public CustomFieldMetaData fieldType(FieldTypeEnum fieldType) {
  ...
  public CustomFieldMetaData groupId(String groupId) {
  ...
  public CustomFieldMetaData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CustomFieldMetaData label(String label) {
    this.label = label;
    return this;
  }
  ...
  public CustomFieldMetaData options(List<@Valid CustomFieldOption> options) {
  ...
  public CustomFieldMetaData recordType(RecordTypeEnum recordType) {
