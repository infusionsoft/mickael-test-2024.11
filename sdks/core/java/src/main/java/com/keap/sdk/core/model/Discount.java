...
public class Discount implements Serializable {
  ...
  private DiscountMethodEnum discountMethod;
  ...
  public Discount discountMethod(DiscountMethodEnum discountMethod) {
  ...
  @JsonProperty(JSON_PROPERTY_DISCOUNT_METHOD)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDiscountMethod(DiscountMethodEnum discountMethod) {
    this.discountMethod = discountMethod;
  }


  public Discount lineItemId(String lineItemId) {
  ...
  public Discount specialItemId(String specialItemId) {
