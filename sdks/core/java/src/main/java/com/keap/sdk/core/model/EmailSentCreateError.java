...
public class EmailSentCreateError implements Serializable {
  ...
  private CreateEmailSentRequest email;
  ...
  public EmailSentCreateError email(CreateEmailSentRequest email) {
    this.email = email;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EMAIL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEmail(CreateEmailSentRequest email) {
    this.email = email;
  }


  public EmailSentCreateError errorMessage(String errorMessage) {
