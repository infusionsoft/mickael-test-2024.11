...
import com.keap.sdk.core.model.FunnelIntegrationSchemaField;
...
public class FunnelIntegrationAction implements Serializable {
  ...
  private List<@Valid FunnelIntegrationSchemaField> schemaFields = new ArrayList<>();

  public FunnelIntegrationAction() { 
  }

  public FunnelIntegrationAction baseUrl(String baseUrl) {
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The base URL of the trigger, that will be used to call the integration related REST endpoints.")
  ...
  public FunnelIntegrationAction context(String context) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The context of the trigger, that will be used internally to identify the integration.")
  ...
  public FunnelIntegrationAction enabled(Boolean enabled) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The flag to enable or disable the integration trigger.")
  ...
  public FunnelIntegrationAction iconUrl(String iconUrl) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The icon URL of the trigger, that will be used to display the icon of this specific integration trigger.")
  ...
  public FunnelIntegrationAction name(String name) {
    this.name = name;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(example = "My Trigger, MyTrigger, My 1 New Very Exciting Trigger", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The name of the trigger, that will be used internally to identify and initiate the trigger.")
  ...
  public FunnelIntegrationAction schemaFields(List<@Valid FunnelIntegrationSchemaField> schemaFields) {
  ...
  @JsonProperty(JSON_PROPERTY_SCHEMA_FIELDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSchemaFields(List<@Valid FunnelIntegrationSchemaField> schemaFields) {
    this.schemaFields = schemaFields;
  }
