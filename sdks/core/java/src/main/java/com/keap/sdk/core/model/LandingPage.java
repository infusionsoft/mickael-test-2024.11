...
public class LandingPage implements Serializable {
  ...
  private String templateGroupStatus;
  ...
  public LandingPage htmlPreviewUrl(String htmlPreviewUrl) {
  ...
  public LandingPage htmlUrl(String htmlUrl) {
  ...
  public LandingPage templateGroupStatus(String templateGroupStatus) {
  ...
  @JsonProperty(JSON_PROPERTY_TEMPLATE_GROUP_STATUS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTemplateGroupStatus(String templateGroupStatus) {
    this.templateGroupStatus = templateGroupStatus;
  }
