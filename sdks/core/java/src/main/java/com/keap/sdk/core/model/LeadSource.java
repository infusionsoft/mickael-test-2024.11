...
public class LeadSource implements Serializable {
  ...
  public LeadSource category(LeadSourceCategory category) {
  ...
  public LeadSource description(String description) {
  ...
  public LeadSource endTime(String endTime) {
  ...
  public LeadSource id(String id) {
    this.id = id;
    return this;
  }
  ...
  public LeadSource message(String message) {
  ...
  public LeadSource startTime(String startTime) {
  ...
  public LeadSource statusIsActive(Boolean statusIsActive) {
  ...
  public LeadSource vendor(String vendor) {
    this.vendor = vendor;
    return this;
  }
