...
public class ListAffiliateCommissionProgramsResponse implements Serializable {
  ...
  private List<@Valid AffiliateProgramV2> commissionPrograms = new ArrayList<>();
  ...
  public ListAffiliateCommissionProgramsResponse commissionPrograms(List<@Valid AffiliateProgramV2> commissionPrograms) {
  ...
  @JsonProperty(JSON_PROPERTY_COMMISSION_PROGRAMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCommissionPrograms(List<@Valid AffiliateProgramV2> commissionPrograms) {
    this.commissionPrograms = commissionPrograms;
  }


  public ListAffiliateCommissionProgramsResponse nextPageToken(String nextPageToken) {
