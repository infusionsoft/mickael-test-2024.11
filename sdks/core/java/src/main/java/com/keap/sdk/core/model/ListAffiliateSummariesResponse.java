...
import com.keap.sdk.core.model.AffiliateSummaryRecord;
...
public class ListAffiliateSummariesResponse implements Serializable {
  ...
  private List<@Valid AffiliateSummaryRecord> affiliateSummaries = new ArrayList<>();
  ...
  public ListAffiliateSummariesResponse affiliateSummaries(List<@Valid AffiliateSummaryRecord> affiliateSummaries) {
  ...
  @JsonProperty(JSON_PROPERTY_AFFILIATE_SUMMARIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAffiliateSummaries(List<@Valid AffiliateSummaryRecord> affiliateSummaries) {
    this.affiliateSummaries = affiliateSummaries;
  }


  public ListAffiliateSummariesResponse nextPageToken(String nextPageToken) {
