...
import com.keap.sdk.core.model.AutomationCategory;
...
public class ListAutomationCategoryResponse implements Serializable {
  ...
  private List<@Valid AutomationCategory> automationCategories = new ArrayList<>();
  ...
  public ListAutomationCategoryResponse automationCategories(List<@Valid AutomationCategory> automationCategories) {
  ...
  @JsonProperty(JSON_PROPERTY_AUTOMATION_CATEGORIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAutomationCategories(List<@Valid AutomationCategory> automationCategories) {
    this.automationCategories = automationCategories;
  }


  public ListAutomationCategoryResponse nextPageToken(String nextPageToken) {
