...
public class ListAutomationResponse implements Serializable {
  ...
  private List<@Valid Automation> automations = new ArrayList<>();
  ...
  public ListAutomationResponse automationCount(Integer automationCount) {
  ...
  public ListAutomationResponse automations(List<@Valid Automation> automations) {
  ...
  @JsonProperty(JSON_PROPERTY_AUTOMATIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAutomations(List<@Valid Automation> automations) {
    this.automations = automations;
  }


  public ListAutomationResponse nextPageToken(String nextPageToken) {
