...
public class ListCompaniesResponse implements Serializable {
  ...
  private List<@Valid Company> companies = new ArrayList<>();
  ...
  public ListCompaniesResponse companies(List<@Valid Company> companies) {
  ...
  @JsonProperty(JSON_PROPERTY_COMPANIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCompanies(List<@Valid Company> companies) {
    this.companies = companies;
  }
