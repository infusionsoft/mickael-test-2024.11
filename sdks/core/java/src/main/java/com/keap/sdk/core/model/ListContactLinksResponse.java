...
public class ListContactLinksResponse implements Serializable {
  ...
  private List<@Valid ContactLink> links = new ArrayList<>();
  ...
  public ListContactLinksResponse links(List<@Valid ContactLink> links) {
    this.links = links;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LINKS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLinks(List<@Valid ContactLink> links) {
    this.links = links;
  }


  public ListContactLinksResponse nextPageToken(String nextPageToken) {
