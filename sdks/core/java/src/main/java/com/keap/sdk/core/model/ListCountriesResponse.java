...
import com.keap.sdk.core.model.Country;
...
public class ListCountriesResponse implements Serializable {
  ...
  private List<@Valid Country> countries = new ArrayList<>();

  public ListCountriesResponse() { 
  }

  public ListCountriesResponse countries(List<@Valid Country> countries) {
