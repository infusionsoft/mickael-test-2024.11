...
public class ListLeadSourcesResponse implements Serializable {
  ...
  private List<@Valid LeadSource> leadsources = new ArrayList<>();
  ...
  public ListLeadSourcesResponse leadsources(List<@Valid LeadSource> leadsources) {
  ...
  @JsonProperty(JSON_PROPERTY_LEADSOURCES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLeadsources(List<@Valid LeadSource> leadsources) {
    this.leadsources = leadsources;
  }


  public ListLeadSourcesResponse nextPageToken(String nextPageToken) {
