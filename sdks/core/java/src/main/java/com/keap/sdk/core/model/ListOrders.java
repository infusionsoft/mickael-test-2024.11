...
public class ListOrders implements Serializable {
  ...
  private List<@Valid RestV2Order> orders = new ArrayList<>();

  public ListOrders() { 
  }

  public ListOrders nextPageToken(String nextPageToken) {
  ...
  public ListOrders orders(List<@Valid RestV2Order> orders) {
    this.orders = orders;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ORDERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOrders(List<@Valid RestV2Order> orders) {
    this.orders = orders;
  }
