...
import com.keap.sdk.core.model.Provinces;
...
public class ListProvincesResponse implements Serializable {
  ...
  private List<@Valid Provinces> provinces = new ArrayList<>();

  public ListProvincesResponse() { 
  }

  public ListProvincesResponse provinces(List<@Valid Provinces> provinces) {
  ...
  @JsonProperty(JSON_PROPERTY_PROVINCES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProvinces(List<@Valid Provinces> provinces) {
    this.provinces = provinces;
  }
