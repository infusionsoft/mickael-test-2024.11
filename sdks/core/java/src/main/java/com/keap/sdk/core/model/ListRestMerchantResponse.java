...
import com.keap.sdk.core.model.ListRestMerchantAccountResponse;
...
public class ListRestMerchantResponse implements Serializable {
  ...
  private String defaultMerchantAccountId;

  public static final String JSON_PROPERTY_MERCHANT_ACCOUNTS = "merchant_accounts";
  private List<@Valid ListRestMerchantAccountResponse> merchantAccounts = new ArrayList<>();
  ...
  public ListRestMerchantResponse defaultMerchantAccountId(String defaultMerchantAccountId) {
  ...
  @JsonProperty(JSON_PROPERTY_DEFAULT_MERCHANT_ACCOUNT_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDefaultMerchantAccountId(String defaultMerchantAccountId) {
    this.defaultMerchantAccountId = defaultMerchantAccountId;
  }


  public ListRestMerchantResponse merchantAccounts(List<@Valid ListRestMerchantAccountResponse> merchantAccounts) {
  ...
  @JsonProperty(JSON_PROPERTY_MERCHANT_ACCOUNTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMerchantAccounts(List<@Valid ListRestMerchantAccountResponse> merchantAccounts) {
    this.merchantAccounts = merchantAccounts;
  }


  public ListRestMerchantResponse nextPageToken(String nextPageToken) {
