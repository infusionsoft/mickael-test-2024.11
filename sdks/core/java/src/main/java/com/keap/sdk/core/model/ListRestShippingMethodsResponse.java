...
import com.keap.sdk.core.model.ShippingMethod;
...
public class ListRestShippingMethodsResponse implements Serializable {
  ...
  private List<@Valid ShippingMethod> shippingMethods = new ArrayList<>();

  public ListRestShippingMethodsResponse() { 
  }

  public ListRestShippingMethodsResponse nextPageToken(String nextPageToken) {
  ...
  public ListRestShippingMethodsResponse shippingMethods(List<@Valid ShippingMethod> shippingMethods) {
  ...
  @JsonProperty(JSON_PROPERTY_SHIPPING_METHODS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setShippingMethods(List<@Valid ShippingMethod> shippingMethods) {
    this.shippingMethods = shippingMethods;
  }
