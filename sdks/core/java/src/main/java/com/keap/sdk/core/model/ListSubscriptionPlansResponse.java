...
public class ListSubscriptionPlansResponse implements Serializable {
  ...
  private List<@Valid RestSubscriptionPlan> subscriptions = new ArrayList<>();

  public ListSubscriptionPlansResponse() { 
  }

  public ListSubscriptionPlansResponse nextPageToken(String nextPageToken) {
  ...
  public ListSubscriptionPlansResponse subscriptions(List<@Valid RestSubscriptionPlan> subscriptions) {
  ...
  @JsonProperty(JSON_PROPERTY_SUBSCRIPTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubscriptions(List<@Valid RestSubscriptionPlan> subscriptions) {
    this.subscriptions = subscriptions;
  }
