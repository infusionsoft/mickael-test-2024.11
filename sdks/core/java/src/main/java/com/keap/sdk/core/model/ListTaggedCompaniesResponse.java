...
import com.keap.sdk.core.model.TaggedCompany;
...
public class ListTaggedCompaniesResponse implements Serializable {
  ...
  private List<@Valid TaggedCompany> taggedCompanies = new ArrayList<>();

  public ListTaggedCompaniesResponse() { 
  }

  public ListTaggedCompaniesResponse nextPageToken(String nextPageToken) {
  ...
  public ListTaggedCompaniesResponse taggedCompanies(List<@Valid TaggedCompany> taggedCompanies) {
  ...
  @JsonProperty(JSON_PROPERTY_TAGGED_COMPANIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTaggedCompanies(List<@Valid TaggedCompany> taggedCompanies) {
    this.taggedCompanies = taggedCompanies;
  }
