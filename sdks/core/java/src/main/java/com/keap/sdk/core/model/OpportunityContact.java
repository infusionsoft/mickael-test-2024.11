...
public class OpportunityContact implements Serializable {
  ...
  public OpportunityContact companyName(String companyName) {
  ...
  public OpportunityContact email(String email) {
    this.email = email;
    return this;
  }
  ...
  public OpportunityContact firstName(String firstName) {
  ...
  public OpportunityContact id(String id) {
    this.id = id;
    return this;
  }
  ...
  public OpportunityContact jobTitle(String jobTitle) {
  ...
  public OpportunityContact lastName(String lastName) {
  ...
  public OpportunityContact phoneNumber(String phoneNumber) {
