...
import com.keap.sdk.core.model.StageDetails;
...
public class OpportunityStage implements Serializable {
  ...
  public OpportunityStage details(StageDetails details) {
  ...
  @JsonProperty(JSON_PROPERTY_DETAILS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDetails(StageDetails details) {
    this.details = details;
  }


  public OpportunityStage id(String id) {
    this.id = id;
    return this;
  }
  ...
  public OpportunityStage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public OpportunityStage reasons(List<String> reasons) {
