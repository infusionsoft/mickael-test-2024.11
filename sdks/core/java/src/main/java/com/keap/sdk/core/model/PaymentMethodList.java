...
import com.keap.sdk.core.model.RestPaymentMethod;
...
public class PaymentMethodList implements Serializable {
  ...
  private List<@Valid RestPaymentMethod> records = new ArrayList<>();

  public PaymentMethodList() { 
  }

  public PaymentMethodList nextPageToken(String nextPageToken) {
  ...
  public PaymentMethodList records(List<@Valid RestPaymentMethod> records) {
  ...
  @JsonProperty(JSON_PROPERTY_RECORDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRecords(List<@Valid RestPaymentMethod> records) {
    this.records = records;
  }
