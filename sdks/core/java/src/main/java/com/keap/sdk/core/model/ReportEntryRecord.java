...
import com.keap.sdk.core.model.ReportEntryValue;
...
public class ReportEntryRecord implements Serializable {
  ...
  private List<@Valid ReportEntryValue> columns = new ArrayList<>();

  public ReportEntryRecord() { 
  }

  public ReportEntryRecord columns(List<@Valid ReportEntryValue> columns) {
  ...
  @JsonProperty(JSON_PROPERTY_COLUMNS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setColumns(List<@Valid ReportEntryValue> columns) {
    this.columns = columns;
  }
