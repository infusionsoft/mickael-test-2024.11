...
import com.keap.sdk.core.model.ReportEntryRecord;
...
public class ReportExecutionResult implements Serializable {
  ...
  private List<@Valid ReportEntryRecord> results = new ArrayList<>();

  public ReportExecutionResult() { 
  }

  public ReportExecutionResult pageToken(String pageToken) {
  ...
  public ReportExecutionResult results(List<@Valid ReportEntryRecord> results) {
  ...
  @JsonProperty(JSON_PROPERTY_RESULTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResults(List<@Valid ReportEntryRecord> results) {
    this.results = results;
  }
