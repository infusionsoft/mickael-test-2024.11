...
public class RestCreateOrderRequest implements Serializable {
  ...
  private List<@Valid CreateRestOrderItemRequest> orderItems = new ArrayList<>();
  ...
  public RestCreateOrderRequest contactId(String contactId) {
  ...
  public RestCreateOrderRequest leadAffiliateId(String leadAffiliateId) {
  ...
  public RestCreateOrderRequest orderItems(List<@Valid CreateRestOrderItemRequest> orderItems) {
  ...
  @JsonProperty(JSON_PROPERTY_ORDER_ITEMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOrderItems(List<@Valid CreateRestOrderItemRequest> orderItems) {
    this.orderItems = orderItems;
  }


  public RestCreateOrderRequest orderTime(String orderTime) {
  ...
  public RestCreateOrderRequest orderTitle(String orderTitle) {
  ...
  public RestCreateOrderRequest orderType(OrderTypeEnum orderType) {
  ...
  public RestCreateOrderRequest promoCodes(List<String> promoCodes) {
  ...
  public RestCreateOrderRequest salesAffiliateId(String salesAffiliateId) {
  ...
  public RestCreateOrderRequest shippingAddress(AddressInformation shippingAddress) {
