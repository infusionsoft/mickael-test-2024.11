...
import com.keap.sdk.core.model.CheckListItem;
 ...
 */
@JsonPropertyOrder({
  RestOpportunityStage.JSON_PROPERTY_CHECK_LIST_ITEMS,
...
public class RestOpportunityStage implements Serializable {
  ...
  private List<@Valid CheckListItem> checkListItems = new ArrayList<>();
  ...
  public RestOpportunityStage checkListItems(List<@Valid CheckListItem> checkListItems) {
  ...
  @JsonProperty(JSON_PROPERTY_CHECK_LIST_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCheckListItems(List<@Valid CheckListItem> checkListItems) {
    this.checkListItems = checkListItems;
  }


  public RestOpportunityStage createdTime(String createdTime) {
  ...
  public RestOpportunityStage id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RestOpportunityStage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestOpportunityStage order(Integer order) {
    this.order = order;
    return this;
  }
  ...
  public RestOpportunityStage probability(Integer probability) {
  ...
  public RestOpportunityStage targetNumberDays(Integer targetNumberDays) {
  ...
  public RestOpportunityStage updatedTime(String updatedTime) {
