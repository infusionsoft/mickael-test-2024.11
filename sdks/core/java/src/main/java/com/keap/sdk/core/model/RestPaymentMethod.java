...
import com.keap.sdk.core.model.CardInfo;
...
public class RestPaymentMethod implements Serializable {
  ...
  public RestPaymentMethod cardInfo(CardInfo cardInfo) {
  ...
  public RestPaymentMethod dateCreated(ZonedDateTime dateCreated) {
  ...
  public RestPaymentMethod id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RestPaymentMethod paymentMethodType(String paymentMethodType) {
  ...
  public RestPaymentMethod processorId(UUID processorId) {
  ...
  public RestPaymentMethod processorType(String processorType) {
