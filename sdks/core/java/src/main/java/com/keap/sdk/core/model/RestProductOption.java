...
import com.keap.sdk.core.model.RestProductOptionValue;
...
public class RestProductOption implements Serializable {
  ...
  private List<@Valid RestProductOptionValue> values = new ArrayList<>();

  public RestProductOption() { 
  }

  public RestProductOption allowSpaces(Boolean allowSpaces) {
  ...
  public RestProductOption canContainCharacter(Boolean canContainCharacter) {
  ...
  public RestProductOption canContainNumber(Boolean canContainNumber) {
  ...
  public RestProductOption canEndWithCharacter(Boolean canEndWithCharacter) {
  ...
  public RestProductOption canEndWithNumber(Boolean canEndWithNumber) {
  ...
  public RestProductOption canStartWithCharacter(Boolean canStartWithCharacter) {
  ...
  public RestProductOption canStartWithNumber(Boolean canStartWithNumber) {
  ...
  public RestProductOption displayIndex(Integer displayIndex) {
  ...
  public RestProductOption id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RestProductOption label(String label) {
    this.label = label;
    return this;
  }
  ...
  public RestProductOption maxChars(Integer maxChars) {
  ...
  public RestProductOption minChars(Integer minChars) {
  ...
  public RestProductOption name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestProductOption required(Boolean required) {
  ...
  public RestProductOption textMessage(String textMessage) {
  ...
  public RestProductOption type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public RestProductOption values(List<@Valid RestProductOptionValue> values) {
    this.values = values;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALUES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(List<@Valid RestProductOptionValue> values) {
    this.values = values;
  }
