...
public class RestSubscriptionPlan implements Serializable {
  ...
  private Integer subscriptionPlanIndex;
  ...
  public RestSubscriptionPlan active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public RestSubscriptionPlan cycle(String cycle) {
    this.cycle = cycle;
    return this;
  }
  ...
  public RestSubscriptionPlan frequency(Integer frequency) {
  ...
  public RestSubscriptionPlan id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RestSubscriptionPlan productId(String productId) {
  ...
  public RestSubscriptionPlan subscriptionPlanIndex(Integer subscriptionPlanIndex) {
  ...
  public RestSubscriptionPlan subscriptionPlanName(String subscriptionPlanName) {
