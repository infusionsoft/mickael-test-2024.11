...
import com.keap.sdk.core.model.BasicContact;
import com.keap.sdk.core.model.PaymentPlan;
import com.keap.sdk.core.model.RestV2OrderItem;
import com.keap.sdk.core.model.ShippingInformation;
...
public class RestV2Order implements Serializable {
  ...
  private List<@Valid RestV2OrderItem> orderItems = new ArrayList<>();
  ...
  public RestV2Order allowPayment(Boolean allowPayment) {
  ...
  public RestV2Order allowPaypal(Boolean allowPaypal) {
  ...
  public RestV2Order contact(BasicContact contact) {
  ...
  @JsonProperty(JSON_PROPERTY_CONTACT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setContact(BasicContact contact) {
    this.contact = contact;
  }


  public RestV2Order creationTime(String creationTime) {
  ...
  public RestV2Order id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RestV2Order invoiceNumber(String invoiceNumber) {
  ...
  public RestV2Order leadAffiliateId(String leadAffiliateId) {
  ...
  public RestV2Order modificationTime(String modificationTime) {
  ...
  public RestV2Order notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public RestV2Order orderItems(List<@Valid RestV2OrderItem> orderItems) {
  ...
  @JsonProperty(JSON_PROPERTY_ORDER_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOrderItems(List<@Valid RestV2OrderItem> orderItems) {
    this.orderItems = orderItems;
  }


  public RestV2Order orderTime(String orderTime) {
  ...
  public RestV2Order orderType(String orderType) {
  ...
  public RestV2Order paymentPlan(PaymentPlan paymentPlan) {
  ...
  public RestV2Order recurring(Boolean recurring) {
  ...
  public RestV2Order refundTotal(Double refundTotal) {
  ...
  public RestV2Order salesAffiliateId(String salesAffiliateId) {
  ...
  public RestV2Order shippingInformation(ShippingInformation shippingInformation) {
  ...
  public RestV2Order sourceType(SourceTypeEnum sourceType) {
  ...
  public RestV2Order status(String status) {
    this.status = status;
    return this;
  }
  ...
  public RestV2Order terms(String terms) {
    this.terms = terms;
    return this;
  }
  ...
  public RestV2Order title(String title) {
    this.title = title;
    return this;
  }
  ...
  public RestV2Order total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public RestV2Order totalDue(Double totalDue) {
  ...
  public RestV2Order totalPaid(Double totalPaid) {
