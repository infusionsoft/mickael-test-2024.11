...
public class RestV2Subscription implements Serializable {
  ...
  private Integer subscriptionCyclesCompleted;
  ...
  private String subscriptionNextBillDate;
  ...
  public RestV2Subscription subscriptionActive(Boolean subscriptionActive) {
  ...
  public RestV2Subscription subscriptionCyclesCompleted(Integer subscriptionCyclesCompleted) {
  ...
  @JsonProperty(JSON_PROPERTY_SUBSCRIPTION_CYCLES_COMPLETED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubscriptionCyclesCompleted(Integer subscriptionCyclesCompleted) {
    this.subscriptionCyclesCompleted = subscriptionCyclesCompleted;
  }


  public RestV2Subscription subscriptionEndDate(String subscriptionEndDate) {
  ...
  public RestV2Subscription subscriptionId(String subscriptionId) {
  ...
  public RestV2Subscription subscriptionNextBillDate(String subscriptionNextBillDate) {
  ...
  @JsonProperty(JSON_PROPERTY_SUBSCRIPTION_NEXT_BILL_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubscriptionNextBillDate(String subscriptionNextBillDate) {
    this.subscriptionNextBillDate = subscriptionNextBillDate;
  }


  public RestV2Subscription subscriptionStartDate(String subscriptionStartDate) {
