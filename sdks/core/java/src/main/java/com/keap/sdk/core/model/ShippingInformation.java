...
public class ShippingInformation implements Serializable {
  ...
  private Boolean invoiceToCompany;
  ...
  public ShippingInformation addresses(List<@Valid Address> addresses) {
  ...
  public ShippingInformation company(BasicCompany company) {
  ...
  public ShippingInformation familyName(String familyName) {
  ...
  public ShippingInformation givenName(String givenName) {
  ...
  public ShippingInformation id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ShippingInformation invoiceToCompany(Boolean invoiceToCompany) {
  ...
  @JsonProperty(JSON_PROPERTY_INVOICE_TO_COMPANY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInvoiceToCompany(Boolean invoiceToCompany) {
    this.invoiceToCompany = invoiceToCompany;
  }


  public ShippingInformation phoneNumbers(List<@Valid PhoneNumber> phoneNumbers) {
