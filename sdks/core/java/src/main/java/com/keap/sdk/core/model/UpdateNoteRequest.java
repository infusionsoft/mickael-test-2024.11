...
public class UpdateNoteRequest implements Serializable {
  ...
  public UpdateNoteRequest contactId(String contactId) {
  ...
  public UpdateNoteRequest text(String text) {
    this.text = text;
    return this;
  }
  ...
  public UpdateNoteRequest title(String title) {
    this.title = title;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "A value for either `title` or `type` is required.")
  ...
  public UpdateNoteRequest type(String type) {
    this.type = type;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "A value for either `title` or `type` is required. The value may be one of `Appointment`, `Call`, `Email`, `Fax`, `Letter` or `Other` in Keap Max/Pro, or an admin-configured value in Classic.")
  ...
  public UpdateNoteRequest userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contactId, text, title, type, userId);
  }
