...
import com.keap.sdk.core.model.CategoryReference;
...
public class UpdateTagResponse implements Serializable {
  ...
  public UpdateTagResponse category(CategoryReference category) {
  ...
  public UpdateTagResponse description(String description) {
  ...
  public UpdateTagResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public UpdateTagResponse name(String name) {
    this.name = name;
    return this;
  }
