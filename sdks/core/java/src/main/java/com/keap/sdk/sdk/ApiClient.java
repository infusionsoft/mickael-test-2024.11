 ...
 */
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")public class ApiClient {
 ...
 /**
  ...
  private static final String DEFAULT_RETRY_NAME = "default-sdk-retry";

  private static final RetryConfig retryConfig = RetryConfig.<HttpResponse<InputStream>>custom()
      .maxAttempts(5)
      .intervalFunction(IntervalFunction.ofExponentialRandomBackoff(100))
      .retryOnException(e -> {
        // IOException: Problems with timeouts, connection, host, routes
        // IllegalStateException: Read body after connection closed
        return e instanceof IOException || e instanceof IllegalStateException;
      })
      .retryOnResult(httpResponse ->
  ...
  public static Retry getRetry() {
      return retryRegistry.retry(DEFAULT_RETRY_NAME);
  }
}
