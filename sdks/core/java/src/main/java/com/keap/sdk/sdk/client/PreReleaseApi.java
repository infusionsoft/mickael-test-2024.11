...
import com.keap.sdk.sdk.model.UpdateProductInventoryRequest;
...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")public class PreReleaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public RestV2Product adjustInventoryUsingPOST(String productId, UpdateProductInventoryRequest updateProductInventoryRequest) throws ApiException {
    ApiResponse<RestV2Product> localVarResponse = adjustInventoryUsingPOSTWithHttpInfo(productId, updateProductInventoryRequest);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RestV2Product> adjustInventoryUsingPOSTWithHttpInfo(String productId, UpdateProductInventoryRequest updateProductInventoryRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = adjustInventoryUsingPOSTRequestBuilder(productId, updateProductInventoryRequest);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("adjustInventoryUsingPOST", localVarResponse);
        }
  ...
  private HttpRequest.Builder adjustInventoryUsingPOSTRequestBuilder(String productId, UpdateProductInventoryRequest updateProductInventoryRequest) throws ApiException {
    // verify the required parameter 'productId' is set
    if (productId == null) {
      throw new ApiException(400, "Missing the required parameter 'productId' when calling adjustInventoryUsingPOST");
    }
    // verify the required parameter 'updateProductInventoryRequest' is set
    if (updateProductInventoryRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'updateProductInventoryRequest' when calling adjustInventoryUsingPOST");
    }
