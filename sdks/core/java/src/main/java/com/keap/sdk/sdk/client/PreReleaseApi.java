...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.9.0")public class PreReleaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public CategoryDiscount getCategoryDiscountUsingGET(String discountId) throws ApiException {
    ApiResponse<CategoryDiscount> localVarResponse = getCategoryDiscountUsingGETWithHttpInfo(discountId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CategoryDiscount> getCategoryDiscountUsingGETWithHttpInfo(String discountId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getCategoryDiscountUsingGETRequestBuilder(discountId);
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getCategoryDiscountUsingGET", localVarResponse);
        }
  ...
  private HttpRequest.Builder getCategoryDiscountUsingGETRequestBuilder(String discountId) throws ApiException {
    // verify the required parameter 'discountId' is set
    if (discountId == null) {
      throw new ApiException(400, "Missing the required parameter 'discountId' when calling getCategoryDiscountUsingGET");
    }
