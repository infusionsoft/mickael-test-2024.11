...
public class AddToAutomationSequenceResponse implements Serializable {
  ...
  private Map<String, String> addToAutomationSequenceResults = new HashMap<>();

  public AddToAutomationSequenceResponse() { 
  }

  public AddToAutomationSequenceResponse addToAutomationSequenceResults(Map<String, String> addToAutomationSequenceResults) {
  ...
  @JsonProperty(JSON_PROPERTY_ADD_TO_AUTOMATION_SEQUENCE_RESULTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAddToAutomationSequenceResults(Map<String, String> addToAutomationSequenceResults) {
    this.addToAutomationSequenceResults = addToAutomationSequenceResults;
  }
