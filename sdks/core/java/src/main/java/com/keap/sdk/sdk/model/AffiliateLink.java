...
public class AffiliateLink implements Serializable {
  ...
  public AffiliateLink affiliateId(String affiliateId) {
  ...
  public AffiliateLink dateCreated(String dateCreated) {
  ...
  public AffiliateLink id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AffiliateLink localUrlCode(String localUrlCode) {
  ...
  @JsonProperty(JSON_PROPERTY_LOCAL_URL_CODE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLocalUrlCode(String localUrlCode) {
    this.localUrlCode = localUrlCode;
  }
  ...
  public AffiliateLink programIds(List<String> programIds) {
  ...
  public AffiliateLink redirectUrl(String redirectUrl) {
