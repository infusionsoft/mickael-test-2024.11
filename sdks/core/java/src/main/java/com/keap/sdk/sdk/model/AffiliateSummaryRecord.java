...
public class AffiliateSummaryRecord implements Serializable {
  ...
  private Double clawbacks;

  public AffiliateSummaryRecord() { 
  }

  public AffiliateSummaryRecord affiliateId(Long affiliateId) {
  ...
  public AffiliateSummaryRecord amountEarned(Double amountEarned) {
  ...
  public AffiliateSummaryRecord balance(Double balance) {
  ...
  public AffiliateSummaryRecord clawbacks(Double clawbacks) {
  ...
  @JsonProperty(JSON_PROPERTY_CLAWBACKS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setClawbacks(Double clawbacks) {
    this.clawbacks = clawbacks;
  }
