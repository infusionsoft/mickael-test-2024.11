...
public class ApplicationConfigurationModuleFulfillment implements Serializable {
  ...
  private String defaultMessageFields;
  ...
  public ApplicationConfigurationModuleFulfillment defaultMessageFields(String defaultMessageFields) {
  ...
  @JsonProperty(JSON_PROPERTY_DEFAULT_MESSAGE_FIELDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDefaultMessageFields(String defaultMessageFields) {
    this.defaultMessageFields = defaultMessageFields;
  }


  public ApplicationConfigurationModuleFulfillment defaultMessageTo(String defaultMessageTo) {
  ...
  @JsonProperty(JSON_PROPERTY_DEFAULT_MESSAGE_TO)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDefaultMessageTo(String defaultMessageTo) {
    this.defaultMessageTo = defaultMessageTo;
  }
