...
public class ApplicationConfigurationModuleTemplate implements Serializable {
  ...
  private Integer defaultCountryCode;
  ...
  public ApplicationConfigurationModuleTemplate defaultCountryCode(Integer defaultCountryCode) {
  ...
  @JsonProperty(JSON_PROPERTY_DEFAULT_COUNTRY_CODE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDefaultCountryCode(Integer defaultCountryCode) {
    this.defaultCountryCode = defaultCountryCode;
  }


  public ApplicationConfigurationModuleTemplate defaultUserId(Long defaultUserId) {
