...
public class BasicContact implements Serializable {
  ...
  public BasicContact email(String email) {
    this.email = email;
    return this;
  }
  ...
  public BasicContact familyName(String familyName) {
  ...
  public BasicContact givenName(String givenName) {
  ...
  public BasicContact id(String id) {
    this.id = id;
    return this;
  }
