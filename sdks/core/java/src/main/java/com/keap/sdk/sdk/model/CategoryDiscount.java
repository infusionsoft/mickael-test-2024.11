...
public class CategoryDiscount implements Serializable {
  ...
  @jakarta.annotation.Nullable  private Integer applyToCommissions;
  ...
  @jakarta.annotation.Nullable  private List<@Valid Criteria> criteria = new ArrayList<>();
  ...
  public CategoryDiscount applyToCommissions(@jakarta.annotation.Nullable Integer applyToCommissions) {
  ...
  @JsonProperty(JSON_PROPERTY_APPLY_TO_COMMISSIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setApplyToCommissions(@jakarta.annotation.Nullable Integer applyToCommissions) {
    this.applyToCommissions = applyToCommissions;
  }
  ...
  public CategoryDiscount criteria(@jakarta.annotation.Nullable List<@Valid Criteria> criteria) {
  ...
  @JsonProperty(JSON_PROPERTY_CRITERIA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCriteria(@jakarta.annotation.Nullable List<@Valid Criteria> criteria) {
    this.criteria = criteria;
  }
