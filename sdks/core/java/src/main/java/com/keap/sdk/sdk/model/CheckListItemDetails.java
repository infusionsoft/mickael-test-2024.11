...
public class CheckListItemDetails implements Serializable {
  ...
  public CheckListItemDetails description(String description) {
  ...
  public CheckListItemDetails doneDate(ZonedDateTime doneDate) {
  ...
  public CheckListItemDetails id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public CheckListItemDetails instanceId(Long instanceId) {
  ...
  public CheckListItemDetails itemOrder(Integer itemOrder) {
  ...
  public CheckListItemDetails required(Boolean required) {
