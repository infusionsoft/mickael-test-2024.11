...
public class CreateCustomFieldOptionRequest implements Serializable {
  ...
  public CreateCustomFieldOptionRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public CreateCustomFieldOptionRequest options(List<@Valid CreateCustomFieldOptionRequest> options) {
