...
public class DeleteFunnelIntegrationRequest implements Serializable {
  ...
  private List<String> integrationNames = new ArrayList<>();

  public static final String JSON_PROPERTY_TRIGGER_NAMES = "trigger_names";
  private List<String> triggerNames = new ArrayList<>();

  public DeleteFunnelIntegrationRequest() { 
  }

  public DeleteFunnelIntegrationRequest actionNames(List<String> actionNames) {
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The name of the actions, that will be looked for and uninstalled.")
  ...
  public DeleteFunnelIntegrationRequest integrationNames(List<String> integrationNames) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The name of the integrations, that will be looked for and uninstalled. This will uninstall all triggers and actions related to this automation.")
  ...
  @JsonProperty(JSON_PROPERTY_INTEGRATION_NAMES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIntegrationNames(List<String> integrationNames) {
    this.integrationNames = integrationNames;
  }


  public DeleteFunnelIntegrationRequest triggerNames(List<String> triggerNames) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The name of the triggers, that will be looked for and uninstalled.")
