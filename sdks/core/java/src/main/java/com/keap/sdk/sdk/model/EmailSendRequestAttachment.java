...
public class EmailSendRequestAttachment implements Serializable {
  ...
  public EmailSendRequestAttachment fileData(String fileData) {
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The content of the attachment, encoded in Base64")
  ...
  public EmailSendRequestAttachment fileName(String fileName) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The filename of the attached file, including extension")
