...
public class FunnelIntegrationHttpRequest implements Serializable {
  ...
  public FunnelIntegrationHttpRequest body(String body) {
    this.body = body;
    return this;
  }
  ...
  @Schema(example = "", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The body of the HTTP request that will be made when this action is processed in the builder(s).")
  ...
  public FunnelIntegrationHttpRequest callType(String callType) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(example = "POST", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The type of HTTP request that will be made when this action is processed in the builder(s).")
  ...
  public FunnelIntegrationHttpRequest headerParameters(Map<String, String> headerParameters) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(example = "{\"header1\":\"value1\",\"contact_name\":\"~Contact.FirstName~\"}", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "A map of the header parameters of the HTTP request that will be made when this action is processed in the builder(s).")
  ...
  public FunnelIntegrationHttpRequest queryParameters(Map<String, String> queryParameters) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(example = "{\"param1\":\"value1\",\"contact_name\":\"~Contact.FirstName~\"}", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "A map of the query parameters of the HTTP request that will be made when this action is processed in the builder(s).")
  ...
  public FunnelIntegrationHttpRequest url(String url) {
    this.url = url;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(example = "https://api.example.com", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The URL of the HTTP request that will be made when this action is processed in the builder(s).")
