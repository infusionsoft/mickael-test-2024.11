...
public class Link implements Serializable {
  ...
  private String linkedContactId;
  ...
  public Link linkTypeId(String linkTypeId) {
  ...
  public Link linkTypeName(String linkTypeName) {
  ...
  public Link linkedContactId(String linkedContactId) {
  ...
  @JsonProperty(JSON_PROPERTY_LINKED_CONTACT_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLinkedContactId(String linkedContactId) {
    this.linkedContactId = linkedContactId;
  }
