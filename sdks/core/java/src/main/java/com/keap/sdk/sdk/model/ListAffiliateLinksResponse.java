...
public class ListAffiliateLinksResponse implements Serializable {
  ...
  private List<@Valid AffiliateLink> affiliateLinks = new ArrayList<>();
  ...
  public ListAffiliateLinksResponse affiliateLinks(List<@Valid AffiliateLink> affiliateLinks) {
  ...
  @JsonProperty(JSON_PROPERTY_AFFILIATE_LINKS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAffiliateLinks(List<@Valid AffiliateLink> affiliateLinks) {
    this.affiliateLinks = affiliateLinks;
  }


  public ListAffiliateLinksResponse nextPageToken(String nextPageToken) {
