...
public class ObjectModel implements Serializable {
  ...
  private List<@Valid CustomFieldMetaData> customFields = new ArrayList<>();
  ...
  public ObjectModel customFields(List<@Valid CustomFieldMetaData> customFields) {
  ...
  @JsonProperty(JSON_PROPERTY_CUSTOM_FIELDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCustomFields(List<@Valid CustomFieldMetaData> customFields) {
    this.customFields = customFields;
  }


  public ObjectModel optionalProperties(List<String> optionalProperties) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "These fields are not transmitted by default on this model, but can be requested by specifying them in a comma-separated list in the optional_properties query parameter.")
