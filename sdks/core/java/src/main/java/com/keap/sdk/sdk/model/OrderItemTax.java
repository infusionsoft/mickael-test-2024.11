...
public class OrderItemTax implements Serializable {
  ...
  private Long taxTemplateId;

  public OrderItemTax() { 
  }

  public OrderItemTax amount(Double amount) {
    this.amount = amount;
    return this;
  }
  ...
  public OrderItemTax id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public OrderItemTax name(String name) {
    this.name = name;
    return this;
  }
  ...
  public OrderItemTax orderItemId(Long orderItemId) {
  ...
  public OrderItemTax rate(Double rate) {
    this.rate = rate;
    return this;
  }
  ...
  public OrderItemTax taxTemplateId(Long taxTemplateId) {
  ...
  @JsonProperty(JSON_PROPERTY_TAX_TEMPLATE_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTaxTemplateId(Long taxTemplateId) {
    this.taxTemplateId = taxTemplateId;
  }
