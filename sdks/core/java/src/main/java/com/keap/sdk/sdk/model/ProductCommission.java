...
public class ProductCommission implements Serializable {
  ...
  public ProductCommission dollarAmount(Double dollarAmount) {
  ...
  public ProductCommission percentage(Double percentage) {
  ...
  public ProductCommission productId(String productId) {
  ...
  public ProductCommission productName(String productName) {
  ...
  public ProductCommission productPrice(Double productPrice) {
