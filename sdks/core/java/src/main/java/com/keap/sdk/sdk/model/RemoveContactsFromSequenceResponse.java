...
public class RemoveContactsFromSequenceResponse implements Serializable {
  ...
  private Map<String, String> removeFromSequenceResults = new HashMap<>();

  public RemoveContactsFromSequenceResponse() { 
  }

  public RemoveContactsFromSequenceResponse removeFromSequenceResults(Map<String, String> removeFromSequenceResults) {
  ...
  @JsonProperty(JSON_PROPERTY_REMOVE_FROM_SEQUENCE_RESULTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRemoveFromSequenceResults(Map<String, String> removeFromSequenceResults) {
    this.removeFromSequenceResults = removeFromSequenceResults;
  }
