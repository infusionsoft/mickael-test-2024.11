...
public class RestPaymentGateway implements Serializable {
  ...
  public RestPaymentGateway merchantAccountId(String merchantAccountId) {
  ...
  public RestPaymentGateway merchantAccountName(String merchantAccountName) {
  ...
  public RestPaymentGateway useDefault(Boolean useDefault) {
