...
public class RestProductOptionValue implements Serializable {
  ...
  public RestProductOptionValue id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RestProductOptionValue index(Integer index) {
    this.index = index;
    return this;
  }
  ...
  public RestProductOptionValue isDefault(Boolean isDefault) {
  ...
  public RestProductOptionValue label(String label) {
    this.label = label;
    return this;
  }
  ...
  public RestProductOptionValue priceAdjustment(Double priceAdjustment) {
  ...
  public RestProductOptionValue sku(String sku) {
    this.sku = sku;
    return this;
  }
