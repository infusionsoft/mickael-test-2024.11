...
public class RestSubscriptionV2 implements Serializable {
  ...
  public RestSubscriptionV2 endDate(@jakarta.annotation.Nullable LocalDate endDate) {
  ...
  public RestSubscriptionV2 nextBillDate(@jakarta.annotation.Nullable LocalDate nextBillDate) {
  ...
  public RestSubscriptionV2 paymentMethodId(@jakarta.annotation.Nullable Long paymentMethodId) {
  ...
  public RestSubscriptionV2 startDate(@jakarta.annotation.Nullable LocalDate startDate) {
