...
public class RestSubscriptionV2 implements Serializable {
  ...
  public RestSubscriptionV2 active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public RestSubscriptionV2 allowTax(Boolean allowTax) {
  ...
  public RestSubscriptionV2 autoCharge(Boolean autoCharge) {
  ...
  public RestSubscriptionV2 billingAmount(Double billingAmount) {
  ...
  public RestSubscriptionV2 billingCycle(BillingCycleEnum billingCycle) {
  ...
  public RestSubscriptionV2 billingFrequency(Integer billingFrequency) {
  ...
  public RestSubscriptionV2 contactId(String contactId) {
  ...
  public RestSubscriptionV2 endDate(LocalDate endDate) {
  ...
  public RestSubscriptionV2 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RestSubscriptionV2 nextBillDate(LocalDate nextBillDate) {
  ...
  public RestSubscriptionV2 paymentGatewayId(String paymentGatewayId) {
  ...
  public RestSubscriptionV2 paymentMethodId(Long paymentMethodId) {
  ...
  public RestSubscriptionV2 productId(String productId) {
  ...
  public RestSubscriptionV2 quantity(Long quantity) {
  ...
  public RestSubscriptionV2 saleAffiliateId(String saleAffiliateId) {
  ...
  public RestSubscriptionV2 startDate(LocalDate startDate) {
  ...
  public RestSubscriptionV2 subscriptionPlanId(String subscriptionPlanId) {
    ...
    public static class Builder {
        ...
        public RestSubscriptionV2.Builder active(Boolean active) {
          ...
          return this;
            ...
            public RestSubscriptionV2.Builder endDate(LocalDate endDate) {
          ...
          return this;
            ...
            public RestSubscriptionV2.Builder nextBillDate(LocalDate nextBillDate) {
          ...
          return this;
            ...
            public RestSubscriptionV2.Builder paymentMethodId(Long paymentMethodId) {
          ...
          return this;
            ...
            public RestSubscriptionV2.Builder startDate(LocalDate startDate) {
