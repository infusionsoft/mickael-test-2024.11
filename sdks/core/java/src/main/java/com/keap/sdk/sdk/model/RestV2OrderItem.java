...
import com.keap.sdk.sdk.model.RestProduct;
...
public class RestV2OrderItem implements Serializable {
  ...
  public enum CycleEnum {
    ...
    DAY_OF_YEAR(String.valueOf("DAY_OF_YEAR")),
  ...
  @jakarta.annotation.Nullable  private RestProduct product;
  ...
  public RestV2OrderItem product(@jakarta.annotation.Nullable RestProduct product) {
  ...
  @JsonProperty(JSON_PROPERTY_PRODUCT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProduct(@jakarta.annotation.Nullable RestProduct product) {
    this.product = product;
  }
