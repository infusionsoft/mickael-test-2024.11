...
public class RestV2PatchOrderRequest implements Serializable {
  ...
  public RestV2PatchOrderRequest contactId(@jakarta.annotation.Nullable String contactId) {
  ...
  public RestV2PatchOrderRequest leadAffiliateId(@jakarta.annotation.Nullable String leadAffiliateId) {
  ...
  public RestV2PatchOrderRequest orderTime(@jakarta.annotation.Nullable String orderTime) {
  ...
  public RestV2PatchOrderRequest orderTitle(@jakarta.annotation.Nullable String orderTitle) {
  ...
  public RestV2PatchOrderRequest orderType(@jakarta.annotation.Nullable OrderTypeEnum orderType) {
  ...
  public RestV2PatchOrderRequest promoCodes(@jakarta.annotation.Nullable List<String> promoCodes) {
  ...
  public RestV2PatchOrderRequest salesAffiliateId(@jakarta.annotation.Nullable String salesAffiliateId) {
  ...
  public RestV2PatchOrderRequest shippingAddress(@jakarta.annotation.Nullable AddressInformation shippingAddress) {
