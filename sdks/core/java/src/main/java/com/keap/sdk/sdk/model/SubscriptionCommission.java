...
public class SubscriptionCommission implements Serializable {
  ...
  public SubscriptionCommission dollarAmount(Double dollarAmount) {
  ...
  public SubscriptionCommission name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SubscriptionCommission percentage(Double percentage) {
  ...
  public SubscriptionCommission planPrice(Double planPrice) {
  ...
  public SubscriptionCommission subscriptionId(String subscriptionId) {
