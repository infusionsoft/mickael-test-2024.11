...
public class UpdateTaskResponse implements Serializable {
  ...
  public UpdateTaskResponse assignedToUserId(String assignedToUserId) {
  ...
  public UpdateTaskResponse completed(Boolean completed) {
  ...
  public UpdateTaskResponse completionTime(String completionTime) {
  ...
  public UpdateTaskResponse contactId(String contactId) {
  ...
  public UpdateTaskResponse createTime(String createTime) {
   ...
   */
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "On initial object the returned value for this property may not accurately represent the exact stored value.")
  ...
  public UpdateTaskResponse createdByUserId(String createdByUserId) {
  ...
  public UpdateTaskResponse dueTime(String dueTime) {
  ...
  public UpdateTaskResponse modificationTime(String modificationTime) {
  ...
  public UpdateTaskResponse priority(PriorityEnum priority) {
  ...
  public UpdateTaskResponse remindTimeMins(Integer remindTimeMins) {
  ...
  public UpdateTaskResponse title(String title) {
    this.title = title;
    return this;
  }
  ...
  public UpdateTaskResponse type(TypeEnum type) {
    this.type = type;
    return this;
  }
