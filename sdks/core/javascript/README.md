...
*KeapCoreServiceCoreSdk.CategoryDiscountApi* | [**createDiscountUsingPOST**](docs/CategoryDiscountApi.md#createDiscountUsingPOST) | **POST** /v2/discounts/productCategories | Create a Category Discount
...
*KeapCoreServiceCoreSdk.CategoryDiscountApi* | [**listCategoryDiscountsUsingGET**](docs/CategoryDiscountApi.md#listCategoryDiscountsUsingGET) | **GET** /v2/discounts/productCategories | List Category Discounts
...
*KeapCoreServiceCoreSdk.FilesApi* | [**createFileUsingPOST1**](docs/FilesApi.md#createFileUsingPOST1) | **POST** /v2/files | Create a file
*KeapCoreServiceCoreSdk.FilesApi* | [**deleteFileUsingDELETE1**](docs/FilesApi.md#deleteFileUsingDELETE1) | **DELETE** /v2/files/{file_id} | Delete a file
*KeapCoreServiceCoreSdk.FilesApi* | [**getFileDataUsingGET**](docs/FilesApi.md#getFileDataUsingGET) | **GET** /v2/files/{file_id}:data | Retrieve a file&#39;s data
*KeapCoreServiceCoreSdk.FilesApi* | [**getFileUsingGET1**](docs/FilesApi.md#getFileUsingGET1) | **GET** /v2/files/{file_id} | Retrieve a file
*KeapCoreServiceCoreSdk.FilesApi* | [**listFilesUsingGET1**](docs/FilesApi.md#listFilesUsingGET1) | **GET** /v2/files | List all files
*KeapCoreServiceCoreSdk.FilesApi* | [**updateFileUsingPATCH**](docs/FilesApi.md#updateFileUsingPATCH) | **PATCH** /v2/files/{file_id} | Update a file
...
*KeapCoreServiceCoreSdk.LeadScoreApi* | [**getLeadScoreDetailsUsingGET**](docs/LeadScoreApi.md#getLeadScoreDetailsUsingGET) | **GET** /v2/contact/{contact_id}/leadScore | Retrieve Lead Score of a Contact
*KeapCoreServiceCoreSdk.LeadSourceCategoriesApi* | [**createLeadSourceCategoryUsingPOST**](docs/LeadSourceCategoriesApi.md#createLeadSourceCategoryUsingPOST) | **POST** /v2/leadSourceCategories | Create a Lead Source Category
*KeapCoreServiceCoreSdk.LeadSourceCategoriesApi* | [**deleteLeadSourceCategoryUsingDELETE**](docs/LeadSourceCategoriesApi.md#deleteLeadSourceCategoryUsingDELETE) | **DELETE** /v2/leadSourceCategories/{category_id} | Delete a Lead Source Category
*KeapCoreServiceCoreSdk.LeadSourceCategoriesApi* | [**getLeadSourceCategoryUsingGET**](docs/LeadSourceCategoriesApi.md#getLeadSourceCategoryUsingGET) | **GET** /v2/leadSourceCategories/{category_id} | Retrieve a Lead Source Category
...
*KeapCoreServiceCoreSdk.PreReleaseApi* | [**adjustInventoryUsingPOST**](docs/PreReleaseApi.md#adjustInventoryUsingPOST) | **POST** /v2/products/{product_id}:adjustInventory | Adjust Inventory of a Product
...
*KeapCoreServiceCoreSdk.PreReleaseApi* | [**createFileUsingPOST1**](docs/PreReleaseApi.md#createFileUsingPOST1) | **POST** /v2/files | Create a file
...
*KeapCoreServiceCoreSdk.PreReleaseApi* | [**createLeadSourceCategoryUsingPOST**](docs/PreReleaseApi.md#createLeadSourceCategoryUsingPOST) | **POST** /v2/leadSourceCategories | Create a Lead Source Category
...
*KeapCoreServiceCoreSdk.PreReleaseApi* | [**deleteFileUsingDELETE1**](docs/PreReleaseApi.md#deleteFileUsingDELETE1) | **DELETE** /v2/files/{file_id} | Delete a file
...
*KeapCoreServiceCoreSdk.PreReleaseApi* | [**deleteLeadSourceCategoryUsingDELETE**](docs/PreReleaseApi.md#deleteLeadSourceCategoryUsingDELETE) | **DELETE** /v2/leadSourceCategories/{category_id} | Delete a Lead Source Category
...
*KeapCoreServiceCoreSdk.PreReleaseApi* | [**getFileDataUsingGET**](docs/PreReleaseApi.md#getFileDataUsingGET) | **GET** /v2/files/{file_id}:data | Retrieve a file&#39;s data
*KeapCoreServiceCoreSdk.PreReleaseApi* | [**getFileUsingGET1**](docs/PreReleaseApi.md#getFileUsingGET1) | **GET** /v2/files/{file_id} | Retrieve a file
*KeapCoreServiceCoreSdk.PreReleaseApi* | [**getLeadScoreDetailsUsingGET**](docs/PreReleaseApi.md#getLeadScoreDetailsUsingGET) | **GET** /v2/contact/{contact_id}/leadScore | Retrieve Lead Score of a Contact
*KeapCoreServiceCoreSdk.PreReleaseApi* | [**getLeadSourceCategoryUsingGET**](docs/PreReleaseApi.md#getLeadSourceCategoryUsingGET) | **GET** /v2/leadSourceCategories/{category_id} | Retrieve a Lead Source Category
...
*KeapCoreServiceCoreSdk.PreReleaseApi* | [**getOrderTotalDiscountUsingGET**](docs/PreReleaseApi.md#getOrderTotalDiscountUsingGET) | **GET** /v2/discounts/orderTotals/{discount_id} | Retrieve an Order Total Discount
...
*KeapCoreServiceCoreSdk.PreReleaseApi* | [**listCategoryDiscountsUsingGET**](docs/PreReleaseApi.md#listCategoryDiscountsUsingGET) | **GET** /v2/discounts/productCategories | List Category Discounts
...
*KeapCoreServiceCoreSdk.PreReleaseApi* | [**listFilesUsingGET1**](docs/PreReleaseApi.md#listFilesUsingGET1) | **GET** /v2/files | List all files
...
*KeapCoreServiceCoreSdk.PreReleaseApi* | [**updateFileUsingPATCH**](docs/PreReleaseApi.md#updateFileUsingPATCH) | **PATCH** /v2/files/{file_id} | Update a file
...
*KeapCoreServiceCoreSdk.ProductApi* | [**adjustInventoryUsingPOST**](docs/ProductApi.md#adjustInventoryUsingPOST) | **POST** /v2/products/{product_id}:adjustInventory | Adjust Inventory of a Product
