...
var PreReleaseApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
  ...
  return _createClass(PreReleaseApi, [{
    ...
    key: "getCategoryDiscountUsingGETWithHttpInfo",
    value: function getCategoryDiscountUsingGETWithHttpInfo(discountId) {
      var postBody = null;
      // verify the required parameter 'discountId' is set
      if (discountId === undefined || discountId === null) {
        throw new _Error["default"]("Missing the required parameter 'discountId' when calling getCategoryDiscountUsingGET");
      }
      var pathParams = {
    ...
    key: "getCategoryDiscountUsingGET",
    value: function getCategoryDiscountUsingGET(discountId) {
      return this.getCategoryDiscountUsingGETWithHttpInfo(discountId).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
