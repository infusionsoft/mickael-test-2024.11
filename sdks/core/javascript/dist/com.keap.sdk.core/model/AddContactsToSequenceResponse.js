 ...
 * @version 0.0.37
 */
var AddContactsToSequenceResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function AddContactsToSequenceResponse() {
    _classCallCheck(this, AddContactsToSequenceResponse);
   ...
   */
  return _createClass(AddContactsToSequenceResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('add_to_sequence_results')) {
          obj['add_to_sequence_results'] = _ApiClient["default"].convertToType(data['add_to_sequence_results'], {
            'String': 'String'
          });
        }
      }
...
var _default = exports["default"] = AddContactsToSequenceResponse;