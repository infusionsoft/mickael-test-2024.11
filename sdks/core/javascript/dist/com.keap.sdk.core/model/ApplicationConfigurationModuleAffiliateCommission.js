...
var ApplicationConfigurationModuleAffiliateCommission = /*#__PURE__*/function () {
  ...
  function ApplicationConfigurationModuleAffiliateCommission() {
    _classCallCheck(this, ApplicationConfigurationModuleAffiliateCommission);
   ...
   */
  return _createClass(ApplicationConfigurationModuleAffiliateCommission, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('calculation_type')) {
          obj['calculation_type'] = _ApiClient["default"].convertToType(data['calculation_type'], 'String');
        }
        if (data.hasOwnProperty('levels')) {
          obj['levels'] = _ApiClient["default"].convertToType(data['levels'], 'Number');
        }
        if (data.hasOwnProperty('participant_types')) {
          obj['participant_types'] = _ApiClient["default"].convertToType(data['participant_types'], 'String');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = ApplicationConfigurationModuleAffiliateCommission;