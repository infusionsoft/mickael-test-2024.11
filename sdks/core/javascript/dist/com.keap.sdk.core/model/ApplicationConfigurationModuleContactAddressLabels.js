 ...
 * @version 0.0.31
 */
var ApplicationConfigurationModuleContactAddressLabels = /*#__PURE__*/function () {
  /**
   ...
   */
  function ApplicationConfigurationModuleContactAddressLabels() {
    _classCallCheck(this, ApplicationConfigurationModuleContactAddressLabels);
   ...
   */
  return _createClass(ApplicationConfigurationModuleContactAddressLabels, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('line_2')) {
          obj['line_2'] = _ApiClient["default"].convertToType(data['line_2'], 'String');
        }
        if (data.hasOwnProperty('line_3')) {
          obj['line_3'] = _ApiClient["default"].convertToType(data['line_3'], 'String');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = ApplicationConfigurationModuleContactAddressLabels;