...
var _ApplicationConfigurationModuleOpportunityStates = _interopRequireDefault(require("./ApplicationConfigurationModuleOpportunityStates"));
 ...
 * @version 0.0.31
 */
var ApplicationConfigurationModuleOpportunity = /*#__PURE__*/function () {
  /**
  ...
  function ApplicationConfigurationModuleOpportunity() {
    _classCallCheck(this, ApplicationConfigurationModuleOpportunity);
   ...
   */
  return _createClass(ApplicationConfigurationModuleOpportunity, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('default_stage')) {
          obj['default_stage'] = _ApiClient["default"].convertToType(data['default_stage'], 'String');
        }
        if (data.hasOwnProperty('states')) {
          obj['states'] = _ApplicationConfigurationModuleOpportunityStates["default"].constructFromObject(data['states']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['states']) {
        // data not null
        _ApplicationConfigurationModuleOpportunityStates["default"].validateJSON(data['states']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = ApplicationConfigurationModuleOpportunity;