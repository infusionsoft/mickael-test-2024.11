 ...
 */
var ApplicationConfigurationModuleTemplate = /*#__PURE__*/function () {
  /**
  ...
  function ApplicationConfigurationModuleTemplate() {
    _classCallCheck(this, ApplicationConfigurationModuleTemplate);
   ...
   */
  return _createClass(ApplicationConfigurationModuleTemplate, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('default_country_code')) {
          obj['default_country_code'] = _ApiClient["default"].convertToType(data['default_country_code'], 'Number');
        }
        if (data.hasOwnProperty('default_user_id')) {
          obj['default_user_id'] = _ApiClient["default"].convertToType(data['default_user_id'], 'Number');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = ApplicationConfigurationModuleTemplate;