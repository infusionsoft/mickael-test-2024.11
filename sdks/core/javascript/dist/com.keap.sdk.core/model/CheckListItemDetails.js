 ...
 * @version 0.0.38
 */
var CheckListItemDetails = /*#__PURE__*/function () {
  /**
  ...
  function CheckListItemDetails() {
    _classCallCheck(this, CheckListItemDetails);
   ...
   */
  return _createClass(CheckListItemDetails, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('done_date')) {
          obj['done_date'] = _ApiClient["default"].convertToType(data['done_date'], 'Date');
        }
        ...
        if (data.hasOwnProperty('item_order')) {
          obj['item_order'] = _ApiClient["default"].convertToType(data['item_order'], 'Number');
        }
...
var _default = exports["default"] = CheckListItemDetails;