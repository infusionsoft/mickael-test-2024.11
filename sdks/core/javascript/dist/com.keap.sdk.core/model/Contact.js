...
var _ContactUtmResponse = _interopRequireDefault(require("./ContactUtmResponse"));
  ...
  return _createClass(Contact, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('origin')) {
          obj['origin'] = _Origin["default"].constructFromObject(data['origin']);
        }
        ...
        if (data.hasOwnProperty('score_value')) {
          obj['score_value'] = _ApiClient["default"].convertToType(data['score_value'], 'String');
        }
        ...
        if (data.hasOwnProperty('tag_ids')) {
          obj['tag_ids'] = _ApiClient["default"].convertToType(data['tag_ids'], ['String']);
        }
        ...
        if (data.hasOwnProperty('utm_parameters')) {
          obj['utm_parameters'] = _ApiClient["default"].convertToType(data['utm_parameters'], [_ContactUtmResponse["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['email_addresses']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _EmailAddress["default"].validateJSON(_item2);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (data['links']) {
        ...
        var _iterator5 = _createForOfIteratorHelper(data['links']),
          _step5;
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            var _item4 = _step5.value;
            _Link["default"].validateJSON(_item4);
          }
        } catch (err) {
          _iterator5.e(err);
        } finally {
      ...
      if (data['origin']) {
        // data not null
        _Origin["default"].validateJSON(data['origin']);
      }
      // ensure the json data is a string
      ...
      if (data['phone_numbers']) {
        ...
        var _iterator6 = _createForOfIteratorHelper(data['phone_numbers']),
          _step6;
        try {
          for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
            var _item5 = _step6.value;
            _PhoneNumber["default"].validateJSON(_item5);
          }
        } catch (err) {
          _iterator6.e(err);
        } finally {
      ...
      if (data['social_accounts']) {
        ...
        var _iterator7 = _createForOfIteratorHelper(data['social_accounts']),
          _step7;
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
            var _item6 = _step7.value;
            _SocialAccount["default"].validateJSON(_item6);
          }
        } catch (err) {
          _iterator7.e(err);
        } finally {
      ...
      if (data['utm_parameters']) {
        ...
        var _iterator8 = _createForOfIteratorHelper(data['utm_parameters']),
          _step8;
        try {
          for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
            var _item7 = _step8.value;
            _ContactUtmResponse["default"].validateJSON(_item7);
          }
        } catch (err) {
          _iterator8.e(err);
        } finally {
