 ...
 * @version 0.0.26
 */
var CreateContactLinkTypeRequest = /*#__PURE__*/function () {
  /**
  ...
  function CreateContactLinkTypeRequest() {
    _classCallCheck(this, CreateContactLinkTypeRequest);
   ...
   */
  return _createClass(CreateContactLinkTypeRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('max_links')) {
          obj['max_links'] = _ApiClient["default"].convertToType(data['max_links'], 'Number');
        }
...
var _default = exports["default"] = CreateContactLinkTypeRequest;