 ...
 * @module com.keap.sdk.core/model/CreateCustomFieldOptionRequest
 * @version 2.70.0.739356-hf-202411181744
 */
var CreateCustomFieldOptionRequest = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateCustomFieldOptionRequest</code>.
   * @alias module:com.keap.sdk.core/model/CreateCustomFieldOptionRequest
   */
  function CreateCustomFieldOptionRequest() {
    _classCallCheck(this, CreateCustomFieldOptionRequest);
   ...
   */
  return _createClass(CreateCustomFieldOptionRequest, null, [{
    key: "initialize",
     ...
     * @param {module:com.keap.sdk.core/model/CreateCustomFieldOptionRequest} obj Optional instance to populate.
     * @return {module:com.keap.sdk.core/model/CreateCustomFieldOptionRequest} The populated <code>CreateCustomFieldOptionRequest</code> instance.
     */
  }, {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('options')) {
          obj['options'] = _ApiClient["default"].convertToType(data['options'], [CreateCustomFieldOptionRequest]);
        }
      }
      return obj;
    }
...
var _default = exports["default"] = CreateCustomFieldOptionRequest;