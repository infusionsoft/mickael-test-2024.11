...
var _FunnelIntegrationTriggerEventDTO = _interopRequireDefault(require("./FunnelIntegrationTriggerEventDTO"));
 ...
 * @version 0.0.28
 */
var CreateFunnelIntegrationTriggerEvents = /*#__PURE__*/function () {
  /**
  ...
  function CreateFunnelIntegrationTriggerEvents() {
    _classCallCheck(this, CreateFunnelIntegrationTriggerEvents);
   ...
   */
  return _createClass(CreateFunnelIntegrationTriggerEvents, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('funnel_integration_trigger_events')) {
          obj['funnel_integration_trigger_events'] = _ApiClient["default"].convertToType(data['funnel_integration_trigger_events'], [_FunnelIntegrationTriggerEventDTO["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      if (data['funnel_integration_trigger_events']) {
        // data not null
        ...
        var _iterator = _createForOfIteratorHelper(data['funnel_integration_trigger_events']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _FunnelIntegrationTriggerEventDTO["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = CreateFunnelIntegrationTriggerEvents;