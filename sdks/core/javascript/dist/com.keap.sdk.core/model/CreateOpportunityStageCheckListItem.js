...
var CreateOpportunityStageCheckListItem = /*#__PURE__*/function () {
   ...
   */
  function CreateOpportunityStageCheckListItem(description, order, required) {
    _classCallCheck(this, CreateOpportunityStageCheckListItem);
   ...
   */
  return _createClass(CreateOpportunityStageCheckListItem, null, [{
    key: "initialize",
    value: function initialize(obj, description, order, required) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateOpportunityStageCheckListItem.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = CreateOpportunityStageCheckListItem;