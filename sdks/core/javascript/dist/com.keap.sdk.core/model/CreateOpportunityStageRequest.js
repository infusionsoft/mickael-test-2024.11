...
var _CreateOpportunityStageCheckListItem = _interopRequireDefault(require("./CreateOpportunityStageCheckListItem"));
 ...
 * @version 0.0.38
 */
var CreateOpportunityStageRequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateOpportunityStageRequest(name, order, probability, targetNumberDays) {
    _classCallCheck(this, CreateOpportunityStageRequest);
   ...
   */
  return _createClass(CreateOpportunityStageRequest, null, [{
    key: "initialize",
    value: function initialize(obj, name, order, probability, targetNumberDays) {
      obj['name'] = name;
      obj['order'] = order;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('check_list_items')) {
          obj['check_list_items'] = _ApiClient["default"].convertToType(data['check_list_items'], [_CreateOpportunityStageCheckListItem["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateOpportunityStageRequest.RequiredProperties),
        _step;
      try {
      ...
      if (data['check_list_items']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['check_list_items']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _CreateOpportunityStageCheckListItem["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = CreateOpportunityStageRequest;