 ...
 * @version 0.0.25
 */
var CreateOrPatchAffiliateLinkRequest = /*#__PURE__*/function () {
  /**
  ...
  function CreateOrPatchAffiliateLinkRequest() {
    _classCallCheck(this, CreateOrPatchAffiliateLinkRequest);
   ...
   */
  return _createClass(CreateOrPatchAffiliateLinkRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('website_address')) {
          obj['website_address'] = _ApiClient["default"].convertToType(data['website_address'], 'String');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = CreateOrPatchAffiliateLinkRequest;