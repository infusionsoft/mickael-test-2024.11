...
var Discount = /*#__PURE__*/function () {
   ...
   */
  function Discount(amount, discountMethod, specialItemId) {
   ...
   */
  return _createClass(Discount, null, [{
    key: "initialize",
    value: function initialize(obj, amount, discountMethod, specialItemId) {
      obj['amount'] = amount;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('discount_method')) {
          obj['discount_method'] = _ApiClient["default"].convertToType(data['discount_method'], 'String');
        }
        if (data.hasOwnProperty('line_item_id')) {
          obj['line_item_id'] = _ApiClient["default"].convertToType(data['line_item_id'], 'String');
        }
        if (data.hasOwnProperty('special_item_id')) {
          obj['special_item_id'] = _ApiClient["default"].convertToType(data['special_item_id'], 'String');
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(Discount.RequiredProperties),
        _step;
      try {
