...
var _StackTraceElement = _interopRequireDefault(require("./StackTraceElement"));
var _Throwable = _interopRequireDefault(require("./Throwable"));
...
var Error = /*#__PURE__*/function () {
  ...
  return _createClass(Error, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('cause')) {
          obj['cause'] = _Throwable["default"].constructFromObject(data['cause']);
        }
        ...
        if (data.hasOwnProperty('stackTrace')) {
          obj['stackTrace'] = _ApiClient["default"].convertToType(data['stackTrace'], [_StackTraceElement["default"]]);
        }
        if (data.hasOwnProperty('suppressed')) {
          obj['suppressed'] = _ApiClient["default"].convertToType(data['suppressed'], [_Throwable["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['cause']) {
        // data not null
        _Throwable["default"].validateJSON(data['cause']);
      }
      ...
      if (data['stackTrace']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _StackTraceElement["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['suppressed']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _Throwable["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
