...
var GetContactOptionTypesResponse = /*#__PURE__*/function () {
   ...
   */
  function GetContactOptionTypesResponse() {
    _classCallCheck(this, GetContactOptionTypesResponse);
   ...
   */
  return _createClass(GetContactOptionTypesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('option_types')) {
          obj['option_types'] = _ApiClient["default"].convertToType(data['option_types'], ['String']);
        }
      }
      return obj;
    }
...
var _default = exports["default"] = GetContactOptionTypesResponse;