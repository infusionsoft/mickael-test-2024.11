...
var Item = /*#__PURE__*/function () {
   ...
   * @alias module:com.keap.sdk.core/model/Item
   */
  function Item() {
  ...
  return _createClass(Item, null, [{
     ...
     * @param {module:com.keap.sdk.core/model/Item} obj Optional instance to populate.
     * @return {module:com.keap.sdk.core/model/Item} The populated <code>Item</code> instance.
     */
  }, {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('previous_item_id')) {
          obj['previous_item_id'] = _ApiClient["default"].convertToType(data['previous_item_id'], 'String');
        }
...
/**
 * @member {module:com.keap.sdk.core/model/Item.TypeEnum} type
 */
