...
var _AffiliateProgramV = _interopRequireDefault(require("./AffiliateProgramV2"));
...
var ListAffiliateCommissionProgramsResponse = /*#__PURE__*/function () {
  ...
  function ListAffiliateCommissionProgramsResponse() {
    _classCallCheck(this, ListAffiliateCommissionProgramsResponse);
   ...
   */
  return _createClass(ListAffiliateCommissionProgramsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('commission_programs')) {
          obj['commission_programs'] = _ApiClient["default"].convertToType(data['commission_programs'], [_AffiliateProgramV["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['commission_programs']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['commission_programs']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _AffiliateProgramV["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListAffiliateCommissionProgramsResponse;