 ...
 */
var ListAffiliateLinksResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListAffiliateLinksResponse() {
    _classCallCheck(this, ListAffiliateLinksResponse);
   ...
   */
  return _createClass(ListAffiliateLinksResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('affiliate_links')) {
          obj['affiliate_links'] = _ApiClient["default"].convertToType(data['affiliate_links'], [_AffiliateLink["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['affiliate_links']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['affiliate_links']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _AffiliateLink["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListAffiliateLinksResponse;