...
var _AffiliateSummaryRecord = _interopRequireDefault(require("./AffiliateSummaryRecord"));
...
var ListAffiliateSummariesResponse = /*#__PURE__*/function () {
  ...
  function ListAffiliateSummariesResponse() {
    _classCallCheck(this, ListAffiliateSummariesResponse);
   ...
   */
  return _createClass(ListAffiliateSummariesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('affiliate_summaries')) {
          obj['affiliate_summaries'] = _ApiClient["default"].convertToType(data['affiliate_summaries'], [_AffiliateSummaryRecord["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['affiliate_summaries']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['affiliate_summaries']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _AffiliateSummaryRecord["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListAffiliateSummariesResponse;