...
var _AutomationCategory = _interopRequireDefault(require("./AutomationCategory"));
 ...
 * @version 0.0.24
 */
var ListAutomationCategoryResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListAutomationCategoryResponse() {
    _classCallCheck(this, ListAutomationCategoryResponse);
   ...
   */
  return _createClass(ListAutomationCategoryResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('automation_categories')) {
          obj['automation_categories'] = _ApiClient["default"].convertToType(data['automation_categories'], [_AutomationCategory["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['automation_categories']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['automation_categories']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _AutomationCategory["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListAutomationCategoryResponse;