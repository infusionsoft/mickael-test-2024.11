 ...
 * @version 0.0.29
 */
var ListAutomationResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListAutomationResponse() {
    _classCallCheck(this, ListAutomationResponse);
   ...
   */
  return _createClass(ListAutomationResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('automation_count')) {
          obj['automation_count'] = _ApiClient["default"].convertToType(data['automation_count'], 'Number');
        }
        if (data.hasOwnProperty('automations')) {
          obj['automations'] = _ApiClient["default"].convertToType(data['automations'], [_Automation["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['automations']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['automations']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _Automation["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListAutomationResponse;