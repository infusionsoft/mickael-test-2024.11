...
var ListCampaignsResponse = /*#__PURE__*/function () {
  ...
  function ListCampaignsResponse() {
    _classCallCheck(this, ListCampaignsResponse);
   ...
   */
  return _createClass(ListCampaignsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('campaigns')) {
          obj['campaigns'] = _ApiClient["default"].convertToType(data['campaigns'], [_Campaign["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['campaigns']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['campaigns']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _Campaign["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListCampaignsResponse;