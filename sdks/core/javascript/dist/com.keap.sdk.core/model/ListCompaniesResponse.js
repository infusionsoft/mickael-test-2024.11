 ...
 * @version 0.0.36
 */
var ListCompaniesResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListCompaniesResponse() {
    _classCallCheck(this, ListCompaniesResponse);
   ...
   */
  return _createClass(ListCompaniesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('companies')) {
          obj['companies'] = _ApiClient["default"].convertToType(data['companies'], [_Company["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['companies']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['companies']),
          _step;
        try {
...
var _default = exports["default"] = ListCompaniesResponse;