...
var _ContactLinkType = _interopRequireDefault(require("./ContactLinkType"));
 ...
 * @version 0.0.23
 */
var ListContactLinkTypesResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListContactLinkTypesResponse() {
    _classCallCheck(this, ListContactLinkTypesResponse);
   ...
   */
  return _createClass(ListContactLinkTypesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('contact_link_types')) {
          obj['contact_link_types'] = _ApiClient["default"].convertToType(data['contact_link_types'], [_ContactLinkType["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['contact_link_types']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['contact_link_types']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _ContactLinkType["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListContactLinkTypesResponse;