 ...
 */
var ListContactsResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListContactsResponse() {
    _classCallCheck(this, ListContactsResponse);
   ...
   */
  return _createClass(ListContactsResponse, null, [{
    key: "initialize",
      ...
      if (data['contacts']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _Contact["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListContactsResponse;