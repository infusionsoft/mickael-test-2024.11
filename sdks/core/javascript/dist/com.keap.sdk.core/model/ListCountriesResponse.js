...
var ListCountriesResponse = /*#__PURE__*/function () {
   ...
   */
  function ListCountriesResponse(countries) {
    _classCallCheck(this, ListCountriesResponse);
   ...
   */
  return _createClass(ListCountriesResponse, null, [{
    key: "initialize",
    value: function initialize(obj, countries) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListCountriesResponse.RequiredProperties),
        _step;
      try {
      ...
      if (data['countries']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['countries']),
          _step2;
        try {
...
var _default = exports["default"] = ListCountriesResponse;