 ...
 * @version 0.0.21
 */
var ListLandingPagesResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListLandingPagesResponse() {
    _classCallCheck(this, ListLandingPagesResponse);
   ...
   */
  return _createClass(ListLandingPagesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('landingpages')) {
          obj['landingpages'] = _ApiClient["default"].convertToType(data['landingpages'], [_LandingPage["default"]]);
        }
        if (data.hasOwnProperty('next_page_token')) {
          obj['next_page_token'] = _ApiClient["default"].convertToType(data['next_page_token'], 'String');
        }
        if (data.hasOwnProperty('page_size')) {
          obj['page_size'] = _ApiClient["default"].convertToType(data['page_size'], 'String');
        }
    ...
    value: function validateJSON(data) {
      if (data['landingpages']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['landingpages']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _LandingPage["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListLandingPagesResponse;