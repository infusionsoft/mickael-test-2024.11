...
var _LeadSource = _interopRequireDefault(require("./LeadSource"));
 ...
 * @version 0.0.33
 */
var ListLeadSourcesResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListLeadSourcesResponse() {
    _classCallCheck(this, ListLeadSourcesResponse);
   ...
   */
  return _createClass(ListLeadSourcesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('leadsources')) {
          obj['leadsources'] = _ApiClient["default"].convertToType(data['leadsources'], [_LeadSource["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['leadsources']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['leadsources']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _LeadSource["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListLeadSourcesResponse;