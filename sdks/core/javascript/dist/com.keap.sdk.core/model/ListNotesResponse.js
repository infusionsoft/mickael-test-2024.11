 ...
 * @version 0.0.33
 */
var ListNotesResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListNotesResponse() {
    _classCallCheck(this, ListNotesResponse);
   ...
   */
  return _createClass(ListNotesResponse, null, [{
    key: "initialize",
      ...
      if (data['notes']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _Note["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListNotesResponse;