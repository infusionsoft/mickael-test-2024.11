...
var _RestV2Opportunity = _interopRequireDefault(require("./RestV2Opportunity"));
 ...
 * @version 0.0.19
 */
var ListOpportunitiesResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListOpportunitiesResponse() {
    _classCallCheck(this, ListOpportunitiesResponse);
   ...
   */
  return _createClass(ListOpportunitiesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('opportunities')) {
          obj['opportunities'] = _ApiClient["default"].convertToType(data['opportunities'], [_RestV2Opportunity["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['opportunities']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['opportunities']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _RestV2Opportunity["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListOpportunitiesResponse;