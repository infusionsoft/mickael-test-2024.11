...
var _RestV2Order = _interopRequireDefault(require("./RestV2Order"));
...
var ListOrders = /*#__PURE__*/function () {
   ...
   */
  return _createClass(ListOrders, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('orders')) {
          obj['orders'] = _ApiClient["default"].convertToType(data['orders'], [_RestV2Order["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['orders']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _RestV2Order["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListOrders;