...
var ListProductsResponse = /*#__PURE__*/function () {
  ...
  function ListProductsResponse() {
    _classCallCheck(this, ListProductsResponse);
   ...
   */
  return _createClass(ListProductsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('products')) {
          obj['products'] = _ApiClient["default"].convertToType(data['products'], [_RestProduct["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['products']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _RestProduct["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
/**
 * @member {Array.<module:com.keap.sdk.core/model/RestProduct>} products
 */
ListProductsResponse.prototype['products'] = undefined;
var _default = exports["default"] = ListProductsResponse;