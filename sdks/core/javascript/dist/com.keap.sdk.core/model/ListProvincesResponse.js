 ...
 * @version 0.0.31
 */
var ListProvincesResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListProvincesResponse(provinces) {
    _classCallCheck(this, ListProvincesResponse);
   ...
   */
  return _createClass(ListProvincesResponse, null, [{
    key: "initialize",
    value: function initialize(obj, provinces) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('provinces')) {
          obj['provinces'] = _ApiClient["default"].convertToType(data['provinces'], [_Provinces["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListProvincesResponse.RequiredProperties),
        _step;
      try {
      ...
      if (data['provinces']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['provinces']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _Provinces["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = ListProvincesResponse;