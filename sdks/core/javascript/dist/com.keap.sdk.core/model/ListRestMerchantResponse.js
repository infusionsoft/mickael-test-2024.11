...
var _ListRestMerchantAccountResponse = _interopRequireDefault(require("./ListRestMerchantAccountResponse"));
 ...
 * @version 0.0.29
 */
var ListRestMerchantResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListRestMerchantResponse() {
    _classCallCheck(this, ListRestMerchantResponse);
   ...
   */
  return _createClass(ListRestMerchantResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('default_merchant_account_id')) {
          obj['default_merchant_account_id'] = _ApiClient["default"].convertToType(data['default_merchant_account_id'], 'String');
        }
        if (data.hasOwnProperty('merchant_accounts')) {
          obj['merchant_accounts'] = _ApiClient["default"].convertToType(data['merchant_accounts'], [_ListRestMerchantAccountResponse["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['merchant_accounts']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['merchant_accounts']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _ListRestMerchantAccountResponse["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListRestMerchantResponse;