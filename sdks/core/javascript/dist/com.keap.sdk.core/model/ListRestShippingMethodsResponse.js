...
var ListRestShippingMethodsResponse = /*#__PURE__*/function () {
  ...
  function ListRestShippingMethodsResponse() {
    _classCallCheck(this, ListRestShippingMethodsResponse);
   ...
   */
  return _createClass(ListRestShippingMethodsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('shipping_methods')) {
          obj['shipping_methods'] = _ApiClient["default"].convertToType(data['shipping_methods'], [_ShippingMethod["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['shipping_methods']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['shipping_methods']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _ShippingMethod["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListRestShippingMethodsResponse;