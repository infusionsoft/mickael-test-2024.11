 ...
 * @version 0.0.33
 */
var ListSubscriptionPlansResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListSubscriptionPlansResponse() {
    _classCallCheck(this, ListSubscriptionPlansResponse);
   ...
   */
  return _createClass(ListSubscriptionPlansResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('subscriptions')) {
          obj['subscriptions'] = _ApiClient["default"].convertToType(data['subscriptions'], [_RestSubscriptionPlan["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['subscriptions']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _RestSubscriptionPlan["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListSubscriptionPlansResponse;