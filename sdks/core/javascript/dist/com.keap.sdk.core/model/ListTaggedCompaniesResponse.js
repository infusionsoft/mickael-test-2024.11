...
var _TaggedCompany = _interopRequireDefault(require("./TaggedCompany"));
 ...
 * @version 0.0.34
 */
var ListTaggedCompaniesResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListTaggedCompaniesResponse() {
    _classCallCheck(this, ListTaggedCompaniesResponse);
   ...
   */
  return _createClass(ListTaggedCompaniesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('tagged_companies')) {
          obj['tagged_companies'] = _ApiClient["default"].convertToType(data['tagged_companies'], [_TaggedCompany["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['tagged_companies']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['tagged_companies']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _TaggedCompany["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListTaggedCompaniesResponse;