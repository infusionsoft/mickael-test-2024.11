 ...
 * @version 0.0.34
 */
var ListTasksResponse = /*#__PURE__*/function () {
  /**
  ...
  function ListTasksResponse() {
    _classCallCheck(this, ListTasksResponse);
   ...
   */
  return _createClass(ListTasksResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('tasks')) {
          obj['tasks'] = _ApiClient["default"].convertToType(data['tasks'], [_Task["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['tasks']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _Task["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListTasksResponse;