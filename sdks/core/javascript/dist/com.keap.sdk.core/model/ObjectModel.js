...
var _CustomFieldMetaData = _interopRequireDefault(require("./CustomFieldMetaData"));
 ...
 * @version 0.0.31
 */
var ObjectModel = /*#__PURE__*/function () {
  /**
   ...
   */
  return _createClass(ObjectModel, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('custom_fields')) {
          obj['custom_fields'] = _ApiClient["default"].convertToType(data['custom_fields'], [_CustomFieldMetaData["default"]]);
        }
        if (data.hasOwnProperty('optional_properties')) {
          obj['optional_properties'] = _ApiClient["default"].convertToType(data['optional_properties'], ['String']);
        }
      }
      return obj;
    }
      ...
      if (data['custom_fields']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _CustomFieldMetaData["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ObjectModel;