 ...
 * @version 0.0.27
 */
var OpportunityContact = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OpportunityContact</code>.
   * @alias module:com.keap.sdk.core/model/OpportunityContact
   * @param id {String} 
   */
  function OpportunityContact(id) {
    _classCallCheck(this, OpportunityContact);
   ...
   */
  return _createClass(OpportunityContact, null, [{
    key: "initialize",
     ...
     * @param {module:com.keap.sdk.core/model/OpportunityContact} obj Optional instance to populate.
     * @return {module:com.keap.sdk.core/model/OpportunityContact} The populated <code>OpportunityContact</code> instance.
     */
  }, {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(OpportunityContact.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = OpportunityContact;