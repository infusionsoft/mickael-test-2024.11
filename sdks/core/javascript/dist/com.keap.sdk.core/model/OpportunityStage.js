...
var _StageDetails = _interopRequireDefault(require("./StageDetails"));
 ...
 * @version 0.0.21
 */
var OpportunityStage = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OpportunityStage</code>.
   * @alias module:com.keap.sdk.core/model/OpportunityStage
   * @param id {String} 
   */
  function OpportunityStage(id) {
    _classCallCheck(this, OpportunityStage);
   ...
   */
  return _createClass(OpportunityStage, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('details')) {
          obj['details'] = _StageDetails["default"].constructFromObject(data['details']);
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(OpportunityStage.RequiredProperties),
        _step;
      try {
      ...
      if (data['details']) {
        // data not null
        _StageDetails["default"].validateJSON(data['details']);
      }
...
var _default = exports["default"] = OpportunityStage;