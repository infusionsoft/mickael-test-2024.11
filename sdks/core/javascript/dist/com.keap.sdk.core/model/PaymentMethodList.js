...
var _RestPaymentMethod = _interopRequireDefault(require("./RestPaymentMethod"));
...
var PaymentMethodList = /*#__PURE__*/function () {
   ...
   */
  return _createClass(PaymentMethodList, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('records')) {
          obj['records'] = _ApiClient["default"].convertToType(data['records'], [_RestPaymentMethod["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['records']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _RestPaymentMethod["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = PaymentMethodList;