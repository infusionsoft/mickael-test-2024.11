...
var PaymentResult = /*#__PURE__*/function () {
  ...
  function PaymentResult() {
    _classCallCheck(this, PaymentResult);
   ...
   */
  return _createClass(PaymentResult, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('payment_amount')) {
          obj['payment_amount'] = _ApiClient["default"].convertToType(data['payment_amount'], 'Number');
        }
        if (data.hasOwnProperty('payment_status_message')) {
          obj['payment_status_message'] = _ApiClient["default"].convertToType(data['payment_status_message'], 'String');
        }
...
var _default = exports["default"] = PaymentResult;