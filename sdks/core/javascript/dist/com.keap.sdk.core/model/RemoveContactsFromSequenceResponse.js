 ...
 * @version 0.0.18
 */
var RemoveContactsFromSequenceResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function RemoveContactsFromSequenceResponse() {
    _classCallCheck(this, RemoveContactsFromSequenceResponse);
   ...
   */
  return _createClass(RemoveContactsFromSequenceResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('remove_from_sequence_results')) {
          obj['remove_from_sequence_results'] = _ApiClient["default"].convertToType(data['remove_from_sequence_results'], {
            'String': 'String'
          });
        }
      }
...
var _default = exports["default"] = RemoveContactsFromSequenceResponse;