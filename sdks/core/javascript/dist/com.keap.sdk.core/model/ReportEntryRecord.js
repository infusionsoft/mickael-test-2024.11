...
var _ReportEntryValue = _interopRequireDefault(require("./ReportEntryValue"));
...
var ReportEntryRecord = /*#__PURE__*/function () {
  ...
  function ReportEntryRecord() {
    _classCallCheck(this, ReportEntryRecord);
   ...
   */
  return _createClass(ReportEntryRecord, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('columns')) {
          obj['columns'] = _ApiClient["default"].convertToType(data['columns'], [_ReportEntryValue["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['columns']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _ReportEntryValue["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ReportEntryRecord;