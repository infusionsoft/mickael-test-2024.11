 ...
 * @version 0.0.33
 */
var RestPaymentGateway = /*#__PURE__*/function () {
  /**
  ...
  function RestPaymentGateway() {
    _classCallCheck(this, RestPaymentGateway);
   ...
   */
  return _createClass(RestPaymentGateway, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('merchant_account_id')) {
          obj['merchant_account_id'] = _ApiClient["default"].convertToType(data['merchant_account_id'], 'String');
        }
        if (data.hasOwnProperty('merchant_account_name')) {
          obj['merchant_account_name'] = _ApiClient["default"].convertToType(data['merchant_account_name'], 'String');
        }
        if (data.hasOwnProperty('use_default')) {
          obj['use_default'] = _ApiClient["default"].convertToType(data['use_default'], 'Boolean');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = RestPaymentGateway;