...
var _RestProductOptionValue = _interopRequireDefault(require("./RestProductOptionValue"));
 ...
 * @version 0.0.26
 */
var RestProductOption = /*#__PURE__*/function () {
  /**
  ...
  function RestProductOption() {
    _classCallCheck(this, RestProductOption);
   ...
   */
  return _createClass(RestProductOption, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('allow_spaces')) {
          obj['allow_spaces'] = _ApiClient["default"].convertToType(data['allow_spaces'], 'Boolean');
        }
        if (data.hasOwnProperty('can_contain_character')) {
          obj['can_contain_character'] = _ApiClient["default"].convertToType(data['can_contain_character'], 'Boolean');
        }
        if (data.hasOwnProperty('can_contain_number')) {
          obj['can_contain_number'] = _ApiClient["default"].convertToType(data['can_contain_number'], 'Boolean');
        }
        if (data.hasOwnProperty('can_end_with_character')) {
          obj['can_end_with_character'] = _ApiClient["default"].convertToType(data['can_end_with_character'], 'Boolean');
        }
        if (data.hasOwnProperty('can_end_with_number')) {
          obj['can_end_with_number'] = _ApiClient["default"].convertToType(data['can_end_with_number'], 'Boolean');
        }
        if (data.hasOwnProperty('can_start_with_character')) {
          obj['can_start_with_character'] = _ApiClient["default"].convertToType(data['can_start_with_character'], 'Boolean');
        }
        if (data.hasOwnProperty('can_start_with_number')) {
          obj['can_start_with_number'] = _ApiClient["default"].convertToType(data['can_start_with_number'], 'Boolean');
        }
        if (data.hasOwnProperty('display_index')) {
          obj['display_index'] = _ApiClient["default"].convertToType(data['display_index'], 'Number');
        }
        ...
        if (data.hasOwnProperty('max_chars')) {
          obj['max_chars'] = _ApiClient["default"].convertToType(data['max_chars'], 'Number');
        }
        if (data.hasOwnProperty('min_chars')) {
          obj['min_chars'] = _ApiClient["default"].convertToType(data['min_chars'], 'Number');
        }
        ...
        if (data.hasOwnProperty('values')) {
          obj['values'] = _ApiClient["default"].convertToType(data['values'], [_RestProductOptionValue["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['values']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _RestProductOptionValue["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = RestProductOption;