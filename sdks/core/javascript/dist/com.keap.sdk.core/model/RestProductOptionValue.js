...
var RestProductOptionValue = /*#__PURE__*/function () {
  ...
  function RestProductOptionValue() {
    _classCallCheck(this, RestProductOptionValue);
   ...
   */
  return _createClass(RestProductOptionValue, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('price_adjustment')) {
          obj['price_adjustment'] = _ApiClient["default"].convertToType(data['price_adjustment'], 'Number');
        }
...
var _default = exports["default"] = RestProductOptionValue;