...
var _SequencePath = _interopRequireDefault(require("./SequencePath"));
...
var Sequence = /*#__PURE__*/function () {
   ...
   */
  return _createClass(Sequence, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('active_contact_count_completed')) {
          obj['active_contact_count_completed'] = _ApiClient["default"].convertToType(data['active_contact_count_completed'], 'Number');
        }
        if (data.hasOwnProperty('historical_contact_count')) {
          obj['historical_contact_count'] = _HistoricalCounts["default"].constructFromObject(data['historical_contact_count']);
        }
        ...
        if (data.hasOwnProperty('paths')) {
          obj['paths'] = _ApiClient["default"].convertToType(data['paths'], [_SequencePath["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['historical_contact_count']) {
        // data not null
        _HistoricalCounts["default"].validateJSON(data['historical_contact_count']);
      }
      ...
      if (data['paths']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _SequencePath["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
