...
var _CheckListItemDetails = _interopRequireDefault(require("./CheckListItemDetails"));
...
var StageDetails = /*#__PURE__*/function () {
  ...
  function StageDetails() {
    _classCallCheck(this, StageDetails);
   ...
   */
  return _createClass(StageDetails, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('check_list_items')) {
          obj['check_list_items'] = _ApiClient["default"].convertToType(data['check_list_items'], [_CheckListItemDetails["default"]]);
        }
        ...
        if (data.hasOwnProperty('stage_order')) {
          obj['stage_order'] = _ApiClient["default"].convertToType(data['stage_order'], 'Number');
        }
        if (data.hasOwnProperty('target_num_days')) {
          obj['target_num_days'] = _ApiClient["default"].convertToType(data['target_num_days'], 'Number');
        }
      }
      return obj;
    }
      ...
      if (data['check_list_items']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _CheckListItemDetails["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = StageDetails;