...
var UpdateEmailAddress = /*#__PURE__*/function () {
   ...
   * @param reason {String} 
   */
  function UpdateEmailAddress(optedIn, reason) {
    _classCallCheck(this, UpdateEmailAddress);
   ...
   */
  return _createClass(UpdateEmailAddress, null, [{
    key: "initialize",
    value: function initialize(obj, optedIn, reason) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UpdateEmailAddress.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = UpdateEmailAddress;