...
export default class ContactApi {
    ...
    */
     ...
     * @param {module:com.keap.sdk.core/model/CreateUpdateContactRequest} [createUpdateContactRequest] contact
     ...
     * Creates a new Contact. *Note:* Contact must contain at least one item in `email_addresses` or `phone_numbers` and `country_code` is required if `region` is specified.
     * @param {Object} opts Optional parameters
     * @param {module:com.keap.sdk.core/model/CreateUpdateContactRequest} opts.createUpdateContactRequest contact
