...
class CreateUpdateDiscountRequest {
    /**
     * Constructs a new <code>CreateUpdateDiscountRequest</code>.
     * @alias module:com.keap.sdk.core/model/CreateUpdateDiscountRequest
     */
    constructor() { 
        
        CreateUpdateDiscountRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUpdateDiscountRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.keap.sdk.core/model/CreateUpdateDiscountRequest} obj Optional instance to populate.
     * @return {module:com.keap.sdk.core/model/CreateUpdateDiscountRequest} The populated <code>CreateUpdateDiscountRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUpdateDiscountRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUpdateDiscountRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUpdateDiscountRequest</code>.
     */
 ...
 */
CreateUpdateDiscountRequest.prototype['apply_to_commissions'] = undefined;

/**
 * @member {Array.<module:com.keap.sdk.core/model/DiscountCriteria>} criteria
 */
CreateUpdateDiscountRequest.prototype['criteria'] = undefined;

/**
 * @member {String} description
 */
CreateUpdateDiscountRequest.prototype['description'] = undefined;

/**
 * @member {Number} discount_percent
 */
CreateUpdateDiscountRequest.prototype['discount_percent'] = undefined;

/**
 * @member {String} name
 */
CreateUpdateDiscountRequest.prototype['name'] = undefined;

/**
 * @member {Array.<String>} product_category_ids
 */
CreateUpdateDiscountRequest.prototype['product_category_ids'] = undefined;
...
export default CreateUpdateDiscountRequest;
