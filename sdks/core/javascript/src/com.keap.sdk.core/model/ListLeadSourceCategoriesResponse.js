 ...
 * @module com.keap.sdk.core/model/ListLeadSourceCategoriesResponse
 * @version 0.0.98
 */
class ListLeadSourceCategoriesResponse {
    /**
     * Constructs a new <code>ListLeadSourceCategoriesResponse</code>.
     * @alias module:com.keap.sdk.core/model/ListLeadSourceCategoriesResponse
     */
    constructor() { 
     ...
     * @param {module:com.keap.sdk.core/model/ListLeadSourceCategoriesResponse} obj Optional instance to populate.
     * @return {module:com.keap.sdk.core/model/ListLeadSourceCategoriesResponse} The populated <code>ListLeadSourceCategoriesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:com.keap.sdk.core/model/LeadSourceCategory>} lead_source_categories
 */
