 ...
 * @module com.keap.sdk.core/model/UpdateProductCommissionProgramRequest
 * @version 0.0.96
 */
class UpdateProductCommissionProgramRequest {
    /**
     * Constructs a new <code>UpdateProductCommissionProgramRequest</code>.
     * @alias module:com.keap.sdk.core/model/UpdateProductCommissionProgramRequest
     */
    constructor() { 
     ...
     * @param {module:com.keap.sdk.core/model/UpdateProductCommissionProgramRequest} obj Optional instance to populate.
     * @return {module:com.keap.sdk.core/model/UpdateProductCommissionProgramRequest} The populated <code>UpdateProductCommissionProgramRequest</code> instance.
     */
