 ...
 * @module com.keap.sdk.core/model/UpdateSubscriptionPlanRequest
 * @version 0.0.95
 */
class UpdateSubscriptionPlanRequest {
    /**
     * Constructs a new <code>UpdateSubscriptionPlanRequest</code>.
     * @alias module:com.keap.sdk.core/model/UpdateSubscriptionPlanRequest
     * @param cycleType {module:com.keap.sdk.core/model/UpdateSubscriptionPlanRequest.CycleTypeEnum} The cycle type of the subscription plan.
     ...
     * @param {module:com.keap.sdk.core/model/UpdateSubscriptionPlanRequest} obj Optional instance to populate.
     * @return {module:com.keap.sdk.core/model/UpdateSubscriptionPlanRequest} The populated <code>UpdateSubscriptionPlanRequest</code> instance.
     */
 ...
 * @member {module:com.keap.sdk.core/model/UpdateSubscriptionPlanRequest.CycleTypeEnum} cycle_type
 */
