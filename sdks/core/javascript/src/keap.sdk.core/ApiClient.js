...
* @alias module:keap.sdk.core/ApiClient
* @class
*/
class ApiClient {
    /**
    ...
    constructor(basePath = 'https://api.keap.com/crm/rest') {
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'core-service-core-javascript/0.0.114'
        };
    ...
    * @param {module:keap.sdk.core/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:keap.sdk.core/ApiClient}
*/
