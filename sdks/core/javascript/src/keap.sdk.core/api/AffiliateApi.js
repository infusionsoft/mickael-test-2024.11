...
/**
* Affiliate service.
* @module keap.sdk.core/api/AffiliateApi
*/
export default class AffiliateApi {

    /**
    * Constructs a new AffiliateApi. 
    * @alias module:keap.sdk.core/api/AffiliateApi
    * @class
    ...
    */
     ...
     * @param {module:keap.sdk.core/model/CreateAffiliateRequest} [createAffiliateRequest] Affiliate request to insert
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/RestAffiliate} and HTTP response
     */
     ...
     * Creates a single Affiliate
     * @param {Object} opts Optional parameters
     * @param {module:keap.sdk.core/model/CreateAffiliateRequest} opts.createAffiliateRequest Affiliate request to insert
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/RestAffiliate}
     */
     ...
     * @param {String} id id
     * @param {Object} opts Optional parameters
     * @param {module:keap.sdk.core/model/UpdateAffiliateRequest} [updateAffiliateRequest] Request to update an affiliate
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/RestAffiliate} and HTTP response
     */
     ...
     * @param {String} id id
     * @param {Object} opts Optional parameters
     * @param {module:keap.sdk.core/model/UpdateAffiliateRequest} opts.updateAffiliateRequest Request to update an affiliate
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/RestAffiliate}
     */
     ...
     * @param {module:keap.sdk.core/model/UpdateCommissionProgramRequest} updateCommissionProgramRequest updateCommissionProgramRequest
     * @param {Object} opts Optional parameters
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/AffiliateCommissionProgramResponse} and HTTP response
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/AffiliateCommissionProgramResponse}
     */
