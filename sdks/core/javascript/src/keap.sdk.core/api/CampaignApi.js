...
/**
* Campaign service.
* @module keap.sdk.core/api/CampaignApi
*/
export default class CampaignApi {

    /**
    * Constructs a new CampaignApi. 
    * @alias module:keap.sdk.core/api/CampaignApi
    * @class
    ...
    */
     ...
     * @param {module:keap.sdk.core/model/AddContactsToSequenceRequest} addContactsToSequenceRequest addContactsToSequenceRequest
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/AddContactsToSequenceResponse} and HTTP response
     */
     ...
     * @param {String} sequenceId sequence_id
     * @param {module:keap.sdk.core/model/AddContactsToSequenceRequest} addContactsToSequenceRequest addContactsToSequenceRequest
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/AddContactsToSequenceResponse}
     */
     ...
     * @param {String} campaignId campaign_id
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/Campaign} and HTTP response
     */
     ...
     * Retrieves a single campaign
     * @param {String} campaignId campaign_id
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/Campaign}
     */
     ...
     * @param {Boolean} [stats] 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/ListCampaignsResponse} and HTTP response
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/ListCampaignsResponse}
     */
     ...
     * @param {String} campaignId campaign_id
     * @param {String} sequenceId sequence_id
     * @param {module:keap.sdk.core/model/RemoveContactsFromSequenceRequest} removeContactsFromSequenceRequest removeContactsFromSequenceRequest
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/RemoveContactsFromSequenceResponse} and HTTP response
     */
     ...
     * @param {String} sequenceId sequence_id
     * @param {module:keap.sdk.core/model/RemoveContactsFromSequenceRequest} removeContactsFromSequenceRequest removeContactsFromSequenceRequest
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/RemoveContactsFromSequenceResponse}
     */
