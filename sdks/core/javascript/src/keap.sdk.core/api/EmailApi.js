...
/**
* Email service.
* @module keap.sdk.core/api/EmailApi
*/
export default class EmailApi {

    /**
    * Constructs a new EmailApi. 
    * @alias module:keap.sdk.core/api/EmailApi
    * @class
    ...
    */
     ...
     * @param {module:keap.sdk.core/model/CreateEmailSentRequest} createEmailSentRequest emailWithContent
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/EmailSentWithContent} and HTTP response
     */
     ...
     * Creates a Record of an Email sent to a Contact
     * @param {module:keap.sdk.core/model/CreateEmailSentRequest} createEmailSentRequest emailWithContent
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/EmailSentWithContent}
     */
     ...
     * @param {module:keap.sdk.core/model/CreateEmailsSentRequest} [createEmailsSentRequest] Email records to persist, with content.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/EmailsSentList} and HTTP response
     */
     ...
     * Creates a set of Records of Emails sent to Contacts, maximum 1000 per transaction.
     * @param {Object} opts Optional parameters
     * @param {module:keap.sdk.core/model/CreateEmailsSentRequest} opts.createEmailsSentRequest Email records to persist, with content.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/EmailsSentList}
     */
     ...
     * @param {module:keap.sdk.core/model/DeleteEmailsRequest} deleteEmailsRequest deleteEmailsRequest
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/DeleteEmailsResponse} and HTTP response
     */
     ...
     * Removes a set of Email Records
     * @param {module:keap.sdk.core/model/DeleteEmailsRequest} deleteEmailsRequest deleteEmailsRequest
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/DeleteEmailsResponse}
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:keap.sdk.core/model/EmailSendRequest} [emailSendRequest] emailSendRequest
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
     ...
     * Sends an Email to a list of Contacts
     * @param {Object} opts Optional parameters
     * @param {module:keap.sdk.core/model/EmailSendRequest} opts.emailSendRequest emailSendRequest
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
