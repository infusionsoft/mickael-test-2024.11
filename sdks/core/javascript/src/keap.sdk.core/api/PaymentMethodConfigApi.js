...
* @module keap.sdk.core/api/PaymentMethodConfigApi
*/
export default class PaymentMethodConfigApi {

    /**
    * Constructs a new PaymentMethodConfigApi. 
    * @alias module:keap.sdk.core/api/PaymentMethodConfigApi
    * @class
    ...
    */
     ...
     * @param {module:keap.sdk.core/model/CreatePaymentMethodConfigRequest} createPaymentMethodConfigRequest request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/PaymentMethodConfig} and HTTP response
     */
     ...
     * Creates configuration details for rendering payment method components
     * @param {module:keap.sdk.core/model/CreatePaymentMethodConfigRequest} createPaymentMethodConfigRequest request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/PaymentMethodConfig}
     */
