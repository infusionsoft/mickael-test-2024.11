...
/**
* Stages service.
* @module keap.sdk.core/api/StagesApi
*/
export default class StagesApi {

    /**
    * Constructs a new StagesApi. 
    * @alias module:keap.sdk.core/api/StagesApi
    * @class
    ...
    */
     ...
     * Creates a new entity.
     * @param {module:keap.sdk.core/model/CreateStageRequest} createStageRequest the create request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/Stage} and HTTP response
     */
     ...
     * Creates a new entity.
     * @param {module:keap.sdk.core/model/CreateStageRequest} createStageRequest the create request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/Stage}
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/StageListResponse} and HTTP response
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/StageListResponse}
     */
    list1(opts) {
     ...
     * @param {String} [orderBy] 
     * @param {Number} [pageSize = 1000)] 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/StageDealListResponse} and HTTP response
     */
     ...
     * @param {String} opts.orderBy 
     * @param {Number} opts.pageSize  (default to 1000)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:keap.sdk.core/model/StageDealListResponse}
     */
    listStages1(id, opts) {
     ...
     * @param {module:keap.sdk.core/model/UpdateStageRequest} updateStageRequest the update request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:keap.sdk.core/model/Stage} and HTTP response
     */
