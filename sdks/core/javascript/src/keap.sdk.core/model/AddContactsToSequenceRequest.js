 ...
 * @module keap.sdk.core/model/AddContactsToSequenceRequest
 */
class AddContactsToSequenceRequest {
    /**
     * Constructs a new <code>AddContactsToSequenceRequest</code>.
     * @alias module:keap.sdk.core/model/AddContactsToSequenceRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/AddContactsToSequenceRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/AddContactsToSequenceRequest} The populated <code>AddContactsToSequenceRequest</code> instance.
     */
