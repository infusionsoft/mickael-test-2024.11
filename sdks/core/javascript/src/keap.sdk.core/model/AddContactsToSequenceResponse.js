 ...
 * @module keap.sdk.core/model/AddContactsToSequenceResponse
 */
class AddContactsToSequenceResponse {
    /**
     * Constructs a new <code>AddContactsToSequenceResponse</code>.
     * @alias module:keap.sdk.core/model/AddContactsToSequenceResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/AddContactsToSequenceResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/AddContactsToSequenceResponse} The populated <code>AddContactsToSequenceResponse</code> instance.
     */
