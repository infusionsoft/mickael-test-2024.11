 ...
 * @module keap.sdk.core/model/AddToAutomationSequenceResponse
 */
class AddToAutomationSequenceResponse {
    /**
     * Constructs a new <code>AddToAutomationSequenceResponse</code>.
     * @alias module:keap.sdk.core/model/AddToAutomationSequenceResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/AddToAutomationSequenceResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/AddToAutomationSequenceResponse} The populated <code>AddToAutomationSequenceResponse</code> instance.
     */
