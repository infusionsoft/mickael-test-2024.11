 ...
 * @module keap.sdk.core/model/AffiliateAddToProgramRequest
 */
class AffiliateAddToProgramRequest {
    /**
     * Constructs a new <code>AffiliateAddToProgramRequest</code>.
     * @alias module:keap.sdk.core/model/AffiliateAddToProgramRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/AffiliateAddToProgramRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/AffiliateAddToProgramRequest} The populated <code>AffiliateAddToProgramRequest</code> instance.
     */
