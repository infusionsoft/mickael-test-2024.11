 ...
 * @module keap.sdk.core/model/AffiliateCommission
 */
class AffiliateCommission {
    /**
     * Constructs a new <code>AffiliateCommission</code>.
     * @alias module:keap.sdk.core/model/AffiliateCommission
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/AffiliateCommission} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/AffiliateCommission} The populated <code>AffiliateCommission</code> instance.
     */
