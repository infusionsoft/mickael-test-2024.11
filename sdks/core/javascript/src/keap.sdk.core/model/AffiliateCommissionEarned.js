 ...
 * @module keap.sdk.core/model/AffiliateCommissionEarned
 */
class AffiliateCommissionEarned {
    /**
     * Constructs a new <code>AffiliateCommissionEarned</code>.
     * @alias module:keap.sdk.core/model/AffiliateCommissionEarned
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/AffiliateCommissionEarned} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/AffiliateCommissionEarned} The populated <code>AffiliateCommissionEarned</code> instance.
     */
