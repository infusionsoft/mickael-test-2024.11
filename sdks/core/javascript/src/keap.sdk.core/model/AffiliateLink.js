 ...
 * @module keap.sdk.core/model/AffiliateLink
 */
class AffiliateLink {
    /**
     * Constructs a new <code>AffiliateLink</code>.
     * @alias module:keap.sdk.core/model/AffiliateLink
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/AffiliateLink} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/AffiliateLink} The populated <code>AffiliateLink</code> instance.
     */
