 ...
 * @module keap.sdk.core/model/AffiliateProgramV2
 */
class AffiliateProgramV2 {
    /**
     * Constructs a new <code>AffiliateProgramV2</code>.
     * @alias module:keap.sdk.core/model/AffiliateProgramV2
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/AffiliateProgramV2} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/AffiliateProgramV2} The populated <code>AffiliateProgramV2</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/DefaultCommission} default_commission
 */
...
/**
 * @member {Array.<module:keap.sdk.core/model/ProductCommission>} product_commissions
 */
AffiliateProgramV2.prototype['product_commissions'] = undefined;

/**
 * @member {Array.<module:keap.sdk.core/model/SubscriptionCommission>} subscription_commissions
 */
