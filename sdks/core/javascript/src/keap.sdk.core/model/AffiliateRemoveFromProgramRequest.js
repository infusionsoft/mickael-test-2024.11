 ...
 * @module keap.sdk.core/model/AffiliateRemoveFromProgramRequest
 */
class AffiliateRemoveFromProgramRequest {
    /**
     * Constructs a new <code>AffiliateRemoveFromProgramRequest</code>.
     * @alias module:keap.sdk.core/model/AffiliateRemoveFromProgramRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/AffiliateRemoveFromProgramRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/AffiliateRemoveFromProgramRequest} The populated <code>AffiliateRemoveFromProgramRequest</code> instance.
     */
