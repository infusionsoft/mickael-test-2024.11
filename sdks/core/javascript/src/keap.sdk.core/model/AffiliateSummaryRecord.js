 ...
 * @module keap.sdk.core/model/AffiliateSummaryRecord
 */
class AffiliateSummaryRecord {
    /**
     * Constructs a new <code>AffiliateSummaryRecord</code>.
     * @alias module:keap.sdk.core/model/AffiliateSummaryRecord
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/AffiliateSummaryRecord} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/AffiliateSummaryRecord} The populated <code>AffiliateSummaryRecord</code> instance.
     */
