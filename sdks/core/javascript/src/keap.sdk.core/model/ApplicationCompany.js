 ...
 * @module keap.sdk.core/model/ApplicationCompany
 */
class ApplicationCompany {
    /**
     * Constructs a new <code>ApplicationCompany</code>.
     * @alias module:keap.sdk.core/model/ApplicationCompany
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplicationCompany} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplicationCompany} The populated <code>ApplicationCompany</code> instance.
     */
