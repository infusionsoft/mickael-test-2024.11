 ...
 * @module keap.sdk.core/model/ApplicationConfigurationModuleApplication
 */
class ApplicationConfigurationModuleApplication {
    /**
     * Constructs a new <code>ApplicationConfigurationModuleApplication</code>.
     * @alias module:keap.sdk.core/model/ApplicationConfigurationModuleApplication
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplicationConfigurationModuleApplication} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplicationConfigurationModuleApplication} The populated <code>ApplicationConfigurationModuleApplication</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/ApplicationCompany} company
 */
...
/**
 * @member {module:keap.sdk.core/model/ApplicationFeaturesEnabled} features_enabled
 */
