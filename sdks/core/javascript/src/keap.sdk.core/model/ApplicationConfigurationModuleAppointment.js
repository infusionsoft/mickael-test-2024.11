 ...
 * @module keap.sdk.core/model/ApplicationConfigurationModuleAppointment
 */
class ApplicationConfigurationModuleAppointment {
    /**
     * Constructs a new <code>ApplicationConfigurationModuleAppointment</code>.
     * @alias module:keap.sdk.core/model/ApplicationConfigurationModuleAppointment
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplicationConfigurationModuleAppointment} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplicationConfigurationModuleAppointment} The populated <code>ApplicationConfigurationModuleAppointment</code> instance.
     */
