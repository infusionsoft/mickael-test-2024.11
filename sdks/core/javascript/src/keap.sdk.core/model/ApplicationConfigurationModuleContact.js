 ...
 * @module keap.sdk.core/model/ApplicationConfigurationModuleContact
 */
class ApplicationConfigurationModuleContact {
    /**
     * Constructs a new <code>ApplicationConfigurationModuleContact</code>.
     * @alias module:keap.sdk.core/model/ApplicationConfigurationModuleContact
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplicationConfigurationModuleContact} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplicationConfigurationModuleContact} The populated <code>ApplicationConfigurationModuleContact</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleContactAddressLabels} address_labels
 */
