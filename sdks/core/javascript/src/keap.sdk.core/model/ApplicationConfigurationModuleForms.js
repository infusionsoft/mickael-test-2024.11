 ...
 * @module keap.sdk.core/model/ApplicationConfigurationModuleForms
 */
class ApplicationConfigurationModuleForms {
    /**
     * Constructs a new <code>ApplicationConfigurationModuleForms</code>.
     * @alias module:keap.sdk.core/model/ApplicationConfigurationModuleForms
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplicationConfigurationModuleForms} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplicationConfigurationModuleForms} The populated <code>ApplicationConfigurationModuleForms</code> instance.
     */
