 ...
 * @module keap.sdk.core/model/ApplicationConfigurationModuleFulfillment
 */
class ApplicationConfigurationModuleFulfillment {
    /**
     * Constructs a new <code>ApplicationConfigurationModuleFulfillment</code>.
     * @alias module:keap.sdk.core/model/ApplicationConfigurationModuleFulfillment
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplicationConfigurationModuleFulfillment} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplicationConfigurationModuleFulfillment} The populated <code>ApplicationConfigurationModuleFulfillment</code> instance.
     */
