 ...
 * @module keap.sdk.core/model/ApplicationConfigurationModuleInvoice
 */
class ApplicationConfigurationModuleInvoice {
    /**
     * Constructs a new <code>ApplicationConfigurationModuleInvoice</code>.
     * @alias module:keap.sdk.core/model/ApplicationConfigurationModuleInvoice
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplicationConfigurationModuleInvoice} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplicationConfigurationModuleInvoice} The populated <code>ApplicationConfigurationModuleInvoice</code> instance.
     */
