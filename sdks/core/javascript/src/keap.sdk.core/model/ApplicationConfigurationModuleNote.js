 ...
 * @module keap.sdk.core/model/ApplicationConfigurationModuleNote
 */
class ApplicationConfigurationModuleNote {
    /**
     * Constructs a new <code>ApplicationConfigurationModuleNote</code>.
     * @alias module:keap.sdk.core/model/ApplicationConfigurationModuleNote
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplicationConfigurationModuleNote} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplicationConfigurationModuleNote} The populated <code>ApplicationConfigurationModuleNote</code> instance.
     */
...
export default ApplicationConfigurationModuleNote;
