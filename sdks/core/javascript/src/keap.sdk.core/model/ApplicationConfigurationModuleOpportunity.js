 ...
 * @module keap.sdk.core/model/ApplicationConfigurationModuleOpportunity
 */
class ApplicationConfigurationModuleOpportunity {
    /**
     * Constructs a new <code>ApplicationConfigurationModuleOpportunity</code>.
     * @alias module:keap.sdk.core/model/ApplicationConfigurationModuleOpportunity
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplicationConfigurationModuleOpportunity} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplicationConfigurationModuleOpportunity} The populated <code>ApplicationConfigurationModuleOpportunity</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleOpportunityStates} states
 */
