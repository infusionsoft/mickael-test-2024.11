 ...
 * @module keap.sdk.core/model/ApplicationConfigurationModuleOpportunityStates
 */
class ApplicationConfigurationModuleOpportunityStates {
     ...
     * @alias module:keap.sdk.core/model/ApplicationConfigurationModuleOpportunityStates
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplicationConfigurationModuleOpportunityStates} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplicationConfigurationModuleOpportunityStates} The populated <code>ApplicationConfigurationModuleOpportunityStates</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleOpportunityStatesActive} active
 */
ApplicationConfigurationModuleOpportunityStates.prototype['active'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleOpportunityStatesLoss} loss
 */
ApplicationConfigurationModuleOpportunityStates.prototype['loss'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleOpportunityStatesWin} win
 */
