 ...
 * @module keap.sdk.core/model/ApplicationConfigurationModuleTask
 */
class ApplicationConfigurationModuleTask {
    /**
     * Constructs a new <code>ApplicationConfigurationModuleTask</code>.
     * @alias module:keap.sdk.core/model/ApplicationConfigurationModuleTask
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplicationConfigurationModuleTask} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplicationConfigurationModuleTask} The populated <code>ApplicationConfigurationModuleTask</code> instance.
     */
