 ...
 * @module keap.sdk.core/model/ApplicationConfigurationModuleTemplate
 */
class ApplicationConfigurationModuleTemplate {
    /**
     * Constructs a new <code>ApplicationConfigurationModuleTemplate</code>.
     * @alias module:keap.sdk.core/model/ApplicationConfigurationModuleTemplate
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplicationConfigurationModuleTemplate} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplicationConfigurationModuleTemplate} The populated <code>ApplicationConfigurationModuleTemplate</code> instance.
     */
