 ...
 * @module keap.sdk.core/model/ApplicationFeaturesEnabled
 */
class ApplicationFeaturesEnabled {
    /**
     * Constructs a new <code>ApplicationFeaturesEnabled</code>.
     * @alias module:keap.sdk.core/model/ApplicationFeaturesEnabled
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplicationFeaturesEnabled} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplicationFeaturesEnabled} The populated <code>ApplicationFeaturesEnabled</code> instance.
     */
