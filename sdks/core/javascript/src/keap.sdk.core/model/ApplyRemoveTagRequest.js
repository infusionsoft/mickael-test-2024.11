 ...
 * @module keap.sdk.core/model/ApplyRemoveTagRequest
 */
class ApplyRemoveTagRequest {
    /**
     * Constructs a new <code>ApplyRemoveTagRequest</code>.
     * @alias module:keap.sdk.core/model/ApplyRemoveTagRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ApplyRemoveTagRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ApplyRemoveTagRequest} The populated <code>ApplyRemoveTagRequest</code> instance.
     */
...
export default ApplyRemoveTagRequest;
