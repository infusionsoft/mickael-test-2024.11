 ...
 * @module keap.sdk.core/model/AssignProductCategoriesRequest
 */
class AssignProductCategoriesRequest {
    /**
     * Constructs a new <code>AssignProductCategoriesRequest</code>.
     * @alias module:keap.sdk.core/model/AssignProductCategoriesRequest
     ...
     * @param {module:keap.sdk.core/model/AssignProductCategoriesRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/AssignProductCategoriesRequest} The populated <code>AssignProductCategoriesRequest</code> instance.
     */
