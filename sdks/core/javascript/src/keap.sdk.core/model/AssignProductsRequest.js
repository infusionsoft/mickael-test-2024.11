 ...
 * @module keap.sdk.core/model/AssignProductsRequest
 */
class AssignProductsRequest {
    /**
     * Constructs a new <code>AssignProductsRequest</code>.
     * @alias module:keap.sdk.core/model/AssignProductsRequest
     ...
     * @param {module:keap.sdk.core/model/AssignProductsRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/AssignProductsRequest} The populated <code>AssignProductsRequest</code> instance.
     */
