 ...
 * @module keap.sdk.core/model/Automation
 */
class Automation {
    /**
     * Constructs a new <code>Automation</code>.
     * @alias module:keap.sdk.core/model/Automation
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Automation} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Automation} The populated <code>Automation</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/AutomationLockStatus} current_edit_lock_status
 */
