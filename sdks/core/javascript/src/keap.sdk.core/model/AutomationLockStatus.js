 ...
 * @module keap.sdk.core/model/AutomationLockStatus
 */
class AutomationLockStatus {
    /**
     * Constructs a new <code>AutomationLockStatus</code>.
     * @alias module:keap.sdk.core/model/AutomationLockStatus
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/AutomationLockStatus} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/AutomationLockStatus} The populated <code>AutomationLockStatus</code> instance.
     */
