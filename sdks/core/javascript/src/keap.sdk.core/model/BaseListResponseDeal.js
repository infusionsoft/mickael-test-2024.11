 ...
 * @module keap.sdk.core/model/BaseListResponseDeal
 */
class BaseListResponseDeal {
    /**
     * Constructs a new <code>BaseListResponseDeal</code>.
     * The list responses.
     * @alias module:keap.sdk.core/model/BaseListResponseDeal
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/BaseListResponseDeal} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/BaseListResponseDeal} The populated <code>BaseListResponseDeal</code> instance.
     */
