 ...
 * @module keap.sdk.core/model/BaseListResponseDealNote
 */
class BaseListResponseDealNote {
    /**
     * Constructs a new <code>BaseListResponseDealNote</code>.
     * The list responses.
     * @alias module:keap.sdk.core/model/BaseListResponseDealNote
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/BaseListResponseDealNote} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/BaseListResponseDealNote} The populated <code>BaseListResponseDealNote</code> instance.
     */
