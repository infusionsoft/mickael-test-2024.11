 ...
 * @module keap.sdk.core/model/BaseListResponsePipeline
 */
class BaseListResponsePipeline {
    /**
     * Constructs a new <code>BaseListResponsePipeline</code>.
     * The list responses.
     * @alias module:keap.sdk.core/model/BaseListResponsePipeline
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/BaseListResponsePipeline} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/BaseListResponsePipeline} The populated <code>BaseListResponsePipeline</code> instance.
     */
