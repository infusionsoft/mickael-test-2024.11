 ...
 * @module keap.sdk.core/model/BaseListResponseStage
 */
class BaseListResponseStage {
    /**
     * Constructs a new <code>BaseListResponseStage</code>.
     * The list responses.
     * @alias module:keap.sdk.core/model/BaseListResponseStage
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/BaseListResponseStage} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/BaseListResponseStage} The populated <code>BaseListResponseStage</code> instance.
     */
