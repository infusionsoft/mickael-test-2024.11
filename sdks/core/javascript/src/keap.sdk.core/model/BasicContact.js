 ...
 * @module keap.sdk.core/model/BasicContact
 */
class BasicContact {
    /**
     * Constructs a new <code>BasicContact</code>.
     * @alias module:keap.sdk.core/model/BasicContact
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/BasicContact} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/BasicContact} The populated <code>BasicContact</code> instance.
     */
