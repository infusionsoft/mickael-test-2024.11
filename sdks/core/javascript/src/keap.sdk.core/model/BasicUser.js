 ...
 * @module keap.sdk.core/model/BasicUser
 */
class BasicUser {
    /**
     * Constructs a new <code>BasicUser</code>.
     * @alias module:keap.sdk.core/model/BasicUser
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/BasicUser} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/BasicUser} The populated <code>BasicUser</code> instance.
     */
