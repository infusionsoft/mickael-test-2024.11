 ...
 * @module keap.sdk.core/model/Campaign
 */
class Campaign {
    /**
     * Constructs a new <code>Campaign</code>.
     * @alias module:keap.sdk.core/model/Campaign
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Campaign} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Campaign} The populated <code>Campaign</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/Goal>} goals
 */
...
/**
 * @member {Array.<module:keap.sdk.core/model/Sequence>} sequences
 */
