 ...
 * @module keap.sdk.core/model/CardInfo
 */
class CardInfo {
    /**
     * Constructs a new <code>CardInfo</code>.
     * @alias module:keap.sdk.core/model/CardInfo
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/CardInfo} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CardInfo} The populated <code>CardInfo</code> instance.
     */
