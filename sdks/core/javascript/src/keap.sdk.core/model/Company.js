 ...
 * @module keap.sdk.core/model/Company
 */
class Company {
    /**
     * Constructs a new <code>Company</code>.
     * @alias module:keap.sdk.core/model/Company
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Company} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Company} The populated <code>Company</code> instance.
     */
