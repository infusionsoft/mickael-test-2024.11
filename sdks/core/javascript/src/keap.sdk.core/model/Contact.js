 ...
 * @module keap.sdk.core/model/Contact
 */
class Contact {
    /**
     * Constructs a new <code>Contact</code>.
     * @alias module:keap.sdk.core/model/Contact
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Contact} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Contact} The populated <code>Contact</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/Link>} links
 */
...
/**
 * @member {module:keap.sdk.core/model/Origin} origin
 */
...
/**
 * @member {module:keap.sdk.core/model/Contact.SourceTypeEnum} source_type
 */
...
/**
 * @member {Array.<module:keap.sdk.core/model/ContactUtmResponse>} utm_parameters
 */
