 ...
 * @module keap.sdk.core/model/ContactLink
 */
class ContactLink {
    /**
     * Constructs a new <code>ContactLink</code>.
     * @alias module:keap.sdk.core/model/ContactLink
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ContactLink} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ContactLink} The populated <code>ContactLink</code> instance.
     */
