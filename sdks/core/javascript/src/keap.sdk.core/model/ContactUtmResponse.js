 ...
 * @module keap.sdk.core/model/ContactUtmResponse
 */
class ContactUtmResponse {
    /**
     * Constructs a new <code>ContactUtmResponse</code>.
     * @alias module:keap.sdk.core/model/ContactUtmResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ContactUtmResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ContactUtmResponse} The populated <code>ContactUtmResponse</code> instance.
     */
