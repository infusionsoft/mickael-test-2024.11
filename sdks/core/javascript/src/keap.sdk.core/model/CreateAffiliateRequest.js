 ...
 * @module keap.sdk.core/model/CreateAffiliateRequest
 */
class CreateAffiliateRequest {
    /**
     * Constructs a new <code>CreateAffiliateRequest</code>.
     * @alias module:keap.sdk.core/model/CreateAffiliateRequest
     ...
     * @param status {module:keap.sdk.core/model/CreateAffiliateRequest.StatusEnum} The Affiliate Status
     */
     ...
     * @param {module:keap.sdk.core/model/CreateAffiliateRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateAffiliateRequest} The populated <code>CreateAffiliateRequest</code> instance.
     */
 ...
 * @member {module:keap.sdk.core/model/CreateAffiliateRequest.StatusEnum} status
 */
