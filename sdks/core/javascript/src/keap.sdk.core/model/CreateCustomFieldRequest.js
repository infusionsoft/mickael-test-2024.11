 ...
 * @module keap.sdk.core/model/CreateCustomFieldRequest
 */
class CreateCustomFieldRequest {
    /**
     * Constructs a new <code>CreateCustomFieldRequest</code>.
     * @alias module:keap.sdk.core/model/CreateCustomFieldRequest
     * @param fieldType {module:keap.sdk.core/model/CreateCustomFieldRequest.FieldTypeEnum} 
     * @param label {String} 
     */
     ...
     * @param {module:keap.sdk.core/model/CreateCustomFieldRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateCustomFieldRequest} The populated <code>CreateCustomFieldRequest</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/CreateCustomFieldRequest.FieldTypeEnum} field_type
 */
...
/**
 * @member {Array.<module:keap.sdk.core/model/CreateCustomFieldOptionRequest>} options
 */
