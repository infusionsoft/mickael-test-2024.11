 ...
 * @module keap.sdk.core/model/CreateDefaultCommissionProgramRequest
 */
class CreateDefaultCommissionProgramRequest {
    /**
     * Constructs a new <code>CreateDefaultCommissionProgramRequest</code>.
     * @alias module:keap.sdk.core/model/CreateDefaultCommissionProgramRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/CreateDefaultCommissionProgramRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateDefaultCommissionProgramRequest} The populated <code>CreateDefaultCommissionProgramRequest</code> instance.
     */
