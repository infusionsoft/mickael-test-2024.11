 ...
 * @module keap.sdk.core/model/CreateEmailsSentRequest
 */
class CreateEmailsSentRequest {
    /**
     * Constructs a new <code>CreateEmailsSentRequest</code>.
     * @alias module:keap.sdk.core/model/CreateEmailsSentRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/CreateEmailsSentRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateEmailsSentRequest} The populated <code>CreateEmailsSentRequest</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/CreateEmailSentRequest>} emails
 */
