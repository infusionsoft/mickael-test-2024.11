 ...
 * @module keap.sdk.core/model/CreateFunnelIntegrationRequest
 */
class CreateFunnelIntegrationRequest {
    /**
     * Constructs a new <code>CreateFunnelIntegrationRequest</code>.
     * @alias module:keap.sdk.core/model/CreateFunnelIntegrationRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/CreateFunnelIntegrationRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateFunnelIntegrationRequest} The populated <code>CreateFunnelIntegrationRequest</code> instance.
     */
 ...
 * @member {Array.<module:keap.sdk.core/model/FunnelIntegrationAction>} funnel_integration_actions
 */
 ...
 * @member {Array.<module:keap.sdk.core/model/FunnelIntegrationAction>} funnel_integration_triggers
 */
