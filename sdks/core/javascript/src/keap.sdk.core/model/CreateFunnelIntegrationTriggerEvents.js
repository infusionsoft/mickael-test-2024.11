 ...
 * @module keap.sdk.core/model/CreateFunnelIntegrationTriggerEvents
 */
class CreateFunnelIntegrationTriggerEvents {
    /**
     * Constructs a new <code>CreateFunnelIntegrationTriggerEvents</code>.
     * @alias module:keap.sdk.core/model/CreateFunnelIntegrationTriggerEvents
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/CreateFunnelIntegrationTriggerEvents} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateFunnelIntegrationTriggerEvents} The populated <code>CreateFunnelIntegrationTriggerEvents</code> instance.
     */
 ...
 * @member {Array.<module:keap.sdk.core/model/FunnelIntegrationTriggerEventDTO>} funnel_integration_trigger_events
 */
