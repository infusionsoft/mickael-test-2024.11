 ...
 * @module keap.sdk.core/model/CreateNoteRequest
 */
class CreateNoteRequest {
    /**
     * Constructs a new <code>CreateNoteRequest</code>.
     * @alias module:keap.sdk.core/model/CreateNoteRequest
     * @param userId {String} 
     */
    constructor(userId) { 
     ...
     * @param {module:keap.sdk.core/model/CreateNoteRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateNoteRequest} The populated <code>CreateNoteRequest</code> instance.
     */
