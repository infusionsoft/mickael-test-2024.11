 ...
 * @module keap.sdk.core/model/CreateOpportunityRequest
 */
class CreateOpportunityRequest {
    /**
     * Constructs a new <code>CreateOpportunityRequest</code>.
     * @alias module:keap.sdk.core/model/CreateOpportunityRequest
     ...
     * @param {module:keap.sdk.core/model/CreateOpportunityRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateOpportunityRequest} The populated <code>CreateOpportunityRequest</code> instance.
     */
