 ...
 * @module keap.sdk.core/model/CreateOpportunityStageRequest
 */
class CreateOpportunityStageRequest {
    /**
     * Constructs a new <code>CreateOpportunityStageRequest</code>.
     * @alias module:keap.sdk.core/model/CreateOpportunityStageRequest
     * @param name {String} 
     * @param order {Number} 
     ...
     * @param {module:keap.sdk.core/model/CreateOpportunityStageRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateOpportunityStageRequest} The populated <code>CreateOpportunityStageRequest</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/CreateOpportunityStageChecklistItem>} checklist_items
 */
