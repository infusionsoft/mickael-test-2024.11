 ...
 * @module keap.sdk.core/model/CreateOrderTotalDiscountRequest
 */
class CreateOrderTotalDiscountRequest {
    /**
     * Constructs a new <code>CreateOrderTotalDiscountRequest</code>.
     * @alias module:keap.sdk.core/model/CreateOrderTotalDiscountRequest
     * @param discountType {module:keap.sdk.core/model/CreateOrderTotalDiscountRequest.DiscountTypeEnum} 
     ...
     * @param {module:keap.sdk.core/model/CreateOrderTotalDiscountRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateOrderTotalDiscountRequest} The populated <code>CreateOrderTotalDiscountRequest</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/CreateOrderTotalDiscountRequest.DiscountStrategyEnum} discount_strategy
 */
CreateOrderTotalDiscountRequest.prototype['discount_strategy'] = undefined;

/**
 * @member {module:keap.sdk.core/model/CreateOrderTotalDiscountRequest.DiscountTypeEnum} discount_type
 */
