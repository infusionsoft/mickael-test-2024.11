 ...
 * @module keap.sdk.core/model/CreatePaymentMethodConfigRequest
 */
class CreatePaymentMethodConfigRequest {
    /**
     * Constructs a new <code>CreatePaymentMethodConfigRequest</code>.
     * @alias module:keap.sdk.core/model/CreatePaymentMethodConfigRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/CreatePaymentMethodConfigRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreatePaymentMethodConfigRequest} The populated <code>CreatePaymentMethodConfigRequest</code> instance.
     */
