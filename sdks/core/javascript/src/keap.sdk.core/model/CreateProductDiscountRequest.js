 ...
 * @module keap.sdk.core/model/CreateProductDiscountRequest
 */
class CreateProductDiscountRequest {
    /**
     * Constructs a new <code>CreateProductDiscountRequest</code>.
     * @alias module:keap.sdk.core/model/CreateProductDiscountRequest
     * @param discountType {module:keap.sdk.core/model/CreateProductDiscountRequest.DiscountTypeEnum} 
     ...
     * @param {module:keap.sdk.core/model/CreateProductDiscountRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateProductDiscountRequest} The populated <code>CreateProductDiscountRequest</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/CreateProductDiscountRequest.DiscountTypeEnum} discount_type
 */
