 ...
 * @module keap.sdk.core/model/CreateShippingDiscountRequest
 */
class CreateShippingDiscountRequest {
    /**
     * Constructs a new <code>CreateShippingDiscountRequest</code>.
     * @alias module:keap.sdk.core/model/CreateShippingDiscountRequest
     * @param discountType {module:keap.sdk.core/model/CreateShippingDiscountRequest.DiscountTypeEnum} 
     ...
     * @param {module:keap.sdk.core/model/CreateShippingDiscountRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateShippingDiscountRequest} The populated <code>CreateShippingDiscountRequest</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/CreateShippingDiscountRequest.DiscountTypeEnum} discount_type
 */
