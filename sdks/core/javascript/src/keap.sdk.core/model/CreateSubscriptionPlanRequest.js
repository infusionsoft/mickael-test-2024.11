 ...
 * @module keap.sdk.core/model/CreateSubscriptionPlanRequest
 */
class CreateSubscriptionPlanRequest {
    /**
     * Constructs a new <code>CreateSubscriptionPlanRequest</code>.
     * @alias module:keap.sdk.core/model/CreateSubscriptionPlanRequest
     * @param cycleType {module:keap.sdk.core/model/CreateSubscriptionPlanRequest.CycleTypeEnum} The cycle type of the subscription plan.
     ...
     * @param {module:keap.sdk.core/model/CreateSubscriptionPlanRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateSubscriptionPlanRequest} The populated <code>CreateSubscriptionPlanRequest</code> instance.
     */
 ...
 * @member {module:keap.sdk.core/model/CreateSubscriptionPlanRequest.CycleTypeEnum} cycle_type
 */
