 ...
 * @module keap.sdk.core/model/CreateUpdateTaskRequest
 */
class CreateUpdateTaskRequest {
    /**
     * Constructs a new <code>CreateUpdateTaskRequest</code>.
     * @alias module:keap.sdk.core/model/CreateUpdateTaskRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/CreateUpdateTaskRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateUpdateTaskRequest} The populated <code>CreateUpdateTaskRequest</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/CreateUpdateTaskRequest.PriorityEnum} priority
 */
...
/**
 * @member {module:keap.sdk.core/model/CreateUpdateTaskRequest.TypeEnum} type
 */
