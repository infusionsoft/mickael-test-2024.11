 ...
 * @module keap.sdk.core/model/CreateUserRequestV2
 */
class CreateUserRequestV2 {
    /**
     * Constructs a new <code>CreateUserRequestV2</code>.
     * @alias module:keap.sdk.core/model/CreateUserRequestV2
     * @param emailAddress {module:keap.sdk.core/model/EmailAddressRequest} 
     ...
     * @param {module:keap.sdk.core/model/CreateUserRequestV2} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CreateUserRequestV2} The populated <code>CreateUserRequestV2</code> instance.
     */
