 ...
 * @module keap.sdk.core/model/CustomField
 */
class CustomField {
    /**
     * Constructs a new <code>CustomField</code>.
     * @alias module:keap.sdk.core/model/CustomField
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/CustomField} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CustomField} The populated <code>CustomField</code> instance.
     */
