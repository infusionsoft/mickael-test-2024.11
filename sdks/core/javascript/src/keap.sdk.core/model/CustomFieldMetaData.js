 ...
 * @module keap.sdk.core/model/CustomFieldMetaData
 */
class CustomFieldMetaData {
    /**
     * Constructs a new <code>CustomFieldMetaData</code>.
     * @alias module:keap.sdk.core/model/CustomFieldMetaData
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/CustomFieldMetaData} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/CustomFieldMetaData} The populated <code>CustomFieldMetaData</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/CustomFieldMetaData.FieldTypeEnum} field_type
 */
...
/**
 * @member {Array.<module:keap.sdk.core/model/CustomFieldOption>} options
 */
CustomFieldMetaData.prototype['options'] = undefined;

/**
 * @member {module:keap.sdk.core/model/CustomFieldMetaData.RecordTypeEnum} record_type
 */
