 ...
 * @module keap.sdk.core/model/DefaultCommission
 */
class DefaultCommission {
    /**
     * Constructs a new <code>DefaultCommission</code>.
     * @alias module:keap.sdk.core/model/DefaultCommission
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/DefaultCommission} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/DefaultCommission} The populated <code>DefaultCommission</code> instance.
     */
