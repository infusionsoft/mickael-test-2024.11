 ...
 * @module keap.sdk.core/model/DeleteEmailsRequest
 */
class DeleteEmailsRequest {
    /**
     * Constructs a new <code>DeleteEmailsRequest</code>.
     * @alias module:keap.sdk.core/model/DeleteEmailsRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/DeleteEmailsRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/DeleteEmailsRequest} The populated <code>DeleteEmailsRequest</code> instance.
     */
