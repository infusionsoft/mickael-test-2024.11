 ...
 * @module keap.sdk.core/model/DeleteEmailsResponse
 */
class DeleteEmailsResponse {
    /**
     * Constructs a new <code>DeleteEmailsResponse</code>.
     * @alias module:keap.sdk.core/model/DeleteEmailsResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/DeleteEmailsResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/DeleteEmailsResponse} The populated <code>DeleteEmailsResponse</code> instance.
     */
