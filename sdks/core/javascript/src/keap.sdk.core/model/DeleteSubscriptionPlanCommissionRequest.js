 ...
 * @module keap.sdk.core/model/DeleteSubscriptionPlanCommissionRequest
 */
class DeleteSubscriptionPlanCommissionRequest {
    /**
     * Constructs a new <code>DeleteSubscriptionPlanCommissionRequest</code>.
     * @alias module:keap.sdk.core/model/DeleteSubscriptionPlanCommissionRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/DeleteSubscriptionPlanCommissionRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/DeleteSubscriptionPlanCommissionRequest} The populated <code>DeleteSubscriptionPlanCommissionRequest</code> instance.
     */
