 ...
 * @module keap.sdk.core/model/Discount
 */
class Discount {
    /**
     * Constructs a new <code>Discount</code>.
     * @alias module:keap.sdk.core/model/Discount
     * @param amount {Number} 
     * @param discountMethod {module:keap.sdk.core/model/Discount.DiscountMethodEnum} 
     ...
     * @param {module:keap.sdk.core/model/Discount} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Discount} The populated <code>Discount</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/Discount.DiscountMethodEnum} discount_method
 */
