 ...
 * @module keap.sdk.core/model/DiscountCriteria
 */
class DiscountCriteria {
    /**
     * Constructs a new <code>DiscountCriteria</code>.
     * @alias module:keap.sdk.core/model/DiscountCriteria
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/DiscountCriteria} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/DiscountCriteria} The populated <code>DiscountCriteria</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/DiscountCriteria.OperatorEnum} operator
 */
...
/**
 * @member {module:keap.sdk.core/model/DiscountCriteria.TypeEnum} type
 */
