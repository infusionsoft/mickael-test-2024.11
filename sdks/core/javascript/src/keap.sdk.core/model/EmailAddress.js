 ...
 * @module keap.sdk.core/model/EmailAddress
 */
class EmailAddress {
    /**
     * Constructs a new <code>EmailAddress</code>.
     * @alias module:keap.sdk.core/model/EmailAddress
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/EmailAddress} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/EmailAddress} The populated <code>EmailAddress</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/EmailAddress.EmailOptStatusEnum} email_opt_status
 */
EmailAddress.prototype['email_opt_status'] = undefined;

/**
 * @member {module:keap.sdk.core/model/EmailAddress.FieldEnum} field
 */
