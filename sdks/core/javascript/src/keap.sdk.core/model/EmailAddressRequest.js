 ...
 * @module keap.sdk.core/model/EmailAddressRequest
 */
class EmailAddressRequest {
    /**
     * Constructs a new <code>EmailAddressRequest</code>.
     * @alias module:keap.sdk.core/model/EmailAddressRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/EmailAddressRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/EmailAddressRequest} The populated <code>EmailAddressRequest</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/EmailAddressRequest.FieldEnum} field
 */
