 ...
 * @module keap.sdk.core/model/EmailSendRequest
 */
class EmailSendRequest {
    /**
     * Constructs a new <code>EmailSendRequest</code>.
     * @alias module:keap.sdk.core/model/EmailSendRequest
     ...
     * @param {module:keap.sdk.core/model/EmailSendRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/EmailSendRequest} The populated <code>EmailSendRequest</code> instance.
     */
 ...
 * @member {Array.<module:keap.sdk.core/model/EmailSendRequestAttachment>} attachments
 */
