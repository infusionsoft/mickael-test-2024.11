 ...
 * @module keap.sdk.core/model/EmailSendRequestAttachment
 */
class EmailSendRequestAttachment {
    /**
     * Constructs a new <code>EmailSendRequestAttachment</code>.
     * @alias module:keap.sdk.core/model/EmailSendRequestAttachment
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/EmailSendRequestAttachment} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/EmailSendRequestAttachment} The populated <code>EmailSendRequestAttachment</code> instance.
     */
