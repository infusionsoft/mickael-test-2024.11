 ...
 * @module keap.sdk.core/model/EmailSentCreateError
 */
class EmailSentCreateError {
    /**
     * Constructs a new <code>EmailSentCreateError</code>.
     * @alias module:keap.sdk.core/model/EmailSentCreateError
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/EmailSentCreateError} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/EmailSentCreateError} The populated <code>EmailSentCreateError</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/CreateEmailSentRequest} email
 */
