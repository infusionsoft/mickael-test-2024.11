 ...
 * @module keap.sdk.core/model/EmailSentWithContent
 */
class EmailSentWithContent {
    /**
     * Constructs a new <code>EmailSentWithContent</code>.
     * @alias module:keap.sdk.core/model/EmailSentWithContent
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/EmailSentWithContent} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/EmailSentWithContent} The populated <code>EmailSentWithContent</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/EmailSentWithContent.OriginalProviderEnum} original_provider
 */
