 ...
 * @module keap.sdk.core/model/EmailsSentList
 */
class EmailsSentList {
    /**
     * Constructs a new <code>EmailsSentList</code>.
     * @alias module:keap.sdk.core/model/EmailsSentList
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/EmailsSentList} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/EmailsSentList} The populated <code>EmailsSentList</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/EmailSentWithContent>} emails
 */
EmailsSentList.prototype['emails'] = undefined;

/**
 * @member {Array.<module:keap.sdk.core/model/EmailSentCreateError>} errors
 */
