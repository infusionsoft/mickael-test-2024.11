 ...
 * @module keap.sdk.core/model/FaxNumber
 */
class FaxNumber {
    /**
     * Constructs a new <code>FaxNumber</code>.
     * @alias module:keap.sdk.core/model/FaxNumber
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/FaxNumber} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/FaxNumber} The populated <code>FaxNumber</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/FaxNumber.FieldEnum} field
 */
