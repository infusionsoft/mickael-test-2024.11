 ...
 * @module keap.sdk.core/model/File
 */
class File {
    /**
     * Constructs a new <code>File</code>.
     * @alias module:keap.sdk.core/model/File
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/File} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/File} The populated <code>File</code> instance.
     */
