 ...
 * @module keap.sdk.core/model/FileMetadata
 */
class FileMetadata {
    /**
     * Constructs a new <code>FileMetadata</code>.
     * @alias module:keap.sdk.core/model/FileMetadata
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/FileMetadata} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/FileMetadata} The populated <code>FileMetadata</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/FileMetadata.CategoryEnum} category
 */
...
/**
 * @member {module:keap.sdk.core/model/FileMetadata.FileBoxTypeEnum} file_box_type
 */
