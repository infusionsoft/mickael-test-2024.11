 ...
 * @module keap.sdk.core/model/FunnelIntegrationAction
 */
class FunnelIntegrationAction {
    /**
     * Constructs a new <code>FunnelIntegrationAction</code>.
     * @alias module:keap.sdk.core/model/FunnelIntegrationAction
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/FunnelIntegrationAction} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/FunnelIntegrationAction} The populated <code>FunnelIntegrationAction</code> instance.
     */
 ...
 * @member {Array.<module:keap.sdk.core/model/FunnelIntegrationSchemaField>} schema_fields
 */
