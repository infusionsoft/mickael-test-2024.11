 ...
 * @module keap.sdk.core/model/FunnelIntegrationTriggerEventDTO
 */
class FunnelIntegrationTriggerEventDTO {
    /**
     * Constructs a new <code>FunnelIntegrationTriggerEventDTO</code>.
     * @alias module:keap.sdk.core/model/FunnelIntegrationTriggerEventDTO
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/FunnelIntegrationTriggerEventDTO} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/FunnelIntegrationTriggerEventDTO} The populated <code>FunnelIntegrationTriggerEventDTO</code> instance.
     */
