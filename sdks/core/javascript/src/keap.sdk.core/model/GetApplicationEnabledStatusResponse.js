 ...
 * @module keap.sdk.core/model/GetApplicationEnabledStatusResponse
 */
class GetApplicationEnabledStatusResponse {
    /**
     * Constructs a new <code>GetApplicationEnabledStatusResponse</code>.
     * @alias module:keap.sdk.core/model/GetApplicationEnabledStatusResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/GetApplicationEnabledStatusResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/GetApplicationEnabledStatusResponse} The populated <code>GetApplicationEnabledStatusResponse</code> instance.
     */
