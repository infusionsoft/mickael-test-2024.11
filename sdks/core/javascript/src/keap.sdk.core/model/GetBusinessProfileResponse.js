 ...
 * @module keap.sdk.core/model/GetBusinessProfileResponse
 */
class GetBusinessProfileResponse {
     ...
     * @alias module:keap.sdk.core/model/GetBusinessProfileResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/GetBusinessProfileResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/GetBusinessProfileResponse} The populated <code>GetBusinessProfileResponse</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/BusinessProfileAddressResponse} address
 */
