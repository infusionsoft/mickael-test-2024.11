 ...
 * @module keap.sdk.core/model/GetSettingsResponse
 */
class GetSettingsResponse {
    /**
     * Constructs a new <code>GetSettingsResponse</code>.
     * @alias module:keap.sdk.core/model/GetSettingsResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/GetSettingsResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/GetSettingsResponse} The populated <code>GetSettingsResponse</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleAffiliate} affiliate
 */
GetSettingsResponse.prototype['affiliate'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleApplication} application
 */
GetSettingsResponse.prototype['application'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleAppointment} appointment
 */
GetSettingsResponse.prototype['appointment'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleContact} contact
 */
GetSettingsResponse.prototype['contact'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleEcommerce} ecommerce
 */
GetSettingsResponse.prototype['ecommerce'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleEmail} email
 */
GetSettingsResponse.prototype['email'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleForms} forms
 */
GetSettingsResponse.prototype['forms'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleFulfillment} fulfillment
 */
GetSettingsResponse.prototype['fulfillment'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleInvoice} invoice
 */
GetSettingsResponse.prototype['invoice'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleNote} note
 */
GetSettingsResponse.prototype['note'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleOpportunity} opportunity
 */
GetSettingsResponse.prototype['opportunity'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleTask} task
 */
GetSettingsResponse.prototype['task'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ApplicationConfigurationModuleTemplate} template
 */
