 ...
 * @module keap.sdk.core/model/Goal
 */
class Goal {
    /**
     * Constructs a new <code>Goal</code>.
     * @alias module:keap.sdk.core/model/Goal
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Goal} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Goal} The populated <code>Goal</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/HistoricalCounts} historical_contact_counts
 */
...
/**
 * @member {module:keap.sdk.core/model/Goal.TypeEnum} type
 */
