 ...
 * @module keap.sdk.core/model/HistoricalCounts
 */
class HistoricalCounts {
    /**
     * Constructs a new <code>HistoricalCounts</code>.
     * @alias module:keap.sdk.core/model/HistoricalCounts
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/HistoricalCounts} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/HistoricalCounts} The populated <code>HistoricalCounts</code> instance.
     */
