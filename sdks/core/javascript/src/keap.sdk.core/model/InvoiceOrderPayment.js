 ...
 * @module keap.sdk.core/model/InvoiceOrderPayment
 */
class InvoiceOrderPayment {
    /**
     * Constructs a new <code>InvoiceOrderPayment</code>.
     * @alias module:keap.sdk.core/model/InvoiceOrderPayment
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/InvoiceOrderPayment} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/InvoiceOrderPayment} The populated <code>InvoiceOrderPayment</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/InvoiceOrderPayment.PayStatusEnum} pay_status
 */
