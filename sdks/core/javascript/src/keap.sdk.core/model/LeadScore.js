 ...
 * @module keap.sdk.core/model/LeadScore
 */
class LeadScore {
    /**
     * Constructs a new <code>LeadScore</code>.
     * @alias module:keap.sdk.core/model/LeadScore
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/LeadScore} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/LeadScore} The populated <code>LeadScore</code> instance.
     */
