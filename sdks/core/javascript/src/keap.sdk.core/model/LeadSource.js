 ...
 * @module keap.sdk.core/model/LeadSource
 */
class LeadSource {
    /**
     * Constructs a new <code>LeadSource</code>.
     * @alias module:keap.sdk.core/model/LeadSource
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/LeadSource} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/LeadSource} The populated <code>LeadSource</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/LeadSource.StatusEnum} status
 */
