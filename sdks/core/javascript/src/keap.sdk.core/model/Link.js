 ...
 * @module keap.sdk.core/model/Link
 */
class Link {
    /**
     * Constructs a new <code>Link</code>.
     * @alias module:keap.sdk.core/model/Link
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Link} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Link} The populated <code>Link</code> instance.
     */
