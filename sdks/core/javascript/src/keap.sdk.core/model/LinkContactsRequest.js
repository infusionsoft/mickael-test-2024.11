 ...
 * @module keap.sdk.core/model/LinkContactsRequest
 */
class LinkContactsRequest {
    /**
     * Constructs a new <code>LinkContactsRequest</code>.
     * @alias module:keap.sdk.core/model/LinkContactsRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/LinkContactsRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/LinkContactsRequest} The populated <code>LinkContactsRequest</code> instance.
     */
