 ...
 * @module keap.sdk.core/model/ListAffiliateCommissionProgramsResponse
 */
class ListAffiliateCommissionProgramsResponse {
    /**
     * Constructs a new <code>ListAffiliateCommissionProgramsResponse</code>.
     * @alias module:keap.sdk.core/model/ListAffiliateCommissionProgramsResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListAffiliateCommissionProgramsResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListAffiliateCommissionProgramsResponse} The populated <code>ListAffiliateCommissionProgramsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/AffiliateProgramV2>} commission_programs
 */
