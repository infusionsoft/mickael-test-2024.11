 ...
 * @module keap.sdk.core/model/ListAffiliateCommissionResponse
 */
class ListAffiliateCommissionResponse {
    /**
     * Constructs a new <code>ListAffiliateCommissionResponse</code>.
     * @alias module:keap.sdk.core/model/ListAffiliateCommissionResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListAffiliateCommissionResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListAffiliateCommissionResponse} The populated <code>ListAffiliateCommissionResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/AffiliateCommission>} AffiliateCommissions
 */
