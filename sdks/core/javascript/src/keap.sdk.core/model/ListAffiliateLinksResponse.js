 ...
 * @module keap.sdk.core/model/ListAffiliateLinksResponse
 */
class ListAffiliateLinksResponse {
    /**
     * Constructs a new <code>ListAffiliateLinksResponse</code>.
     * @alias module:keap.sdk.core/model/ListAffiliateLinksResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListAffiliateLinksResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListAffiliateLinksResponse} The populated <code>ListAffiliateLinksResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/AffiliateLink>} affiliate_links
 */
