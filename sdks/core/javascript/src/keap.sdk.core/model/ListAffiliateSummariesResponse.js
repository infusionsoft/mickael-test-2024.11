 ...
 * @module keap.sdk.core/model/ListAffiliateSummariesResponse
 */
class ListAffiliateSummariesResponse {
    /**
     * Constructs a new <code>ListAffiliateSummariesResponse</code>.
     * @alias module:keap.sdk.core/model/ListAffiliateSummariesResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListAffiliateSummariesResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListAffiliateSummariesResponse} The populated <code>ListAffiliateSummariesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/AffiliateSummaryRecord>} affiliate_summaries
 */
