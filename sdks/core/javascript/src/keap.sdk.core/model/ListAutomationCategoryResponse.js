 ...
 * @module keap.sdk.core/model/ListAutomationCategoryResponse
 */
class ListAutomationCategoryResponse {
    /**
     * Constructs a new <code>ListAutomationCategoryResponse</code>.
     * @alias module:keap.sdk.core/model/ListAutomationCategoryResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListAutomationCategoryResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListAutomationCategoryResponse} The populated <code>ListAutomationCategoryResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/AutomationCategory>} automation_categories
 */
