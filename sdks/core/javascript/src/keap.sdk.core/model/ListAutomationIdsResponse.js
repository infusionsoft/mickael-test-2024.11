 ...
 * @module keap.sdk.core/model/ListAutomationIdsResponse
 */
class ListAutomationIdsResponse {
    /**
     * Constructs a new <code>ListAutomationIdsResponse</code>.
     * @alias module:keap.sdk.core/model/ListAutomationIdsResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListAutomationIdsResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListAutomationIdsResponse} The populated <code>ListAutomationIdsResponse</code> instance.
     */
