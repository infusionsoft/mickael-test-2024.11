 ...
 * @module keap.sdk.core/model/ListAutomationResponse
 */
class ListAutomationResponse {
    /**
     * Constructs a new <code>ListAutomationResponse</code>.
     * @alias module:keap.sdk.core/model/ListAutomationResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListAutomationResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListAutomationResponse} The populated <code>ListAutomationResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/Automation>} automations
 */
