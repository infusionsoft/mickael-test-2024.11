 ...
 * @module keap.sdk.core/model/ListCampaignsResponse
 */
class ListCampaignsResponse {
    /**
     * Constructs a new <code>ListCampaignsResponse</code>.
     * @alias module:keap.sdk.core/model/ListCampaignsResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListCampaignsResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListCampaignsResponse} The populated <code>ListCampaignsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/Campaign>} campaigns
 */
