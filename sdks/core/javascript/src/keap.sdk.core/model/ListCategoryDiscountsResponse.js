 ...
 * @module keap.sdk.core/model/ListCategoryDiscountsResponse
 */
class ListCategoryDiscountsResponse {
    /**
     * Constructs a new <code>ListCategoryDiscountsResponse</code>.
     * @alias module:keap.sdk.core/model/ListCategoryDiscountsResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListCategoryDiscountsResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListCategoryDiscountsResponse} The populated <code>ListCategoryDiscountsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/CategoryDiscount>} discounts
 */
