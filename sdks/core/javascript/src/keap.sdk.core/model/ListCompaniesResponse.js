 ...
 * @module keap.sdk.core/model/ListCompaniesResponse
 */
class ListCompaniesResponse {
    /**
     * Constructs a new <code>ListCompaniesResponse</code>.
     * @alias module:keap.sdk.core/model/ListCompaniesResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListCompaniesResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListCompaniesResponse} The populated <code>ListCompaniesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/Company>} companies
 */
