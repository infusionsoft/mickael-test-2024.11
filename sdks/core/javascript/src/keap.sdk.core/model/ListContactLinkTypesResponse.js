 ...
 * @module keap.sdk.core/model/ListContactLinkTypesResponse
 */
class ListContactLinkTypesResponse {
    /**
     * Constructs a new <code>ListContactLinkTypesResponse</code>.
     * @alias module:keap.sdk.core/model/ListContactLinkTypesResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListContactLinkTypesResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListContactLinkTypesResponse} The populated <code>ListContactLinkTypesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/ContactLinkType>} contact_link_types
 */
