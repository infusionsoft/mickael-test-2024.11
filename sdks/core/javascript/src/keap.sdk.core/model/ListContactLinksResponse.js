 ...
 * @module keap.sdk.core/model/ListContactLinksResponse
 */
class ListContactLinksResponse {
    /**
     * Constructs a new <code>ListContactLinksResponse</code>.
     * @alias module:keap.sdk.core/model/ListContactLinksResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListContactLinksResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListContactLinksResponse} The populated <code>ListContactLinksResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/ContactLink>} links
 */
