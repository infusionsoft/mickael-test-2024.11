 ...
 * @module keap.sdk.core/model/ListContactsResponse
 */
class ListContactsResponse {
    /**
     * Constructs a new <code>ListContactsResponse</code>.
     * @alias module:keap.sdk.core/model/ListContactsResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListContactsResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListContactsResponse} The populated <code>ListContactsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/Contact>} contacts
 */
