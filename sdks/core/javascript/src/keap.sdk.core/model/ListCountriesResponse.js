 ...
 * @module keap.sdk.core/model/ListCountriesResponse
 */
class ListCountriesResponse {
    /**
     * Constructs a new <code>ListCountriesResponse</code>.
     * @alias module:keap.sdk.core/model/ListCountriesResponse
     * @param countries {Array.<module:keap.sdk.core/model/Country>} A key-value pair of country code and country name.
     */
     ...
     * @param {module:keap.sdk.core/model/ListCountriesResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListCountriesResponse} The populated <code>ListCountriesResponse</code> instance.
     */
 ...
 * @member {Array.<module:keap.sdk.core/model/Country>} countries
 */
