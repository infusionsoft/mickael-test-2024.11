 ...
 * @module keap.sdk.core/model/ListFilesResponse
 */
class ListFilesResponse {
    /**
     * Constructs a new <code>ListFilesResponse</code>.
     * @alias module:keap.sdk.core/model/ListFilesResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListFilesResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListFilesResponse} The populated <code>ListFilesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/FileMetadata>} files
 */
