 ...
 * @module keap.sdk.core/model/ListLandingPagesResponse
 */
class ListLandingPagesResponse {
    /**
     * Constructs a new <code>ListLandingPagesResponse</code>.
     * @alias module:keap.sdk.core/model/ListLandingPagesResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListLandingPagesResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListLandingPagesResponse} The populated <code>ListLandingPagesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/LandingPage>} landingpages
 */
