 ...
 * @module keap.sdk.core/model/ListLeadSourceCategoriesResponse
 */
class ListLeadSourceCategoriesResponse {
    /**
     * Constructs a new <code>ListLeadSourceCategoriesResponse</code>.
     * @alias module:keap.sdk.core/model/ListLeadSourceCategoriesResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListLeadSourceCategoriesResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListLeadSourceCategoriesResponse} The populated <code>ListLeadSourceCategoriesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/LeadSourceCategory>} lead_source_categories
 */
