 ...
 * @module keap.sdk.core/model/ListLeadSourcesResponse
 */
class ListLeadSourcesResponse {
    /**
     * Constructs a new <code>ListLeadSourcesResponse</code>.
     * @alias module:keap.sdk.core/model/ListLeadSourcesResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListLeadSourcesResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListLeadSourcesResponse} The populated <code>ListLeadSourcesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/LeadSource>} leadsources
 */
