 ...
 * @module keap.sdk.core/model/ListNoteTemplateResponse
 */
class ListNoteTemplateResponse {
    /**
     * Constructs a new <code>ListNoteTemplateResponse</code>.
     * @alias module:keap.sdk.core/model/ListNoteTemplateResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListNoteTemplateResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListNoteTemplateResponse} The populated <code>ListNoteTemplateResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/NoteTemplate>} note_templates
 */
