 ...
 * @module keap.sdk.core/model/ListNotesResponse
 */
class ListNotesResponse {
    /**
     * Constructs a new <code>ListNotesResponse</code>.
     * @alias module:keap.sdk.core/model/ListNotesResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListNotesResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListNotesResponse} The populated <code>ListNotesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/Note>} notes
 */
