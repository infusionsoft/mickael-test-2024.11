 ...
 * @module keap.sdk.core/model/ListOpportunitiesResponse
 */
class ListOpportunitiesResponse {
    /**
     * Constructs a new <code>ListOpportunitiesResponse</code>.
     * @alias module:keap.sdk.core/model/ListOpportunitiesResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListOpportunitiesResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListOpportunitiesResponse} The populated <code>ListOpportunitiesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/RestV2Opportunity>} opportunities
 */
