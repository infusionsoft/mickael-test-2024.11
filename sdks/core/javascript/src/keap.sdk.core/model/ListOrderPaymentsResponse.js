 ...
 * @module keap.sdk.core/model/ListOrderPaymentsResponse
 */
class ListOrderPaymentsResponse {
    /**
     * Constructs a new <code>ListOrderPaymentsResponse</code>.
     * @alias module:keap.sdk.core/model/ListOrderPaymentsResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListOrderPaymentsResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListOrderPaymentsResponse} The populated <code>ListOrderPaymentsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/InvoiceOrderPayment>} invoice_order_payments
 */
