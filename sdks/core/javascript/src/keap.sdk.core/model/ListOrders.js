 ...
 * @module keap.sdk.core/model/ListOrders
 */
class ListOrders {
    /**
     * Constructs a new <code>ListOrders</code>.
     * @alias module:keap.sdk.core/model/ListOrders
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListOrders} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListOrders} The populated <code>ListOrders</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/RestV2Order>} orders
 */
