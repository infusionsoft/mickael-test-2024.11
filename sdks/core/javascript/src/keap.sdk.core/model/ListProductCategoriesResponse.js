 ...
 * @module keap.sdk.core/model/ListProductCategoriesResponse
 */
class ListProductCategoriesResponse {
    /**
     * Constructs a new <code>ListProductCategoriesResponse</code>.
     * @alias module:keap.sdk.core/model/ListProductCategoriesResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListProductCategoriesResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListProductCategoriesResponse} The populated <code>ListProductCategoriesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/ProductCategory>} product_categories
 */
