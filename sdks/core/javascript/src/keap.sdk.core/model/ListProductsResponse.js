 ...
 * @module keap.sdk.core/model/ListProductsResponse
 */
class ListProductsResponse {
    /**
     * Constructs a new <code>ListProductsResponse</code>.
     * @alias module:keap.sdk.core/model/ListProductsResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListProductsResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListProductsResponse} The populated <code>ListProductsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/RestV2Product>} products
 */
