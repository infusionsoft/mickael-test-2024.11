 ...
 * @module keap.sdk.core/model/ListProvincesResponse
 */
class ListProvincesResponse {
    /**
     * Constructs a new <code>ListProvincesResponse</code>.
     * @alias module:keap.sdk.core/model/ListProvincesResponse
     * @param provinces {Array.<module:keap.sdk.core/model/Provinces>} A key-value pair of province code and province name.
     */
     ...
     * @param {module:keap.sdk.core/model/ListProvincesResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListProvincesResponse} The populated <code>ListProvincesResponse</code> instance.
     */
 ...
 * @member {Array.<module:keap.sdk.core/model/Provinces>} provinces
 */
