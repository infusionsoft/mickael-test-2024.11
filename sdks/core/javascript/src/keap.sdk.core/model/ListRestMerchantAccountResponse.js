 ...
 * @module keap.sdk.core/model/ListRestMerchantAccountResponse
 */
class ListRestMerchantAccountResponse {
    /**
     * Constructs a new <code>ListRestMerchantAccountResponse</code>.
     * @alias module:keap.sdk.core/model/ListRestMerchantAccountResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListRestMerchantAccountResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListRestMerchantAccountResponse} The populated <code>ListRestMerchantAccountResponse</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/ListRestMerchantAccountResponse.TypeEnum} type
 */
