 ...
 * @module keap.sdk.core/model/ListRestMerchantResponse
 */
class ListRestMerchantResponse {
    /**
     * Constructs a new <code>ListRestMerchantResponse</code>.
     * @alias module:keap.sdk.core/model/ListRestMerchantResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListRestMerchantResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListRestMerchantResponse} The populated <code>ListRestMerchantResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/ListRestMerchantAccountResponse>} merchant_accounts
 */
