 ...
 * @module keap.sdk.core/model/ListRestShippingMethodsResponse
 */
class ListRestShippingMethodsResponse {
    /**
     * Constructs a new <code>ListRestShippingMethodsResponse</code>.
     * @alias module:keap.sdk.core/model/ListRestShippingMethodsResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListRestShippingMethodsResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListRestShippingMethodsResponse} The populated <code>ListRestShippingMethodsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/ShippingMethod>} shipping_methods
 */
