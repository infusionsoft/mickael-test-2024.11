 ...
 * @module keap.sdk.core/model/ListShippingDiscountsResponse
 */
class ListShippingDiscountsResponse {
    /**
     * Constructs a new <code>ListShippingDiscountsResponse</code>.
     * @alias module:keap.sdk.core/model/ListShippingDiscountsResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListShippingDiscountsResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListShippingDiscountsResponse} The populated <code>ListShippingDiscountsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/ShippingDiscount>} shipping_discounts
 */
