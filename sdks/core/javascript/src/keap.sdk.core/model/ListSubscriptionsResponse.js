 ...
 * @module keap.sdk.core/model/ListSubscriptionsResponse
 */
class ListSubscriptionsResponse {
    /**
     * Constructs a new <code>ListSubscriptionsResponse</code>.
     * @alias module:keap.sdk.core/model/ListSubscriptionsResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListSubscriptionsResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListSubscriptionsResponse} The populated <code>ListSubscriptionsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/RestSubscriptionV2>} subscriptions
 */
