 ...
 * @module keap.sdk.core/model/ListTaggedCompaniesResponse
 */
class ListTaggedCompaniesResponse {
    /**
     * Constructs a new <code>ListTaggedCompaniesResponse</code>.
     * @alias module:keap.sdk.core/model/ListTaggedCompaniesResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListTaggedCompaniesResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListTaggedCompaniesResponse} The populated <code>ListTaggedCompaniesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/TaggedCompany>} tagged_companies
 */
