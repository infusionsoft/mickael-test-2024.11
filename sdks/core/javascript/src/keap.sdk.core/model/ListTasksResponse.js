 ...
 * @module keap.sdk.core/model/ListTasksResponse
 */
class ListTasksResponse {
    /**
     * Constructs a new <code>ListTasksResponse</code>.
     * @alias module:keap.sdk.core/model/ListTasksResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListTasksResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListTasksResponse} The populated <code>ListTasksResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/Task>} tasks
 */
