 ...
 * @module keap.sdk.core/model/ListUserResponse
 */
class ListUserResponse {
    /**
     * Constructs a new <code>ListUserResponse</code>.
     * @alias module:keap.sdk.core/model/ListUserResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ListUserResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ListUserResponse} The populated <code>ListUserResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/User>} users
 */
