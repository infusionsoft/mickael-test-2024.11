...
class Money {
     ...
     * @param {module:keap.sdk.core/model/Money} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Money} The populated <code>Money</code> instance.
     */
