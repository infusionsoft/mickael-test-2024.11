 ...
 * @module keap.sdk.core/model/Note
 */
class Note {
    /**
     * Constructs a new <code>Note</code>.
     * @alias module:keap.sdk.core/model/Note
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Note} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Note} The populated <code>Note</code> instance.
     */
