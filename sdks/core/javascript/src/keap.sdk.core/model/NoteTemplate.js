 ...
 * @module keap.sdk.core/model/NoteTemplate
 */
class NoteTemplate {
    /**
     * Constructs a new <code>NoteTemplate</code>.
     * @alias module:keap.sdk.core/model/NoteTemplate
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/NoteTemplate} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/NoteTemplate} The populated <code>NoteTemplate</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/NoteTemplate.ActionTypeEnum} action_type
 */
