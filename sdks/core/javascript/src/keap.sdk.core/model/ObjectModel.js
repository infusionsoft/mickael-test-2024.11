 ...
 * @module keap.sdk.core/model/ObjectModel
 */
class ObjectModel {
    /**
     * Constructs a new <code>ObjectModel</code>.
     * @alias module:keap.sdk.core/model/ObjectModel
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ObjectModel} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ObjectModel} The populated <code>ObjectModel</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/CustomFieldMetaData>} custom_fields
 */
