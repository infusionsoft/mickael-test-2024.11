 ...
 * @module keap.sdk.core/model/OpportunityContact
 */
class OpportunityContact {
    /**
     * Constructs a new <code>OpportunityContact</code>.
     * @alias module:keap.sdk.core/model/OpportunityContact
     * @param id {String} 
     */
    constructor(id) { 
     ...
     * @param {module:keap.sdk.core/model/OpportunityContact} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/OpportunityContact} The populated <code>OpportunityContact</code> instance.
     */
