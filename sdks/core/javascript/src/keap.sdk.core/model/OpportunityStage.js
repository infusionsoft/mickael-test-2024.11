 ...
 * @module keap.sdk.core/model/OpportunityStage
 */
class OpportunityStage {
    /**
     * Constructs a new <code>OpportunityStage</code>.
     * @alias module:keap.sdk.core/model/OpportunityStage
     * @param id {String} 
     */
    constructor(id) { 
     ...
     * @param {module:keap.sdk.core/model/OpportunityStage} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/OpportunityStage} The populated <code>OpportunityStage</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/StageDetails} details
 */
