 ...
 * @module keap.sdk.core/model/OrderItemProduct
 */
class OrderItemProduct {
    /**
     * Constructs a new <code>OrderItemProduct</code>.
     * @alias module:keap.sdk.core/model/OrderItemProduct
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/OrderItemProduct} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/OrderItemProduct} The populated <code>OrderItemProduct</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/RestProductOption>} product_options
 */
...
/**
 * @member {module:keap.sdk.core/model/OrderItemProduct.StatusEnum} status
 */
...
/**
 * @member {Array.<module:keap.sdk.core/model/RestSubscriptionPlan>} subscription_plans
 */
