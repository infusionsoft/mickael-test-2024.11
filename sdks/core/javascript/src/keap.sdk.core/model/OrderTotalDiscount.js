 ...
 * @module keap.sdk.core/model/OrderTotalDiscount
 */
class OrderTotalDiscount {
    /**
     * Constructs a new <code>OrderTotalDiscount</code>.
     * @alias module:keap.sdk.core/model/OrderTotalDiscount
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/OrderTotalDiscount} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/OrderTotalDiscount} The populated <code>OrderTotalDiscount</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/OrderTotalDiscount.DiscountStrategyEnum} discount_strategy
 */
OrderTotalDiscount.prototype['discount_strategy'] = undefined;

/**
 * @member {module:keap.sdk.core/model/OrderTotalDiscount.DiscountTypeEnum} discount_type
 */
