 ...
 * @module keap.sdk.core/model/Origin
 */
class Origin {
    /**
     * Constructs a new <code>Origin</code>.
     * @alias module:keap.sdk.core/model/Origin
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Origin} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Origin} The populated <code>Origin</code> instance.
     */
