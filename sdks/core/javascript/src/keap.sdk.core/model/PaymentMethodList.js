 ...
 * @module keap.sdk.core/model/PaymentMethodList
 */
class PaymentMethodList {
    /**
     * Constructs a new <code>PaymentMethodList</code>.
     * @alias module:keap.sdk.core/model/PaymentMethodList
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/PaymentMethodList} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/PaymentMethodList} The populated <code>PaymentMethodList</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/RestPaymentMethod>} records
 */
