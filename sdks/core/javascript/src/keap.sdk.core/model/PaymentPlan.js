 ...
 * @module keap.sdk.core/model/PaymentPlan
 */
class PaymentPlan {
    /**
     * Constructs a new <code>PaymentPlan</code>.
     * @alias module:keap.sdk.core/model/PaymentPlan
     ...
     * @param {module:keap.sdk.core/model/PaymentPlan} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/PaymentPlan} The populated <code>PaymentPlan</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/RestPaymentGateway} payment_gateway
 */
