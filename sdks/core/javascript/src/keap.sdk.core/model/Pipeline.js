 ...
 * @module keap.sdk.core/model/Pipeline
 */
class Pipeline {
    /**
     * Constructs a new <code>Pipeline</code>.
     * A pipeline
     * @alias module:keap.sdk.core/model/Pipeline
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Pipeline} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Pipeline} The populated <code>Pipeline</code> instance.
     */
