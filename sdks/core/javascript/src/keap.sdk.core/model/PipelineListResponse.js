 ...
 * @module keap.sdk.core/model/PipelineListResponse
 */
class PipelineListResponse {
    /**
     * Constructs a new <code>PipelineListResponse</code>.
     * Response for a list of pipelines.
     * @alias module:keap.sdk.core/model/PipelineListResponse
     * @implements module:keap.sdk.core/model/BaseListResponsePipeline
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/PipelineListResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/PipelineListResponse} The populated <code>PipelineListResponse</code> instance.
     */
 ...
 * @member {Array.<module:keap.sdk.core/model/Pipeline>} pipelines
 */
