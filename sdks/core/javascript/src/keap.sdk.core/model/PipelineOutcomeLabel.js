 ...
 * @module keap.sdk.core/model/PipelineOutcomeLabel
 */
class PipelineOutcomeLabel {
    /**
     * Constructs a new <code>PipelineOutcomeLabel</code>.
     * Represents a label for a pipeline outcome.
     * @alias module:keap.sdk.core/model/PipelineOutcomeLabel
     * @param value {module:keap.sdk.core/model/DealStatus} The status of the deal. This field is required.
     */
    constructor(value) { 
     ...
     * @param {module:keap.sdk.core/model/PipelineOutcomeLabel} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/PipelineOutcomeLabel} The populated <code>PipelineOutcomeLabel</code> instance.
     */
 ...
 * @member {module:keap.sdk.core/model/DealStatus} value
 */
