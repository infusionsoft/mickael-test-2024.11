 ...
 * @module keap.sdk.core/model/PipelineStageListResponse
 */
class PipelineStageListResponse {
    /**
     * Constructs a new <code>PipelineStageListResponse</code>.
     * Response for a list of stages.
     * @alias module:keap.sdk.core/model/PipelineStageListResponse
     * @implements module:keap.sdk.core/model/BaseListResponseStage
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/PipelineStageListResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/PipelineStageListResponse} The populated <code>PipelineStageListResponse</code> instance.
     */
...
/**
 * The list of stages.
 * @member {Array.<module:keap.sdk.core/model/Stage>} stages
 */
