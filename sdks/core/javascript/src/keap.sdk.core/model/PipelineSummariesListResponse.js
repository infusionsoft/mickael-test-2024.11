 ...
 * @module keap.sdk.core/model/PipelineSummariesListResponse
 */
class PipelineSummariesListResponse {
     ...
     * @alias module:keap.sdk.core/model/PipelineSummariesListResponse
     * @implements module:keap.sdk.core/model/BaseListResponsePipelineSummary
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/PipelineSummariesListResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/PipelineSummariesListResponse} The populated <code>PipelineSummariesListResponse</code> instance.
     */
 ...
 * @member {Array.<module:keap.sdk.core/model/PipelineSummary>} pipeline_summaries
 */
