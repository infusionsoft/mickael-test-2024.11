 ...
 * @module keap.sdk.core/model/ProductCommission
 */
class ProductCommission {
    /**
     * Constructs a new <code>ProductCommission</code>.
     * @alias module:keap.sdk.core/model/ProductCommission
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ProductCommission} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ProductCommission} The populated <code>ProductCommission</code> instance.
     */
