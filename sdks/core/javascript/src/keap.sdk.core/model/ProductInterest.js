 ...
 * @module keap.sdk.core/model/ProductInterest
 */
class ProductInterest {
    /**
     * Constructs a new <code>ProductInterest</code>.
     * @alias module:keap.sdk.core/model/ProductInterest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ProductInterest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ProductInterest} The populated <code>ProductInterest</code> instance.
     */
