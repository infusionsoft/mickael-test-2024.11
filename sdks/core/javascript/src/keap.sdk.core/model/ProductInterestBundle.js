 ...
 * @module keap.sdk.core/model/ProductInterestBundle
 */
class ProductInterestBundle {
    /**
     * Constructs a new <code>ProductInterestBundle</code>.
     * @alias module:keap.sdk.core/model/ProductInterestBundle
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ProductInterestBundle} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ProductInterestBundle} The populated <code>ProductInterestBundle</code> instance.
     */
...
/**
 * Product interests
 * @member {Array.<module:keap.sdk.core/model/ProductInterest>} product_interests
 */
ProductInterestBundle.prototype['product_interests'] = undefined;

/**
 * Subscription plan interests
 * @member {Array.<module:keap.sdk.core/model/SubscriptionPlanInterest>} subscription_plan_interests
 */
