 ...
 * @module keap.sdk.core/model/ProductOptions
 */
class ProductOptions {
    /**
     * Constructs a new <code>ProductOptions</code>.
     * @alias module:keap.sdk.core/model/ProductOptions
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ProductOptions} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ProductOptions} The populated <code>ProductOptions</code> instance.
     */
 ...
 * @member {Array.<module:keap.sdk.core/model/ProductFixedOption>} fixed_options
 */
 ...
 * @member {module:keap.sdk.core/model/ProductOptions.TypeEnum} type
 */
ProductOptions.prototype['type'] = undefined;

/**
 * @member {module:keap.sdk.core/model/ProductVariableSetting} variable_setting
 */
