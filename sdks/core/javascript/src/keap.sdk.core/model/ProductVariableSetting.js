 ...
 * @module keap.sdk.core/model/ProductVariableSetting
 */
class ProductVariableSetting {
    /**
     * Constructs a new <code>ProductVariableSetting</code>.
     * @alias module:keap.sdk.core/model/ProductVariableSetting
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ProductVariableSetting} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ProductVariableSetting} The populated <code>ProductVariableSetting</code> instance.
     */
