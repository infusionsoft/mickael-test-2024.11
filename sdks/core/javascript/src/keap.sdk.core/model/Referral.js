 ...
 * @module keap.sdk.core/model/Referral
 */
class Referral {
    /**
     * Constructs a new <code>Referral</code>.
     * @alias module:keap.sdk.core/model/Referral
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Referral} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Referral} The populated <code>Referral</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/Referral.ReferralTypeEnum} referral_type
 */
