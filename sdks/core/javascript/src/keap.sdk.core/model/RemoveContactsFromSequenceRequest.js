 ...
 * @module keap.sdk.core/model/RemoveContactsFromSequenceRequest
 */
class RemoveContactsFromSequenceRequest {
    /**
     * Constructs a new <code>RemoveContactsFromSequenceRequest</code>.
     * @alias module:keap.sdk.core/model/RemoveContactsFromSequenceRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RemoveContactsFromSequenceRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RemoveContactsFromSequenceRequest} The populated <code>RemoveContactsFromSequenceRequest</code> instance.
     */
