 ...
 * @module keap.sdk.core/model/RemoveContactsFromSequenceResponse
 */
class RemoveContactsFromSequenceResponse {
    /**
     * Constructs a new <code>RemoveContactsFromSequenceResponse</code>.
     * @alias module:keap.sdk.core/model/RemoveContactsFromSequenceResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RemoveContactsFromSequenceResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RemoveContactsFromSequenceResponse} The populated <code>RemoveContactsFromSequenceResponse</code> instance.
     */
