 ...
 * @module keap.sdk.core/model/ReportEntryRecord
 */
class ReportEntryRecord {
    /**
     * Constructs a new <code>ReportEntryRecord</code>.
     * @alias module:keap.sdk.core/model/ReportEntryRecord
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ReportEntryRecord} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ReportEntryRecord} The populated <code>ReportEntryRecord</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/ReportEntryValue>} columns
 */
