 ...
 * @module keap.sdk.core/model/ReportEntryValue
 */
class ReportEntryValue {
    /**
     * Constructs a new <code>ReportEntryValue</code>.
     * @alias module:keap.sdk.core/model/ReportEntryValue
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ReportEntryValue} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ReportEntryValue} The populated <code>ReportEntryValue</code> instance.
     */
