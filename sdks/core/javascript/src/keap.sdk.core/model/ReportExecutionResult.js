 ...
 * @module keap.sdk.core/model/ReportExecutionResult
 */
class ReportExecutionResult {
    /**
     * Constructs a new <code>ReportExecutionResult</code>.
     * @alias module:keap.sdk.core/model/ReportExecutionResult
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/ReportExecutionResult} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/ReportExecutionResult} The populated <code>ReportExecutionResult</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/ReportEntryRecord>} results
 */
