 ...
 * @module keap.sdk.core/model/Resource
 */
class Resource {
    /**
     * Constructs a new <code>Resource</code>.
     * @alias module:keap.sdk.core/model/Resource
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Resource} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Resource} The populated <code>Resource</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/URL} url
 */
