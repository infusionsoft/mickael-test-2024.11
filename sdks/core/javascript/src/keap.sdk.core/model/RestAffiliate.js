 ...
 * @module keap.sdk.core/model/RestAffiliate
 */
class RestAffiliate {
    /**
     * Constructs a new <code>RestAffiliate</code>.
     * @alias module:keap.sdk.core/model/RestAffiliate
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RestAffiliate} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestAffiliate} The populated <code>RestAffiliate</code> instance.
     */
 ...
 * @member {module:keap.sdk.core/model/RestAffiliate.StatusEnum} status
 */
