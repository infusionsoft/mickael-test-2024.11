 ...
 * @module keap.sdk.core/model/RestCreateOrderRequest
 */
class RestCreateOrderRequest {
    /**
     * Constructs a new <code>RestCreateOrderRequest</code>.
     * @alias module:keap.sdk.core/model/RestCreateOrderRequest
     * @param contactId {String} 
     * @param orderItems {Array.<module:keap.sdk.core/model/CreateRestOrderItemRequest>} 
     * @param orderTime {String} 
     * @param orderTitle {String} 
     * @param orderType {module:keap.sdk.core/model/RestCreateOrderRequest.OrderTypeEnum} 
     */
     ...
     * @param {module:keap.sdk.core/model/RestCreateOrderRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestCreateOrderRequest} The populated <code>RestCreateOrderRequest</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/CreateRestOrderItemRequest>} order_items
 */
...
/**
 * @member {module:keap.sdk.core/model/RestCreateOrderRequest.OrderTypeEnum} order_type
 */
...
/**
 * @member {module:keap.sdk.core/model/AddressInformation} shipping_address
 */
