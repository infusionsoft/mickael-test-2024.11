 ...
 * @module keap.sdk.core/model/RestOpportunityStage
 */
class RestOpportunityStage {
    /**
     * Constructs a new <code>RestOpportunityStage</code>.
     * @alias module:keap.sdk.core/model/RestOpportunityStage
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RestOpportunityStage} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestOpportunityStage} The populated <code>RestOpportunityStage</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/ChecklistItem>} checklist_items
 */
