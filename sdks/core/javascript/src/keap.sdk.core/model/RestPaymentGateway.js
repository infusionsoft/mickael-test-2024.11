 ...
 * @module keap.sdk.core/model/RestPaymentGateway
 */
class RestPaymentGateway {
    /**
     * Constructs a new <code>RestPaymentGateway</code>.
     * @alias module:keap.sdk.core/model/RestPaymentGateway
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RestPaymentGateway} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestPaymentGateway} The populated <code>RestPaymentGateway</code> instance.
     */
