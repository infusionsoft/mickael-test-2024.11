 ...
 * @module keap.sdk.core/model/RestPaymentMethod
 */
class RestPaymentMethod {
    /**
     * Constructs a new <code>RestPaymentMethod</code>.
     * @alias module:keap.sdk.core/model/RestPaymentMethod
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RestPaymentMethod} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestPaymentMethod} The populated <code>RestPaymentMethod</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/CardInfo} cardInfo
 */
