 ...
 * @module keap.sdk.core/model/RestProductOption
 */
class RestProductOption {
    /**
     * Constructs a new <code>RestProductOption</code>.
     * @alias module:keap.sdk.core/model/RestProductOption
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RestProductOption} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestProductOption} The populated <code>RestProductOption</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/RestProductOption.TypeEnum} type
 */
RestProductOption.prototype['type'] = undefined;

/**
 * @member {Array.<module:keap.sdk.core/model/RestProductOptionValue>} values
 */
