 ...
 * @module keap.sdk.core/model/RestProductOptionValue
 */
class RestProductOptionValue {
    /**
     * Constructs a new <code>RestProductOptionValue</code>.
     * @alias module:keap.sdk.core/model/RestProductOptionValue
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RestProductOptionValue} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestProductOptionValue} The populated <code>RestProductOptionValue</code> instance.
     */
