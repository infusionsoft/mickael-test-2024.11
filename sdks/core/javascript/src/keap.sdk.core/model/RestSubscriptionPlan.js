 ...
 * @module keap.sdk.core/model/RestSubscriptionPlan
 */
class RestSubscriptionPlan {
    /**
     * Constructs a new <code>RestSubscriptionPlan</code>.
     * @alias module:keap.sdk.core/model/RestSubscriptionPlan
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RestSubscriptionPlan} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestSubscriptionPlan} The populated <code>RestSubscriptionPlan</code> instance.
     */
 ...
 * @member {module:keap.sdk.core/model/RestSubscriptionPlan.CycleEnum} cycle
 */
