 ...
 * @module keap.sdk.core/model/RestV2Opportunity
 */
class RestV2Opportunity {
    /**
     * Constructs a new <code>RestV2Opportunity</code>.
     * @alias module:keap.sdk.core/model/RestV2Opportunity
     * @param contact {module:keap.sdk.core/model/OpportunityContact} 
     * @param opportunityTitle {String} 
     * @param stage {module:keap.sdk.core/model/OpportunityStage} 
     */
     ...
     * @param {module:keap.sdk.core/model/RestV2Opportunity} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestV2Opportunity} The populated <code>RestV2Opportunity</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/OpportunityContact} contact
 */
...
/**
 * @member {module:keap.sdk.core/model/OpportunityStage} stage
 */
RestV2Opportunity.prototype['stage'] = undefined;

/**
 * @member {module:keap.sdk.core/model/RestV2User} user
 */
