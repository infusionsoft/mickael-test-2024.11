 ...
 * @module keap.sdk.core/model/RestV2Order
 */
class RestV2Order {
    /**
     * Constructs a new <code>RestV2Order</code>.
     * @alias module:keap.sdk.core/model/RestV2Order
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RestV2Order} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestV2Order} The populated <code>RestV2Order</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/BasicContact} contact
 */
...
/**
 * @member {Array.<module:keap.sdk.core/model/RestV2OrderItem>} order_items
 */
...
/**
 * @member {module:keap.sdk.core/model/PaymentPlan} payment_plan
 */
...
/**
 * @member {module:keap.sdk.core/model/ShippingInformation} shipping_information
 */
RestV2Order.prototype['shipping_information'] = undefined;

/**
 * @member {module:keap.sdk.core/model/RestV2Order.SourceTypeEnum} source_type
 */
