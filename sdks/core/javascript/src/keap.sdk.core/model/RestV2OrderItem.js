 ...
 * @module keap.sdk.core/model/RestV2OrderItem
 */
class RestV2OrderItem {
    /**
     * Constructs a new <code>RestV2OrderItem</code>.
     * @alias module:keap.sdk.core/model/RestV2OrderItem
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RestV2OrderItem} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestV2OrderItem} The populated <code>RestV2OrderItem</code> instance.
     */
 ...
 * @member {module:keap.sdk.core/model/RestV2OrderItem.CycleEnum} cycle
 */
...
/**
 * @member {Array.<module:keap.sdk.core/model/OrderItemTax>} order_item_taxes
 */
...
/**
 * @member {module:keap.sdk.core/model/OrderItemProduct} product
 */
...
/**
 * @member {module:keap.sdk.core/model/Discount} special
 */
RestV2OrderItem.prototype['special'] = undefined;

/**
 * @member {module:keap.sdk.core/model/RestV2Subscription} subscription
 */
...
/**
 * @member {module:keap.sdk.core/model/RestSubscriptionPlan} subscription_plan
 */
RestV2OrderItem.prototype['subscription_plan'] = undefined;

/**
 * @member {module:keap.sdk.core/model/RestV2OrderItem.TypeEnum} type
 */
