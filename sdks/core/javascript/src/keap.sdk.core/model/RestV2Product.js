 ...
 * @module keap.sdk.core/model/RestV2Product
 */
class RestV2Product {
    /**
     * Constructs a new <code>RestV2Product</code>.
     * @alias module:keap.sdk.core/model/RestV2Product
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RestV2Product} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestV2Product} The populated <code>RestV2Product</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/ProductInventory} inventory
 */
 ...
 * @member {Array.<module:keap.sdk.core/model/ProductOptions>} options
 */
RestV2Product.prototype['options'] = undefined;

/**
 * @member {module:keap.sdk.core/model/CurrencyValue} price
 */
 ...
 * @member {Array.<module:keap.sdk.core/model/SubscriptionPlan>} subscription_plans
 */
