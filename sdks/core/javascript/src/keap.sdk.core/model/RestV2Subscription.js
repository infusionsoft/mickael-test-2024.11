 ...
 * @module keap.sdk.core/model/RestV2Subscription
 */
class RestV2Subscription {
    /**
     * Constructs a new <code>RestV2Subscription</code>.
     * @alias module:keap.sdk.core/model/RestV2Subscription
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RestV2Subscription} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestV2Subscription} The populated <code>RestV2Subscription</code> instance.
     */
