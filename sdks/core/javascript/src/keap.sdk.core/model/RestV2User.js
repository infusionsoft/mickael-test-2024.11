 ...
 * @module keap.sdk.core/model/RestV2User
 */
class RestV2User {
    /**
     * Constructs a new <code>RestV2User</code>.
     * @alias module:keap.sdk.core/model/RestV2User
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/RestV2User} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/RestV2User} The populated <code>RestV2User</code> instance.
     */
