 ...
 * @module keap.sdk.core/model/Sequence
 */
class Sequence {
    /**
     * Constructs a new <code>Sequence</code>.
     * @alias module:keap.sdk.core/model/Sequence
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Sequence} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Sequence} The populated <code>Sequence</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/HistoricalCounts} historical_contact_count
 */
...
/**
 * @member {Array.<module:keap.sdk.core/model/SequencePath>} paths
 */
