 ...
 * @module keap.sdk.core/model/SequencePath
 */
class SequencePath {
    /**
     * Constructs a new <code>SequencePath</code>.
     * @alias module:keap.sdk.core/model/SequencePath
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/SequencePath} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/SequencePath} The populated <code>SequencePath</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/Item>} items
 */
