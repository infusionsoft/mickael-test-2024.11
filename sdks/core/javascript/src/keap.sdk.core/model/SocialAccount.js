 ...
 * @module keap.sdk.core/model/SocialAccount
 */
class SocialAccount {
    /**
     * Constructs a new <code>SocialAccount</code>.
     * @alias module:keap.sdk.core/model/SocialAccount
     * @param type {module:keap.sdk.core/model/SocialAccount.TypeEnum} 
     */
    constructor(type) { 
     ...
     * @param {module:keap.sdk.core/model/SocialAccount} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/SocialAccount} The populated <code>SocialAccount</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/SocialAccount.TypeEnum} type
 */
