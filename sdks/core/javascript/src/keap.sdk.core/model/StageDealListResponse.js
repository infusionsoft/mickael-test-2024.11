 ...
 * @module keap.sdk.core/model/StageDealListResponse
 */
class StageDealListResponse {
    /**
     * Constructs a new <code>StageDealListResponse</code>.
     * Response for a list of deals in a stage.
     * @alias module:keap.sdk.core/model/StageDealListResponse
     * @implements module:keap.sdk.core/model/BaseListResponseDeal
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/StageDealListResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/StageDealListResponse} The populated <code>StageDealListResponse</code> instance.
     */
 ...
 * @member {Array.<module:keap.sdk.core/model/Deal>} deals
 */
