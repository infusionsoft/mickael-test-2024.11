 ...
 * @module keap.sdk.core/model/StageDetails
 */
class StageDetails {
    /**
     * Constructs a new <code>StageDetails</code>.
     * @alias module:keap.sdk.core/model/StageDetails
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/StageDetails} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/StageDetails} The populated <code>StageDetails</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/CheckListItemDetails>} checklist_items
 */
