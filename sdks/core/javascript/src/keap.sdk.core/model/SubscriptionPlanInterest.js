 ...
 * @module keap.sdk.core/model/SubscriptionPlanInterest
 */
class SubscriptionPlanInterest {
    /**
     * Constructs a new <code>SubscriptionPlanInterest</code>.
     * @alias module:keap.sdk.core/model/SubscriptionPlanInterest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/SubscriptionPlanInterest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/SubscriptionPlanInterest} The populated <code>SubscriptionPlanInterest</code> instance.
     */
