 ...
 * @module keap.sdk.core/model/TaggedCompany
 */
class TaggedCompany {
    /**
     * Constructs a new <code>TaggedCompany</code>.
     * @alias module:keap.sdk.core/model/TaggedCompany
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/TaggedCompany} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/TaggedCompany} The populated <code>TaggedCompany</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/Company} company
 */
