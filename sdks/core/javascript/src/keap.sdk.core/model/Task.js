 ...
 * @module keap.sdk.core/model/Task
 */
class Task {
    /**
     * Constructs a new <code>Task</code>.
     * @alias module:keap.sdk.core/model/Task
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Task} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Task} The populated <code>Task</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/Task.PriorityEnum} priority
 */
...
/**
 * @member {module:keap.sdk.core/model/Task.TypeEnum} type
 */
