 ...
 * @module keap.sdk.core/model/Throwable
 */
class Throwable {
    /**
     * Constructs a new <code>Throwable</code>.
     * @alias module:keap.sdk.core/model/Throwable
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/Throwable} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/Throwable} The populated <code>Throwable</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/Throwable} cause
 */
...
/**
 * @member {Array.<module:keap.sdk.core/model/StackTraceElement>} stackTrace
 */
Throwable.prototype['stackTrace'] = undefined;

/**
 * @member {Array.<module:keap.sdk.core/model/Throwable>} suppressed
 */
