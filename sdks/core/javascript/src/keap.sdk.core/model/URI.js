 ...
 * @module keap.sdk.core/model/URI
 */
class URI {
    /**
     * Constructs a new <code>URI</code>.
     * @alias module:keap.sdk.core/model/URI
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/URI} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/URI} The populated <code>URI</code> instance.
     */
