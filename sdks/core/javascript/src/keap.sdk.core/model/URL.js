 ...
 * @module keap.sdk.core/model/URL
 */
class URL {
    /**
     * Constructs a new <code>URL</code>.
     * @alias module:keap.sdk.core/model/URL
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/URL} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/URL} The populated <code>URL</code> instance.
     */
