 ...
 * @module keap.sdk.core/model/UpdateAffiliateRequest
 */
class UpdateAffiliateRequest {
    /**
     * Constructs a new <code>UpdateAffiliateRequest</code>.
     * @alias module:keap.sdk.core/model/UpdateAffiliateRequest
     ...
     * @param status {module:keap.sdk.core/model/UpdateAffiliateRequest.StatusEnum} The Affiliate Status
     */
     ...
     * @param {module:keap.sdk.core/model/UpdateAffiliateRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/UpdateAffiliateRequest} The populated <code>UpdateAffiliateRequest</code> instance.
     */
 ...
 * @member {module:keap.sdk.core/model/UpdateAffiliateRequest.StatusEnum} status
 */
