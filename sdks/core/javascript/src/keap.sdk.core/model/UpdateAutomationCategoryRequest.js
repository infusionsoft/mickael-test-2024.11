 ...
 * @module keap.sdk.core/model/UpdateAutomationCategoryRequest
 */
class UpdateAutomationCategoryRequest {
    /**
     * Constructs a new <code>UpdateAutomationCategoryRequest</code>.
     * @alias module:keap.sdk.core/model/UpdateAutomationCategoryRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/UpdateAutomationCategoryRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/UpdateAutomationCategoryRequest} The populated <code>UpdateAutomationCategoryRequest</code> instance.
     */
