 ...
 * @module keap.sdk.core/model/UpdateBusinessProfileRequest
 */
class UpdateBusinessProfileRequest {
     ...
     * @alias module:keap.sdk.core/model/UpdateBusinessProfileRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/UpdateBusinessProfileRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/UpdateBusinessProfileRequest} The populated <code>UpdateBusinessProfileRequest</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/BusinessProfileAddressRequest} address
 */
