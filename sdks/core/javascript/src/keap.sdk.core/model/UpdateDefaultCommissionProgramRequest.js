 ...
 * @module keap.sdk.core/model/UpdateDefaultCommissionProgramRequest
 */
class UpdateDefaultCommissionProgramRequest {
    /**
     * Constructs a new <code>UpdateDefaultCommissionProgramRequest</code>.
     * @alias module:keap.sdk.core/model/UpdateDefaultCommissionProgramRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/UpdateDefaultCommissionProgramRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/UpdateDefaultCommissionProgramRequest} The populated <code>UpdateDefaultCommissionProgramRequest</code> instance.
     */
