 ...
 * @module keap.sdk.core/model/UpdateEmailAddress
 */
class UpdateEmailAddress {
    /**
     * Constructs a new <code>UpdateEmailAddress</code>.
     * @alias module:keap.sdk.core/model/UpdateEmailAddress
     ...
     * @param {module:keap.sdk.core/model/UpdateEmailAddress} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/UpdateEmailAddress} The populated <code>UpdateEmailAddress</code> instance.
     */
