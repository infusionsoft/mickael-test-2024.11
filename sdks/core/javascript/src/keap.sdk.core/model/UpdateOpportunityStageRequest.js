 ...
 * @module keap.sdk.core/model/UpdateOpportunityStageRequest
 */
class UpdateOpportunityStageRequest {
    /**
     * Constructs a new <code>UpdateOpportunityStageRequest</code>.
     * @alias module:keap.sdk.core/model/UpdateOpportunityStageRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/UpdateOpportunityStageRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/UpdateOpportunityStageRequest} The populated <code>UpdateOpportunityStageRequest</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/UpdateOpportunityStageChecklistItem>} checklist_items
 */
