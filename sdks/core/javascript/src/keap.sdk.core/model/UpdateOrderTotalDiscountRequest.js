 ...
 * @module keap.sdk.core/model/UpdateOrderTotalDiscountRequest
 */
class UpdateOrderTotalDiscountRequest {
    /**
     * Constructs a new <code>UpdateOrderTotalDiscountRequest</code>.
     * @alias module:keap.sdk.core/model/UpdateOrderTotalDiscountRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/UpdateOrderTotalDiscountRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/UpdateOrderTotalDiscountRequest} The populated <code>UpdateOrderTotalDiscountRequest</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/UpdateOrderTotalDiscountRequest.DiscountStrategyEnum} discount_strategy
 */
UpdateOrderTotalDiscountRequest.prototype['discount_strategy'] = undefined;

/**
 * @member {module:keap.sdk.core/model/UpdateOrderTotalDiscountRequest.DiscountTypeEnum} discount_type
 */
