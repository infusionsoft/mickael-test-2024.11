 ...
 * @module keap.sdk.core/model/UpdateOutcomeLabelsRequest
 */
class UpdateOutcomeLabelsRequest {
     ...
     * @alias module:keap.sdk.core/model/UpdateOutcomeLabelsRequest
     * @param outcomeLabels {Array.<module:keap.sdk.core/model/PipelineOutcomeLabel>} List of outcome labels to be updated.
     */
     ...
     * @param {module:keap.sdk.core/model/UpdateOutcomeLabelsRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/UpdateOutcomeLabelsRequest} The populated <code>UpdateOutcomeLabelsRequest</code> instance.
     */
 ...
 * @member {Array.<module:keap.sdk.core/model/PipelineOutcomeLabel>} outcome_labels
 */
