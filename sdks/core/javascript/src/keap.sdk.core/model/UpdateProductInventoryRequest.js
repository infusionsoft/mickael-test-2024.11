 ...
 * @module keap.sdk.core/model/UpdateProductInventoryRequest
 */
class UpdateProductInventoryRequest {
    /**
     * Constructs a new <code>UpdateProductInventoryRequest</code>.
     * @alias module:keap.sdk.core/model/UpdateProductInventoryRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/UpdateProductInventoryRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/UpdateProductInventoryRequest} The populated <code>UpdateProductInventoryRequest</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/UpdateProductInventoryRequest.TypeEnum} type
 */
