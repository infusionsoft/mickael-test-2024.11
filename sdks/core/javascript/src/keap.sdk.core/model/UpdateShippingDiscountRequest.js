 ...
 * @module keap.sdk.core/model/UpdateShippingDiscountRequest
 */
class UpdateShippingDiscountRequest {
    /**
     * Constructs a new <code>UpdateShippingDiscountRequest</code>.
     * @alias module:keap.sdk.core/model/UpdateShippingDiscountRequest
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/UpdateShippingDiscountRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/UpdateShippingDiscountRequest} The populated <code>UpdateShippingDiscountRequest</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/UpdateShippingDiscountRequest.DiscountTypeEnum} discount_type
 */
