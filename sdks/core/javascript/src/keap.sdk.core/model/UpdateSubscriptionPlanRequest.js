 ...
 * @module keap.sdk.core/model/UpdateSubscriptionPlanRequest
 */
class UpdateSubscriptionPlanRequest {
    /**
     * Constructs a new <code>UpdateSubscriptionPlanRequest</code>.
     * @alias module:keap.sdk.core/model/UpdateSubscriptionPlanRequest
     * @param cycleType {module:keap.sdk.core/model/UpdateSubscriptionPlanRequest.CycleTypeEnum} The cycle type of the subscription plan.
     ...
     * @param {module:keap.sdk.core/model/UpdateSubscriptionPlanRequest} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/UpdateSubscriptionPlanRequest} The populated <code>UpdateSubscriptionPlanRequest</code> instance.
     */
 ...
 * @member {module:keap.sdk.core/model/UpdateSubscriptionPlanRequest.CycleTypeEnum} cycle_type
 */
