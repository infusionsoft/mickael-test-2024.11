 ...
 * @module keap.sdk.core/model/UpdateTaskResponse
 */
class UpdateTaskResponse {
    /**
     * Constructs a new <code>UpdateTaskResponse</code>.
     * @alias module:keap.sdk.core/model/UpdateTaskResponse
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/UpdateTaskResponse} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/UpdateTaskResponse} The populated <code>UpdateTaskResponse</code> instance.
     */
...
/**
 * @member {module:keap.sdk.core/model/UpdateTaskResponse.PriorityEnum} priority
 */
...
/**
 * @member {module:keap.sdk.core/model/UpdateTaskResponse.TypeEnum} type
 */
