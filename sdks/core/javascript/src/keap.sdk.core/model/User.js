 ...
 * @module keap.sdk.core/model/User
 */
class User {
    /**
     * Constructs a new <code>User</code>.
     * @alias module:keap.sdk.core/model/User
     */
    constructor() { 
     ...
     * @param {module:keap.sdk.core/model/User} obj Optional instance to populate.
     * @return {module:keap.sdk.core/model/User} The populated <code>User</code> instance.
     */
...
/**
 * @member {Array.<module:keap.sdk.core/model/EmailAddress>} email_addresses
 */
...
/**
 * @member {module:keap.sdk.core/model/User.StatusEnum} status
 */
