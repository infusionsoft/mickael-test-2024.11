...
class CategoryDiscountApi
{
    ...
    /**
     * Operation listCategoryDiscountsUsingGET
     *
     * List Category Discounts
     *
     * @param  string $filter Filter to apply, the allowed field is: - (String) product_category_id You will need to apply the &#x60;&#x3D;&#x3D;&#x60; operator to check the equality of the filter with your searched word, in the encoded form &#x60;%3D%3D&#x60;. For the filters listed above, here are some examples: - &#x60;filter&#x3D;product_category_id%3D%3D4&#x60; (optional)
     * @param  string $order_by Attribute and direction to order items. One of the following fields: - id - name One of the following directions: - asc - desc (optional)
     * @param  int $page_size Total number of items to return per page (optional)
     * @param  string $page_token Page token (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listCategoryDiscountsUsingGET'] to see the possible values for this operation
     *
     * @throws \Com\Keap\Sdk\Core\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Com\Keap\Sdk\Core\Model\ListCategoryDiscountsResponse|\Com\Keap\Sdk\Core\Model\Error|\Com\Keap\Sdk\Core\Model\Error|\Com\Keap\Sdk\Core\Model\Error
     */
    public function listCategoryDiscountsUsingGET($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listCategoryDiscountsUsingGET'][0])
    {
        list($response) = $this->listCategoryDiscountsUsingGETWithHttpInfo($filter, $order_by, $page_size, $page_token, $contentType);
        return $response;
    }

    /**
     * Operation listCategoryDiscountsUsingGETWithHttpInfo
     *
     * List Category Discounts
     *
     * @param  string $filter Filter to apply, the allowed field is: - (String) product_category_id You will need to apply the &#x60;&#x3D;&#x3D;&#x60; operator to check the equality of the filter with your searched word, in the encoded form &#x60;%3D%3D&#x60;. For the filters listed above, here are some examples: - &#x60;filter&#x3D;product_category_id%3D%3D4&#x60; (optional)
     ...
     * @throws \Com\Keap\Sdk\Core\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Com\Keap\Sdk\Core\Model\ListCategoryDiscountsResponse|\Com\Keap\Sdk\Core\Model\Error|\Com\Keap\Sdk\Core\Model\Error|\Com\Keap\Sdk\Core\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function listCategoryDiscountsUsingGETWithHttpInfo($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listCategoryDiscountsUsingGET'][0])
    {
        $request = $this->listCategoryDiscountsUsingGETRequest($filter, $order_by, $page_size, $page_token, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Com\Keap\Sdk\Core\Model\ListCategoryDiscountsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Com\Keap\Sdk\Core\Model\ListCategoryDiscountsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Com\Keap\Sdk\Core\Model\ListCategoryDiscountsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Com\Keap\Sdk\Core\Model\ListCategoryDiscountsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Com\Keap\Sdk\Core\Model\ListCategoryDiscountsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation listCategoryDiscountsUsingGETAsync
     *
     * List Category Discounts
     *
     * @param  string $filter Filter to apply, the allowed field is: - (String) product_category_id You will need to apply the &#x60;&#x3D;&#x3D;&#x60; operator to check the equality of the filter with your searched word, in the encoded form &#x60;%3D%3D&#x60;. For the filters listed above, here are some examples: - &#x60;filter&#x3D;product_category_id%3D%3D4&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCategoryDiscountsUsingGETAsync($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listCategoryDiscountsUsingGET'][0])
    {
        return $this->listCategoryDiscountsUsingGETAsyncWithHttpInfo($filter, $order_by, $page_size, $page_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listCategoryDiscountsUsingGETAsyncWithHttpInfo
     *
     * List Category Discounts
     *
     * @param  string $filter Filter to apply, the allowed field is: - (String) product_category_id You will need to apply the &#x60;&#x3D;&#x3D;&#x60; operator to check the equality of the filter with your searched word, in the encoded form &#x60;%3D%3D&#x60;. For the filters listed above, here are some examples: - &#x60;filter&#x3D;product_category_id%3D%3D4&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCategoryDiscountsUsingGETAsyncWithHttpInfo($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listCategoryDiscountsUsingGET'][0])
    {
        $returnType = '\Com\Keap\Sdk\Core\Model\ListCategoryDiscountsResponse';
        $request = $this->listCategoryDiscountsUsingGETRequest($filter, $order_by, $page_size, $page_token, $contentType);
    ...
    /**
     * Create request for operation 'listCategoryDiscountsUsingGET'
     *
     * @param  string $filter Filter to apply, the allowed field is: - (String) product_category_id You will need to apply the &#x60;&#x3D;&#x3D;&#x60; operator to check the equality of the filter with your searched word, in the encoded form &#x60;%3D%3D&#x60;. For the filters listed above, here are some examples: - &#x60;filter&#x3D;product_category_id%3D%3D4&#x60; (optional)
     * @param  string $order_by Attribute and direction to order items. One of the following fields: - id - name One of the following directions: - asc - desc (optional)
     * @param  int $page_size Total number of items to return per page (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listCategoryDiscountsUsingGETRequest($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listCategoryDiscountsUsingGET'][0])
    {



        if ($page_size !== null && $page_size > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling CategoryDiscountApi.listCategoryDiscountsUsingGET, must be smaller than or equal to 1000.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling CategoryDiscountApi.listCategoryDiscountsUsingGET, must be bigger than or equal to 1.');
        }
