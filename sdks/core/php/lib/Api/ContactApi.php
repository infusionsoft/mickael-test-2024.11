...
class ContactApi
{
    ...
    /**
     * Operation getContactsBySearchTermUsingGET_0
     *
     * Search for Contacts
     *
     * @param  string $search_param searchParam (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getContactsBySearchTermUsingGET_0'] to see the possible values for this operation
     *
     * @throws \Com\Keap\Sdk\Core\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function getContactsBySearchTermUsingGET_0($search_param, string $contentType = self::contentTypes['getContactsBySearchTermUsingGET_0'][0])
    {
        list($response) = $this->getContactsBySearchTermUsingGET_0WithHttpInfo($search_param, $contentType);
        return $response;
    }

    /**
     * Operation getContactsBySearchTermUsingGET_0WithHttpInfo
     *
     * Search for Contacts
     *
     * @param  string $search_param searchParam (required)
     ...
     */
    public function getContactsBySearchTermUsingGET_0WithHttpInfo($search_param, string $contentType = self::contentTypes['getContactsBySearchTermUsingGET_0'][0])
    {
        $request = $this->getContactsBySearchTermUsingGET_0Request($search_param, $contentType);
    ...
    /**
     * Operation getContactsBySearchTermUsingGET_0Async
     *
     * Search for Contacts
     *
     * @param  string $search_param searchParam (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactsBySearchTermUsingGET_0Async($search_param, string $contentType = self::contentTypes['getContactsBySearchTermUsingGET_0'][0])
    {
        return $this->getContactsBySearchTermUsingGET_0AsyncWithHttpInfo($search_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getContactsBySearchTermUsingGET_0AsyncWithHttpInfo
     *
     * Search for Contacts
     *
     * @param  string $search_param searchParam (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactsBySearchTermUsingGET_0AsyncWithHttpInfo($search_param, string $contentType = self::contentTypes['getContactsBySearchTermUsingGET_0'][0])
    {
        $returnType = '\Com\Keap\Sdk\Core\Model\ListBasicContactResponse';
        $request = $this->getContactsBySearchTermUsingGET_0Request($search_param, $contentType);
    ...
    /**
     * Create request for operation 'getContactsBySearchTermUsingGET_0'
     *
     * @param  string $search_param searchParam (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getContactsBySearchTermUsingGET_0'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactsBySearchTermUsingGET_0Request($search_param, string $contentType = self::contentTypes['getContactsBySearchTermUsingGET_0'][0])
    {

        // verify the required parameter 'search_param' is set
        if ($search_param === null || (is_array($search_param) && count($search_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $search_param when calling getContactsBySearchTermUsingGET_0'
            );
        }
    ...
    /**
     * Operation patchContactUsingPATCH
     *
     * Update a Contact
     *
     * @param  string $contact_id contact_id (required)
    ...
    /**
     * Operation patchContactUsingPATCHWithHttpInfo
     *
     * Update a Contact
     *
     * @param  string $contact_id contact_id (required)
    ...
    /**
     * Operation patchContactUsingPATCHAsync
     *
     * Update a Contact
     *
     * @param  string $contact_id contact_id (required)
    ...
    /**
     * Operation patchContactUsingPATCHAsyncWithHttpInfo
     *
     * Update a Contact
     *
     * @param  string $contact_id contact_id (required)
    ...
    /**
     * Create request for operation 'patchContactUsingPATCH'
     *
     * @param  string $contact_id contact_id (required)
     * @param  string[] $update_mask An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped. (optional)
     * @param  \Com\Keap\Sdk\Core\Model\CreatePatchContactRequest $contact contact (optional)
    ...
    public function patchContactUsingPATCHRequest($contact_id, $update_mask = null, $contact = null, string $contentType = self::contentTypes['patchContactUsingPATCH'][0])
    {
        ...
        if ($contact_id === null || (is_array($contact_id) && count($contact_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contact_id when calling patchContactUsingPATCH'
            );
        }
