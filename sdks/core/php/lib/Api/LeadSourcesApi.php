...
class LeadSourcesApi
{
    ...
    public function listLeadSourcesUsingGETRequest($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listLeadSourcesUsingGET'][0])
    {
        ...
        if ($page_size !== null && $page_size > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling LeadSourcesApi.listLeadSourcesUsingGET, must be smaller than or equal to 1000.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling LeadSourcesApi.listLeadSourcesUsingGET, must be bigger than or equal to 1.');
        }
