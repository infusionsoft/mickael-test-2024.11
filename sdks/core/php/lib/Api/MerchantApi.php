...
class MerchantApi
{
    ...
    public function listMerchantsUsingGETRequest($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listMerchantsUsingGET'][0])
    {
        ...
        if ($page_size !== null && $page_size > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling MerchantApi.listMerchantsUsingGET, must be smaller than or equal to 1000.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling MerchantApi.listMerchantsUsingGET, must be bigger than or equal to 1.');
        }
