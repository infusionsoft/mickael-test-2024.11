...
class MerchantApi
{
    ...
    /**
     * Operation listMerchantsUsingGET_0
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listMerchantsUsingGET_0'] to see the possible values for this operation
     *
     ...
     */
    public function listMerchantsUsingGET_0($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listMerchantsUsingGET_0'][0])
    {
        list($response) = $this->listMerchantsUsingGET_0WithHttpInfo($filter, $order_by, $page_size, $page_token, $contentType);
        return $response;
    }

    /**
     * Operation listMerchantsUsingGET_0WithHttpInfo
     *
     * List Merchant accounts
     *
     * @param  string $filter Filter to apply, allowed fields are: - (String) id - (String) account_name - (String) type You will need to apply the &#x60;&#x3D;&#x3D;&#x60; operator to check the equality of one of the filters with your searched word, in the encoded form &#x60;%3D%3D&#x60;. For the filters listed above, here are some examples: - &#x60;filter&#x3D;id%3D%3D123&#x60; - &#x60;filter&#x3D;account_name%3D%3Dabc&#x60; - &#x60;filter&#x3D;id%3D%3D123;account_name&#x3D;abc&#x60; (optional)
     ...
     */
    public function listMerchantsUsingGET_0WithHttpInfo($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listMerchantsUsingGET_0'][0])
    {
        $request = $this->listMerchantsUsingGET_0Request($filter, $order_by, $page_size, $page_token, $contentType);
    ...
    /**
     * Operation listMerchantsUsingGET_0Async
     *
     * List Merchant accounts
     *
     * @param  string $filter Filter to apply, allowed fields are: - (String) id - (String) account_name - (String) type You will need to apply the &#x60;&#x3D;&#x3D;&#x60; operator to check the equality of one of the filters with your searched word, in the encoded form &#x60;%3D%3D&#x60;. For the filters listed above, here are some examples: - &#x60;filter&#x3D;id%3D%3D123&#x60; - &#x60;filter&#x3D;account_name%3D%3Dabc&#x60; - &#x60;filter&#x3D;id%3D%3D123;account_name&#x3D;abc&#x60; (optional)
     ...
     */
    public function listMerchantsUsingGET_0Async($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listMerchantsUsingGET_0'][0])
    {
        return $this->listMerchantsUsingGET_0AsyncWithHttpInfo($filter, $order_by, $page_size, $page_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listMerchantsUsingGET_0AsyncWithHttpInfo
     *
     * List Merchant accounts
     *
     * @param  string $filter Filter to apply, allowed fields are: - (String) id - (String) account_name - (String) type You will need to apply the &#x60;&#x3D;&#x3D;&#x60; operator to check the equality of one of the filters with your searched word, in the encoded form &#x60;%3D%3D&#x60;. For the filters listed above, here are some examples: - &#x60;filter&#x3D;id%3D%3D123&#x60; - &#x60;filter&#x3D;account_name%3D%3Dabc&#x60; - &#x60;filter&#x3D;id%3D%3D123;account_name&#x3D;abc&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listMerchantsUsingGET_0AsyncWithHttpInfo($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listMerchantsUsingGET_0'][0])
    {
        $returnType = '\Com\Keap\Sdk\Core\Model\ListRestMerchantResponse';
        $request = $this->listMerchantsUsingGET_0Request($filter, $order_by, $page_size, $page_token, $contentType);
    ...
    /**
     * Create request for operation 'listMerchantsUsingGET_0'
     *
     * @param  string $filter Filter to apply, allowed fields are: - (String) id - (String) account_name - (String) type You will need to apply the &#x60;&#x3D;&#x3D;&#x60; operator to check the equality of one of the filters with your searched word, in the encoded form &#x60;%3D%3D&#x60;. For the filters listed above, here are some examples: - &#x60;filter&#x3D;id%3D%3D123&#x60; - &#x60;filter&#x3D;account_name%3D%3Dabc&#x60; - &#x60;filter&#x3D;id%3D%3D123;account_name&#x3D;abc&#x60; (optional)
     * @param  string $order_by Attribute and direction to order items. One of the following fields: - id - account_name - type One of the following directions: - asc - desc (optional)
     * @param  int $page_size Total number of items to return per page (optional)
     ...
     */
    public function listMerchantsUsingGET_0Request($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listMerchantsUsingGET_0'][0])
    {



        if ($page_size !== null && $page_size > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling MerchantApi.listMerchantsUsingGET_0, must be smaller than or equal to 1000.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling MerchantApi.listMerchantsUsingGET_0, must be bigger than or equal to 1.');
        }
