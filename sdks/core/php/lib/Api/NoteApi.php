...
class NoteApi
{
    ...
    /**
     * Operation listNoteTemplatesUsingGET
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listNoteTemplatesUsingGET'] to see the possible values for this operation
     *
     * @throws \Com\Keap\Sdk\Core\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Com\Keap\Sdk\Core\Model\ListNoteTemplateResponse|\Com\Keap\Sdk\Core\Model\Error|\Com\Keap\Sdk\Core\Model\Error|\Com\Keap\Sdk\Core\Model\Error
     */
    public function listNoteTemplatesUsingGET($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listNoteTemplatesUsingGET'][0])
    {
        list($response) = $this->listNoteTemplatesUsingGETWithHttpInfo($filter, $order_by, $page_size, $page_token, $contentType);
        return $response;
    }

    /**
     * Operation listNoteTemplatesUsingGETWithHttpInfo
     *
     * Retrieve Note Templates
     *
     * @param  string $filter Search filter to apply to results (optional)
     ...
     * @throws \Com\Keap\Sdk\Core\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Com\Keap\Sdk\Core\Model\ListNoteTemplateResponse|\Com\Keap\Sdk\Core\Model\Error|\Com\Keap\Sdk\Core\Model\Error|\Com\Keap\Sdk\Core\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function listNoteTemplatesUsingGETWithHttpInfo($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listNoteTemplatesUsingGET'][0])
    {
        $request = $this->listNoteTemplatesUsingGETRequest($filter, $order_by, $page_size, $page_token, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Com\Keap\Sdk\Core\Model\ListNoteTemplateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Com\Keap\Sdk\Core\Model\ListNoteTemplateResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Com\Keap\Sdk\Core\Model\ListNoteTemplateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Com\Keap\Sdk\Core\Model\ListNoteTemplateResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Com\Keap\Sdk\Core\Model\ListNoteTemplateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation listNoteTemplatesUsingGETAsync
     *
     * Retrieve Note Templates
     *
     * @param  string $filter Search filter to apply to results (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listNoteTemplatesUsingGETAsync($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listNoteTemplatesUsingGET'][0])
    {
        return $this->listNoteTemplatesUsingGETAsyncWithHttpInfo($filter, $order_by, $page_size, $page_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listNoteTemplatesUsingGETAsyncWithHttpInfo
     *
     * Retrieve Note Templates
     *
     * @param  string $filter Search filter to apply to results (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listNoteTemplatesUsingGETAsyncWithHttpInfo($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listNoteTemplatesUsingGET'][0])
    {
        $returnType = '\Com\Keap\Sdk\Core\Model\ListNoteTemplateResponse';
        $request = $this->listNoteTemplatesUsingGETRequest($filter, $order_by, $page_size, $page_token, $contentType);
    ...
    /**
     * Create request for operation 'listNoteTemplatesUsingGET'
     *
     * @param  string $filter Search filter to apply to results (optional)
     * @param  string $order_by Attribute and direction to order items by. E.g. &#x60;given_name desc&#x60; (optional)
     * @param  int $page_size Total number of items to return per page (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listNoteTemplatesUsingGETRequest($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listNoteTemplatesUsingGET'][0])
    {



        if ($page_size !== null && $page_size > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling NoteApi.listNoteTemplatesUsingGET, must be smaller than or equal to 1000.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling NoteApi.listNoteTemplatesUsingGET, must be bigger than or equal to 1.');
        }
