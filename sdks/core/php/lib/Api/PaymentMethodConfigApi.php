...
class PaymentMethodConfigApi
{
    ...
    public function createPaymentMethodConfigUsingPOSTWithHttpInfo($request, string $contentType = self::contentTypes['createPaymentMethodConfigUsingPOST'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Com\Keap\Sdk\Core\Model\PaymentMethodConfig' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Com\Keap\Sdk\Core\Model\PaymentMethodConfig' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Com\Keap\Sdk\Core\Model\PaymentMethodConfig', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Com\Keap\Sdk\Core\Model\PaymentMethodConfig',
