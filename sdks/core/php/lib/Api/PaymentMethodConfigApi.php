...
class PaymentMethodConfigApi
{
     ...
     *
     * @param  \Keap\Sdk\Core\Model\CreatePaymentMethodConfigRequest $create_payment_method_config_request request (required)
     ...
     * @return \Keap\Sdk\Core\Model\PaymentMethodConfig|\Keap\Sdk\Core\Model\Error|\Keap\Sdk\Core\Model\Error
     */
     ...
     * @throws \Keap\Sdk\Core\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Keap\Sdk\Core\Model\PaymentMethodConfig|\Keap\Sdk\Core\Model\Error|\Keap\Sdk\Core\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPaymentMethodConfigUsingPOSTWithHttpInfo($create_payment_method_config_request, string $contentType = self::contentTypes['createPaymentMethodConfigUsingPOST'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Keap\Sdk\Core\Model\PaymentMethodConfig' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Keap\Sdk\Core\Model\PaymentMethodConfig' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Keap\Sdk\Core\Model\PaymentMethodConfig', []),
            ...
            $returnType = '\Keap\Sdk\Core\Model\PaymentMethodConfig';
