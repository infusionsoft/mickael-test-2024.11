...
class ShippingApi
{
    ...
    /**
     * Operation listShippingMethodsUsingGET_0
     *
     * List Shipping methods
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listShippingMethodsUsingGET_0'] to see the possible values for this operation
     *
     ...
     */
    public function listShippingMethodsUsingGET_0(string $contentType = self::contentTypes['listShippingMethodsUsingGET_0'][0])
    {
        list($response) = $this->listShippingMethodsUsingGET_0WithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation listShippingMethodsUsingGET_0WithHttpInfo
     *
     * List Shipping methods
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listShippingMethodsUsingGET_0'] to see the possible values for this operation
     ...
     */
    public function listShippingMethodsUsingGET_0WithHttpInfo(string $contentType = self::contentTypes['listShippingMethodsUsingGET_0'][0])
    {
        $request = $this->listShippingMethodsUsingGET_0Request($contentType);
    ...
    /**
     * Operation listShippingMethodsUsingGET_0Async
     *
     * List Shipping methods
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listShippingMethodsUsingGET_0'] to see the possible values for this operation
     ...
     */
    public function listShippingMethodsUsingGET_0Async(string $contentType = self::contentTypes['listShippingMethodsUsingGET_0'][0])
    {
        return $this->listShippingMethodsUsingGET_0AsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listShippingMethodsUsingGET_0AsyncWithHttpInfo
     *
     * List Shipping methods
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listShippingMethodsUsingGET_0'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listShippingMethodsUsingGET_0AsyncWithHttpInfo(string $contentType = self::contentTypes['listShippingMethodsUsingGET_0'][0])
    {
        $returnType = '\Com\Keap\Sdk\Core\Model\ListRestShippingMethodsResponse';
        $request = $this->listShippingMethodsUsingGET_0Request($contentType);
    ...
    /**
     * Create request for operation 'listShippingMethodsUsingGET_0'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listShippingMethodsUsingGET_0'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function listShippingMethodsUsingGET_0Request(string $contentType = self::contentTypes['listShippingMethodsUsingGET_0'][0])
    {
