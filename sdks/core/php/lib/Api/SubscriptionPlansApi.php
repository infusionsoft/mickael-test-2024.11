...
class SubscriptionPlansApi
{
    ...
    /**
     * Operation listSubscriptionPlansUsingGET_0
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listSubscriptionPlansUsingGET_0'] to see the possible values for this operation
     *
     * @throws \Com\Keap\Sdk\Core\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function listSubscriptionPlansUsingGET_0($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listSubscriptionPlansUsingGET_0'][0])
    {
        list($response) = $this->listSubscriptionPlansUsingGET_0WithHttpInfo($filter, $order_by, $page_size, $page_token, $contentType);
        return $response;
    }

    /**
     * Operation listSubscriptionPlansUsingGET_0WithHttpInfo
     *
     * List Subscription Plans
     *
     * @param  string $filter Filter to apply, allowed fields are:   - (String) name (optional)
     ...
     */
    public function listSubscriptionPlansUsingGET_0WithHttpInfo($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listSubscriptionPlansUsingGET_0'][0])
    {
        $request = $this->listSubscriptionPlansUsingGET_0Request($filter, $order_by, $page_size, $page_token, $contentType);
    ...
    /**
     * Operation listSubscriptionPlansUsingGET_0Async
     *
     * List Subscription Plans
     *
     * @param  string $filter Filter to apply, allowed fields are:   - (String) name (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSubscriptionPlansUsingGET_0Async($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listSubscriptionPlansUsingGET_0'][0])
    {
        return $this->listSubscriptionPlansUsingGET_0AsyncWithHttpInfo($filter, $order_by, $page_size, $page_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listSubscriptionPlansUsingGET_0AsyncWithHttpInfo
     *
     * List Subscription Plans
     *
     * @param  string $filter Filter to apply, allowed fields are:   - (String) name (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSubscriptionPlansUsingGET_0AsyncWithHttpInfo($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listSubscriptionPlansUsingGET_0'][0])
    {
        $returnType = '\Com\Keap\Sdk\Core\Model\ListSubscriptionPlansResponse';
        $request = $this->listSubscriptionPlansUsingGET_0Request($filter, $order_by, $page_size, $page_token, $contentType);
    ...
    /**
     * Create request for operation 'listSubscriptionPlansUsingGET_0'
     *
     * @param  string $filter Filter to apply, allowed fields are:   - (String) name (optional)
     * @param  string $order_by Attribute and direction to order items.   One of the following fields:   - name   One of the following directions:   - asc   - desc (optional)
     * @param  int $page_size Total number of items to return per page (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listSubscriptionPlansUsingGET_0Request($filter = null, $order_by = null, $page_size = null, $page_token = null, string $contentType = self::contentTypes['listSubscriptionPlansUsingGET_0'][0])
    {



        if ($page_size !== null && $page_size > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling SubscriptionPlansApi.listSubscriptionPlansUsingGET_0, must be smaller than or equal to 1000.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling SubscriptionPlansApi.listSubscriptionPlansUsingGET_0, must be bigger than or equal to 1.');
        }
