...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'core-service-core-php/0.0.134';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 2.70.0.770650' . PHP_EOL;
        $report .= '    SDK Package Version: 0.0.134' . PHP_EOL;
