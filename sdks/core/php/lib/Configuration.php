...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'core-service-core-php/0.0.88';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 2.70.0.764128' . PHP_EOL;
        $report .= '    SDK Package Version: 0.0.88' . PHP_EOL;
