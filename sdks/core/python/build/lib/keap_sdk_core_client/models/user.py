...
class User(BaseModel):
    ...
    global_user_id: Optional[StrictInt] = None
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Active', 'Invited', 'Inactive', 'NotAUser']):
            raise ValueError("must be one of enum values ('Active', 'Invited', 'Inactive', 'NotAUser')")
        return value
