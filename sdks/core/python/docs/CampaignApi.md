# keap_sdk_core_client.CampaignApi
...
with keap_sdk_core_client.ApiClient(configuration) as api_client:
    ...
    api_instance = keap_sdk_core_client.CampaignApi(api_client)
    campaign_id = 'campaign_id_example' # str | campaign_id
    sequence_id = 'sequence_id_example' # str | sequence_id
    add_contacts_to_sequence_request = keap_sdk_core_client.AddContactsToSequenceRequest() # AddContactsToSequenceRequest | addContactsToSequenceRequest
...
with keap_sdk_core_client.ApiClient(configuration) as api_client:
    ...
    campaign_id = 'campaign_id_example' # str | campaign_id
    sequence_id = 'sequence_id_example' # str | sequence_id
    remove_contacts_from_sequence_request = keap_sdk_core_client.RemoveContactsFromSequenceRequest() # RemoveContactsFromSequenceRequest | removeContactsFromSequenceRequest
