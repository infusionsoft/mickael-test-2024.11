...
class DiscountApi:
    ...
    @validate_call
    def get_category_discount_using_get_0(
        self,
        ...
        _param = self._get_category_discount_using_get_0_serialize(
    ...
    @validate_call
    def get_category_discount_using_get_0_with_http_info(
        self,
        discount_id: Annotated[StrictStr, Field(description="discount_id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_category_discount_using_get_0_without_preload_content(
        self,
        discount_id: Annotated[StrictStr, Field(description="discount_id")],
        _request_timeout: Union[
            None,
    ...
    def _get_category_discount_using_get_0_serialize(
        self,
        discount_id,
        _request_auth,
        _content_type,
