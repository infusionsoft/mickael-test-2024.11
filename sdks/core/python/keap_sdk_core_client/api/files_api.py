...
class FilesApi:
    ...
    def create_file_using_post1(
        self,
        create_file_request: Annotated[CreateFileRequest, Field(description="request")],
        ...
        :param create_file_request: request (required)
    ...
    @validate_call
    def update_file_using_patch(
        self,
        file_id: Annotated[StrictStr, Field(description="file_id")],
        update_file_request: Annotated[UpdateFileRequest, Field(description="request")],
        ...
        :param file_id: file_id (required)
        :type file_id: str
        :param update_file_request: request (required)
        ...
        _param = self._update_file_using_patch_serialize(
            file_id=file_id,
    ...
    @validate_call
    def update_file_using_patch_with_http_info(
        self,
        file_id: Annotated[StrictStr, Field(description="file_id")],
        update_file_request: Annotated[UpdateFileRequest, Field(description="request")],
        update_mask: Annotated[Optional[List[StrictStr]], Field(description="An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.")] = None,
    ...
    @validate_call
    def update_file_using_patch_without_preload_content(
        self,
        file_id: Annotated[StrictStr, Field(description="file_id")],
        update_file_request: Annotated[UpdateFileRequest, Field(description="request")],
        update_mask: Annotated[Optional[List[StrictStr]], Field(description="An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.")] = None,
    ...
    def _update_file_using_patch_serialize(
        self,
        file_id,
        update_file_request,
        update_mask,
