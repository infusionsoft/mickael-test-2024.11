...
class LeadScoreApi:
    ...
    @validate_call
    def get_lead_score_details_using_get(
        self,
        ...
        _param = self._get_lead_score_details_using_get_serialize(
    ...
    @validate_call
    def get_lead_score_details_using_get_with_http_info(
        self,
        contact_id: Annotated[StrictStr, Field(description="contact_id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_lead_score_details_using_get_without_preload_content(
        self,
        contact_id: Annotated[StrictStr, Field(description="contact_id")],
        _request_timeout: Union[
            None,
    ...
    def _get_lead_score_details_using_get_serialize(
        self,
        contact_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/contact/{contact_id}/leadScore',
