...
class OrdersApi:
    ...
    @validate_call
    def list_order_payments_using_get1(
        self,
        order_id: Annotated[StrictStr, Field(description="order_id")],
        ...
        _param = self._list_order_payments_using_get1_serialize(
            order_id=order_id,
            filter=filter,
            order_by=order_by,
            page_size=page_size,
    ...
    @validate_call
    def list_order_payments_using_get1_with_http_info(
        self,
        order_id: Annotated[StrictStr, Field(description="order_id")],
        filter: Annotated[Optional[StrictStr], Field(description="Filter to apply, allowed fields are: - (String) invoice_id - (String) payment_id - (String) amount - (String) pay_status - (Boolean) skip_commission  You will need to apply the `==` operator to check the equality of one of the filters with your searched  word, in the encoded form `%3D%3D`. For the filters listed above, here are some examples: - `filter=payment_id%3D%3D123` - `filter=pay_status%3D%3DAPPROVED` - `filter=invoice_id%3D%3D456%3Bskip_commission=true` ")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items. One of the following fields: - invoice_id - payment_id - amount - pay_time - pay_status - skip_commission - last_updated_time One of the following directions: - asc - desc ")] = None,
    ...
    @validate_call
    def list_order_payments_using_get1_without_preload_content(
        self,
        order_id: Annotated[StrictStr, Field(description="order_id")],
        filter: Annotated[Optional[StrictStr], Field(description="Filter to apply, allowed fields are: - (String) invoice_id - (String) payment_id - (String) amount - (String) pay_status - (Boolean) skip_commission  You will need to apply the `==` operator to check the equality of one of the filters with your searched  word, in the encoded form `%3D%3D`. For the filters listed above, here are some examples: - `filter=payment_id%3D%3D123` - `filter=pay_status%3D%3DAPPROVED` - `filter=invoice_id%3D%3D456%3Bskip_commission=true` ")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items. One of the following fields: - invoice_id - payment_id - amount - pay_time - pay_status - skip_commission - last_updated_time One of the following directions: - asc - desc ")] = None,
    ...
    def _list_order_payments_using_get1_serialize(
        self,
        order_id,
        filter,
        order_by,
