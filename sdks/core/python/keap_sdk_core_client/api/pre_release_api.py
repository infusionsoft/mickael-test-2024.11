...
class PreReleaseApi:
    ...
    @validate_call
    def get_category_discount_using_get(
        self,
        ...
        _param = self._get_category_discount_using_get_serialize(
    ...
    @validate_call
    def get_category_discount_using_get_with_http_info(
        self,
        discount_id: Annotated[StrictStr, Field(description="discount_id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_category_discount_using_get_without_preload_content(
        self,
        discount_id: Annotated[StrictStr, Field(description="discount_id")],
        _request_timeout: Union[
            None,
    ...
    def _get_category_discount_using_get_serialize(
        self,
        discount_id,
        _request_auth,
        _content_type,
    ...
    def get_contacts_by_search_term_using_get(
        ...
        :param search_param: searchParam (required)
    ...
    def get_contacts_by_search_term_using_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListBasicContactResponse]:
        """Search for Contacts
    ...
    def _get_contacts_by_search_term_using_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/contacts:search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_landing_pages_using_get(
        self,
        ...
        _param = self._list_landing_pages_using_get_serialize(
            filter=filter,
            order_by=order_by,
            page_size=page_size,
            page_token=page_token,
    ...
    @validate_call
    def list_landing_pages_using_get_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Search filter to apply to results")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items by. E.g. `given_name desc`")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Total number of items to return per page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListLandingPagesResponse]:
        """List Landing Pages
    ...
    @validate_call
    def list_landing_pages_using_get_without_preload_content(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Search filter to apply to results")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items by. E.g. `given_name desc`")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Total number of items to return per page")] = None,
    ...
    def _list_landing_pages_using_get_serialize(
        self,
        filter,
        order_by,
        page_size,
    ...
    def _list_subscription_plans_using_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/subscriptionPlans',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
