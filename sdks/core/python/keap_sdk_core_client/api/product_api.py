...
class ProductApi:
    ...
    @validate_call
    def adjust_inventory_using_post(
        self,
        ...
        _param = self._adjust_inventory_using_post_serialize(
    ...
    @validate_call
    def adjust_inventory_using_post_with_http_info(
        self,
        product_id: Annotated[StrictStr, Field(description="product_id")],
        update_product_inventory_request: Annotated[UpdateProductInventoryRequest, Field(description="updateProductInventoryRequest")],
        _request_timeout: Union[
    ...
    @validate_call
    def adjust_inventory_using_post_without_preload_content(
        self,
        product_id: Annotated[StrictStr, Field(description="product_id")],
        update_product_inventory_request: Annotated[UpdateProductInventoryRequest, Field(description="updateProductInventoryRequest")],
        _request_timeout: Union[
    ...
    def _adjust_inventory_using_post_serialize(
        self,
        product_id,
    ...
    @validate_call
    def create_product_using_post1(
        self,
        ...
        _param = self._create_product_using_post1_serialize(
    ...
    @validate_call
    def create_product_using_post1_with_http_info(
        self,
        create_product_request: Annotated[CreateProductRequest, Field(description="createProductRequest")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_product_using_post1_without_preload_content(
        self,
        create_product_request: Annotated[CreateProductRequest, Field(description="createProductRequest")],
        _request_timeout: Union[
            None,
    ...
    def _create_product_using_post1_serialize(
        self,
    ...
    @validate_call
    def delete_product_using_delete1(
        self,
        product_id: Annotated[StrictStr, Field(description="product_id")],
        _request_timeout: Union[
            None,
        ...
        _param = self._delete_product_using_delete1_serialize(
            product_id=product_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_product_using_delete1_with_http_info(
        self,
        product_id: Annotated[StrictStr, Field(description="product_id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_product_using_delete1_without_preload_content(
        self,
        product_id: Annotated[StrictStr, Field(description="product_id")],
        _request_timeout: Union[
            None,
    ...
    def _delete_product_using_delete1_serialize(
        self,
        product_id,
        _request_auth,
        _content_type,
    ...
    def get_product_using_get(
        ...
        _param = self._get_product_using_get_serialize(
            product_id=product_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_product_using_get_with_http_info(
        self,
        product_id: Annotated[StrictStr, Field(description="product_id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_product_using_get_without_preload_content(
        self,
        product_id: Annotated[StrictStr, Field(description="product_id")],
        _request_timeout: Union[
            None,
    ...
    def _get_product_using_get_serialize(
        self,
        product_id,
        _request_auth,
        _content_type,
