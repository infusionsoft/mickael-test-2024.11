...
class CreatePaymentRequest(BaseModel):
    ...
    payment_amount: Optional[StrictStr] = None
    payment_method_id: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["apply_to_commissions", "date", "notes", "payment_amount", "payment_method_id"]
