...
class ListSubscriptionPlansResponse(BaseModel):
    ...
    subscriptions: Optional[List[RestSubscriptionPlan]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscriptions": [RestSubscriptionPlan.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None
        })
