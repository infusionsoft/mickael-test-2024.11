...
class RestSubscriptionPlan(BaseModel):
    ...
    subscription_plan_index: Optional[StrictInt] = None
    subscription_plan_name: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["active", "cycle", "frequency", "id", "product_id", "subscription_plan_index", "subscription_plan_name"]
