...
class RestV2OrderItem(BaseModel):
    ...
    product: Optional[RestProduct] = None
    ...
    def cycle_validate_enum(cls, value):
        ...
        if value not in set(['YEAR', 'MONTH', 'WEEK', 'DAY_OF_YEAR']):
            raise ValueError("must be one of enum values ('YEAR', 'MONTH', 'WEEK', 'DAY_OF_YEAR')")
        return value
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['UNKNOWN', 'SHIPPING', 'TAX', 'SERVICE', 'PRODUCT', 'UPSELL', 'FINANCECHARGE', 'SPECIAL', 'PROGRAM', 'SUBSCRIPTION', 'SPECIAL_FREE_TRAIL_DAYS', 'SPECIAL_ORDER_TOTAL', 'SPECIAL_PRODUCT', 'SPECIAL_CATEGORY', 'SPECIAL_SHIPPING', 'TIP', 'OTHER']):
            raise ValueError("must be one of enum values ('UNKNOWN', 'SHIPPING', 'TAX', 'SERVICE', 'PRODUCT', 'UPSELL', 'FINANCECHARGE', 'SPECIAL', 'PROGRAM', 'SUBSCRIPTION', 'SPECIAL_FREE_TRAIL_DAYS', 'SPECIAL_ORDER_TOTAL', 'SPECIAL_PRODUCT', 'SPECIAL_CATEGORY', 'SPECIAL_SHIPPING', 'TIP', 'OTHER')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price": obj.get("price"),
            "product": RestProduct.from_dict(obj["product"]) if obj.get("product") is not None else None,
