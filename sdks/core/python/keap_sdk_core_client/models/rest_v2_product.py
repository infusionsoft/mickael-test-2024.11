...
class RestV2Product(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["active", "categories", "city_taxable", "country_taxable", "description", "id", "name", "options", "price", "short_description", "sku", "state_taxable", "storefront_hidden", "subscription_only", "subscription_plans", "taxable", "weight"]
