 ...
 * no description
 */
export class BusinessProfileApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async getBusinessProfileUsingGET(_options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/v2/businessProfile';
...
export class BusinessProfileApiResponseProcessor {
