 ...
 * no description
 */
export class DiscountApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async getCategoryDiscountUsingGET(discountId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (discountId === null || discountId === undefined) {
            throw new RequiredError("DiscountApi", "getCategoryDiscountUsingGET", "discountId");
        }
...
export class DiscountApiResponseProcessor {
