...
exports.AutomationApiResponseProcessor = exports.AutomationApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var AutomationApiRequestFactory = (function (_super) {
    __extends(AutomationApiRequestFactory, _super);
    function AutomationApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AutomationApiRequestFactory.prototype.addContactsToAutomationSequenceUsingPOST = function (automationId, sequenceId, addToAutomationSequenceRequest, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (automationId === null || automationId === undefined) {
                            throw new baseapi_1.RequiredError("AutomationApi", "addContactsToAutomationSequenceUsingPOST", "automationId");
                        }
                        if (sequenceId === null || sequenceId === undefined) {
                            throw new baseapi_1.RequiredError("AutomationApi", "addContactsToAutomationSequenceUsingPOST", "sequenceId");
                        }
                        if (addToAutomationSequenceRequest === null || addToAutomationSequenceRequest === undefined) {
                            throw new baseapi_1.RequiredError("AutomationApi", "addContactsToAutomationSequenceUsingPOST", "addToAutomationSequenceRequest");
                        }
                        localVarPath = '/v2/automations/{automation_id}/sequences/{sequence_id}:addContacts'
                        ...
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(addToAutomationSequenceRequest, "AddToAutomationSequenceRequest", ""), contentType);
    ...
    AutomationApiRequestFactory.prototype.deleteAutomationUsingDELETE = function (automationIds, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (automationIds === null || automationIds === undefined) {
                            throw new baseapi_1.RequiredError("AutomationApi", "deleteAutomationUsingDELETE", "automationIds");
                        }
                        localVarPath = '/v2/automations';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.DELETE);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        if (automationIds !== undefined) {
                            serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(automationIds, "Array<number>", "int64");
    ...
    AutomationApiRequestFactory.prototype.getAutomationUsingGET = function (automationId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (automationId === null || automationId === undefined) {
                            throw new baseapi_1.RequiredError("AutomationApi", "getAutomationUsingGET", "automationId");
                        }
                        localVarPath = '/v2/automations/{automation_id}'
                            .replace('{' + 'automation_id' + '}', encodeURIComponent(String(automationId)));
    ...
    AutomationApiRequestFactory.prototype.listAllAutomationIdsUsingGET = function (filter, orderBy, pageSize, pageToken, stats, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        localVarPath = '/v2/automations/ids';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        if (filter !== undefined) {
                        ...
                        if (stats !== undefined) {
                            requestContext.setQueryParam("stats", ObjectSerializer_1.ObjectSerializer.serialize(stats, "boolean", ""));
                        }
                        defaultAuth = ((_a = _options === null || _options === void 0 ? void 0 : _options.authMethods) === null || _a === void 0 ? void 0 : _a.default) || ((_c = (_b = this.configuration) === null || _b === void 0 ? void 0 : _b.authMethods) === null || _c === void 0 ? void 0 : _c.default);
                        if (!(defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication)) return [3, 2];
                        return [4, (defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication(requestContext))];
    ...
    AutomationApiRequestFactory.prototype.listAutomationsUsingGET = function (filter, orderBy, pageSize, pageToken, stats, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
    ...
    AutomationApiRequestFactory.prototype.updateAutomationCategoryUsingPUT = function (updateAutomationCategoryRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (updateAutomationCategoryRequest === null || updateAutomationCategoryRequest === undefined) {
                            throw new baseapi_1.RequiredError("AutomationApi", "updateAutomationCategoryUsingPUT", "updateAutomationCategoryRequest");
                        }
                        localVarPath = '/v2/automations/category';
                        ...
                        requestContext.setHeaderParam("Content-Type", contentType);
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(updateAutomationCategoryRequest, "UpdateAutomationCategoryRequest", ""), contentType);
                        requestContext.setBody(serializedBody);
                        defaultAuth = ((_a = _options === null || _options === void 0 ? void 0 : _options.authMethods) === null || _a === void 0 ? void 0 : _a.default) || ((_c = (_b = this.configuration) === null || _b === void 0 ? void 0 : _b.authMethods) === null || _c === void 0 ? void 0 : _c.default);
                        if (!(defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication)) return [3, 2];
                        return [4, (defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication(requestContext))];
    ...
    return AutomationApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.AutomationApiRequestFactory = AutomationApiRequestFactory;
var AutomationApiResponseProcessor = (function () {
    function AutomationApiResponseProcessor() {
    }
    AutomationApiResponseProcessor.prototype.addContactsToAutomationSequenceUsingPOSTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AutomationApiResponseProcessor.prototype.deleteAutomationUsingDELETEWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
    ...
    AutomationApiResponseProcessor.prototype.getAutomationUsingGETWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AutomationApiResponseProcessor.prototype.listAllAutomationIdsUsingGETWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    AutomationApiResponseProcessor.prototype.listAutomationsUsingGETWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    AutomationApiResponseProcessor.prototype.updateAutomationCategoryUsingPUTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
    ...
    return AutomationApiResponseProcessor;
}());
exports.AutomationApiResponseProcessor = AutomationApiResponseProcessor;
