...
exports.AutomationCategoryApiResponseProcessor = exports.AutomationCategoryApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var AutomationCategoryApiRequestFactory = (function (_super) {
    __extends(AutomationCategoryApiRequestFactory, _super);
    function AutomationCategoryApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AutomationCategoryApiRequestFactory.prototype.createCategoryUsingPOST = function (createAutomationCategoryRequest, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (createAutomationCategoryRequest === null || createAutomationCategoryRequest === undefined) {
                            throw new baseapi_1.RequiredError("AutomationCategoryApi", "createCategoryUsingPOST", "createAutomationCategoryRequest");
                        }
                        localVarPath = '/v2/automationCategory';
                        ...
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(createAutomationCategoryRequest, "CreateAutomationCategoryRequest", ""), contentType);
    ...
    AutomationCategoryApiRequestFactory.prototype.deleteCategoriesUsingDELETE = function (ids, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (ids === null || ids === undefined) {
                            throw new baseapi_1.RequiredError("AutomationCategoryApi", "deleteCategoriesUsingDELETE", "ids");
                        }
                        localVarPath = '/v2/automationCategory';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.DELETE);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        if (ids !== undefined) {
                            serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(ids, "Array<number>", "int64");
    ...
    AutomationCategoryApiRequestFactory.prototype.listCategoriesUsingGET = function (_options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    AutomationCategoryApiRequestFactory.prototype.saveCategoryUsingPUT = function (saveAutomationCategoryRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (saveAutomationCategoryRequest === null || saveAutomationCategoryRequest === undefined) {
                            throw new baseapi_1.RequiredError("AutomationCategoryApi", "saveCategoryUsingPUT", "saveAutomationCategoryRequest");
                        }
                        localVarPath = '/v2/automationCategory';
                        ...
                        requestContext.setHeaderParam("Content-Type", contentType);
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(saveAutomationCategoryRequest, "SaveAutomationCategoryRequest", ""), contentType);
                        requestContext.setBody(serializedBody);
                        defaultAuth = ((_a = _options === null || _options === void 0 ? void 0 : _options.authMethods) === null || _a === void 0 ? void 0 : _a.default) || ((_c = (_b = this.configuration) === null || _b === void 0 ? void 0 : _b.authMethods) === null || _c === void 0 ? void 0 : _c.default);
                        if (!(defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication)) return [3, 2];
                        return [4, (defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication(requestContext))];
    ...
    return AutomationCategoryApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.AutomationCategoryApiRequestFactory = AutomationCategoryApiRequestFactory;
var AutomationCategoryApiResponseProcessor = (function () {
    function AutomationCategoryApiResponseProcessor() {
    }
    AutomationCategoryApiResponseProcessor.prototype.createCategoryUsingPOSTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AutomationCategoryApiResponseProcessor.prototype.deleteCategoriesUsingDELETEWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
    ...
    AutomationCategoryApiResponseProcessor.prototype.listCategoriesUsingGETWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AutomationCategoryApiResponseProcessor.prototype.saveCategoryUsingPUTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    return AutomationCategoryApiResponseProcessor;
}());
exports.AutomationCategoryApiResponseProcessor = AutomationCategoryApiResponseProcessor;
//# sourceMappingURL=AutomationCategoryApi.js.map