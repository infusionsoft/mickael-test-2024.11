...
exports.CategoryDiscountApiResponseProcessor = exports.CategoryDiscountApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var CategoryDiscountApiRequestFactory = (function (_super) {
    __extends(CategoryDiscountApiRequestFactory, _super);
    function CategoryDiscountApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CategoryDiscountApiRequestFactory.prototype.deleteDiscountUsingDELETE = function (discountId, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (discountId === null || discountId === undefined) {
                            throw new baseapi_1.RequiredError("CategoryDiscountApi", "deleteDiscountUsingDELETE", "discountId");
                        }
    ...
    CategoryDiscountApiRequestFactory.prototype.getDiscountUsingGET = function (discountId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (discountId === null || discountId === undefined) {
                            throw new baseapi_1.RequiredError("CategoryDiscountApi", "getDiscountUsingGET", "discountId");
                        }
                        localVarPath = '/v2/discounts/productCategories/{discount_id}'
                            .replace('{' + 'discount_id' + '}', encodeURIComponent(String(discountId)));
    ...
    return CategoryDiscountApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.CategoryDiscountApiRequestFactory = CategoryDiscountApiRequestFactory;
var CategoryDiscountApiResponseProcessor = (function () {
    function CategoryDiscountApiResponseProcessor() {
    }
    CategoryDiscountApiResponseProcessor.prototype.deleteDiscountUsingDELETEWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CategoryDiscountApiResponseProcessor.prototype.getDiscountUsingGETWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return CategoryDiscountApiResponseProcessor;
}());
exports.CategoryDiscountApiResponseProcessor = CategoryDiscountApiResponseProcessor;
//# sourceMappingURL=CategoryDiscountApi.js.map