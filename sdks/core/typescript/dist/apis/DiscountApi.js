...
exports.DiscountApiResponseProcessor = exports.DiscountApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var DiscountApiRequestFactory = (function (_super) {
    __extends(DiscountApiRequestFactory, _super);
    function DiscountApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DiscountApiRequestFactory.prototype.getCategoryDiscountUsingGET = function (discountId, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (discountId === null || discountId === undefined) {
                            throw new baseapi_1.RequiredError("DiscountApi", "getCategoryDiscountUsingGET", "discountId");
                        }
    ...
    return DiscountApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.DiscountApiRequestFactory = DiscountApiRequestFactory;
var DiscountApiResponseProcessor = (function () {
    function DiscountApiResponseProcessor() {
    }
    DiscountApiResponseProcessor.prototype.getCategoryDiscountUsingGETWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return DiscountApiResponseProcessor;
}());
exports.DiscountApiResponseProcessor = DiscountApiResponseProcessor;
