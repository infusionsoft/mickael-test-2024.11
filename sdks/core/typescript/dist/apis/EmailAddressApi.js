...
exports.EmailAddressApiResponseProcessor = exports.EmailAddressApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var EmailAddressApiRequestFactory = (function (_super) {
    __extends(EmailAddressApiRequestFactory, _super);
    function EmailAddressApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    EmailAddressApiRequestFactory.prototype.getEmailAddressStatusUsingGET = function (email, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (email === null || email === undefined) {
                            throw new baseapi_1.RequiredError("EmailAddressApi", "getEmailAddressStatusUsingGET", "email");
                        }
                        localVarPath = '/v2/emailAddresses/{email}'
    ...
    EmailAddressApiRequestFactory.prototype.updateEmailAddressOptStatusUsingPUT = function (email, updateEmailAddress, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (email === null || email === undefined) {
                            throw new baseapi_1.RequiredError("EmailAddressApi", "updateEmailAddressOptStatusUsingPUT", "email");
                        }
                        if (updateEmailAddress === null || updateEmailAddress === undefined) {
                            throw new baseapi_1.RequiredError("EmailAddressApi", "updateEmailAddressOptStatusUsingPUT", "updateEmailAddress");
                        }
                        localVarPath = '/v2/emailAddresses/{email}'
                            .replace('{' + 'email' + '}', encodeURIComponent(String(email)));
                        ...
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(updateEmailAddress, "UpdateEmailAddress", ""), contentType);
    ...
    return EmailAddressApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.EmailAddressApiRequestFactory = EmailAddressApiRequestFactory;
var EmailAddressApiResponseProcessor = (function () {
    function EmailAddressApiResponseProcessor() {
    }
    EmailAddressApiResponseProcessor.prototype.getEmailAddressStatusUsingGETWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    EmailAddressApiResponseProcessor.prototype.updateEmailAddressOptStatusUsingPUTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    return EmailAddressApiResponseProcessor;
}());
exports.EmailAddressApiResponseProcessor = EmailAddressApiResponseProcessor;
//# sourceMappingURL=EmailAddressApi.js.map