...
exports.EmailApiResponseProcessor = exports.EmailApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var EmailApiRequestFactory = (function (_super) {
    __extends(EmailApiRequestFactory, _super);
    function EmailApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    EmailApiRequestFactory.prototype.createEmailUsingPOST1 = function (emailWithContent, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (emailWithContent === null || emailWithContent === undefined) {
                            throw new baseapi_1.RequiredError("EmailApi", "createEmailUsingPOST1", "emailWithContent");
                        }
                        localVarPath = '/v2/emails';
                        ...
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(emailWithContent, "CreateEmailSentRequest", ""), contentType);
    ...
    EmailApiRequestFactory.prototype.createEmailsUsingPOST1 = function (createEmailsSentRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        localVarPath = '/v2/emails:batchAdd';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
                        ...
                        requestContext.setHeaderParam("Content-Type", contentType);
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(createEmailsSentRequest, "CreateEmailsSentRequest", ""), contentType);
                        requestContext.setBody(serializedBody);
                        defaultAuth = ((_a = _options === null || _options === void 0 ? void 0 : _options.authMethods) === null || _a === void 0 ? void 0 : _a.default) || ((_c = (_b = this.configuration) === null || _b === void 0 ? void 0 : _b.authMethods) === null || _c === void 0 ? void 0 : _c.default);
                        if (!(defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication)) return [3, 2];
                        return [4, (defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication(requestContext))];
    ...
    EmailApiRequestFactory.prototype.deleteEmailUsingDELETE1 = function (id, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (id === null || id === undefined) {
                            throw new baseapi_1.RequiredError("EmailApi", "deleteEmailUsingDELETE1", "id");
                        }
                        localVarPath = '/v2/emails/{id}'
    ...
    EmailApiRequestFactory.prototype.deleteEmailsUsingPOST1 = function (deleteEmailsRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (deleteEmailsRequest === null || deleteEmailsRequest === undefined) {
                            throw new baseapi_1.RequiredError("EmailApi", "deleteEmailsUsingPOST1", "deleteEmailsRequest");
                        }
                        localVarPath = '/v2/emails:batchRemove';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
                        ...
                        requestContext.setHeaderParam("Content-Type", contentType);
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(deleteEmailsRequest, "DeleteEmailsRequest", ""), contentType);
                        requestContext.setBody(serializedBody);
                        defaultAuth = ((_a = _options === null || _options === void 0 ? void 0 : _options.authMethods) === null || _a === void 0 ? void 0 : _a.default) || ((_c = (_b = this.configuration) === null || _b === void 0 ? void 0 : _b.authMethods) === null || _c === void 0 ? void 0 : _c.default);
                        if (!(defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication)) return [3, 2];
                        return [4, (defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication(requestContext))];
    ...
    EmailApiRequestFactory.prototype.getEmailUsingGET1 = function (id, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (id === null || id === undefined) {
                            throw new baseapi_1.RequiredError("EmailApi", "getEmailUsingGET1", "id");
                        }
                        localVarPath = '/v2/emails/{id}'
                            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
    ...
    EmailApiRequestFactory.prototype.sendEmailUsingPOST1 = function (emailSendRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        requestContext.setHeaderParam("Content-Type", contentType);
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(emailSendRequest, "EmailSendRequest", ""), contentType);
                        requestContext.setBody(serializedBody);
                        defaultAuth = ((_a = _options === null || _options === void 0 ? void 0 : _options.authMethods) === null || _a === void 0 ? void 0 : _a.default) || ((_c = (_b = this.configuration) === null || _b === void 0 ? void 0 : _b.authMethods) === null || _c === void 0 ? void 0 : _c.default);
                        if (!(defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication)) return [3, 2];
                        return [4, (defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication(requestContext))];
    ...
    return EmailApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.EmailApiRequestFactory = EmailApiRequestFactory;
var EmailApiResponseProcessor = (function () {
    function EmailApiResponseProcessor() {
    }
    EmailApiResponseProcessor.prototype.createEmailUsingPOST1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    EmailApiResponseProcessor.prototype.createEmailsUsingPOST1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
    ...
    EmailApiResponseProcessor.prototype.deleteEmailUsingDELETE1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
    ...
    EmailApiResponseProcessor.prototype.deleteEmailsUsingPOST1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
    ...
    EmailApiResponseProcessor.prototype.getEmailUsingGET1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    EmailApiResponseProcessor.prototype.sendEmailUsingPOST1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return EmailApiResponseProcessor;
}());
exports.EmailApiResponseProcessor = EmailApiResponseProcessor;
