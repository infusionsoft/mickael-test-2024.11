...
exports.FunnelIntegrationApiResponseProcessor = exports.FunnelIntegrationApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var FunnelIntegrationApiRequestFactory = (function (_super) {
    __extends(FunnelIntegrationApiRequestFactory, _super);
    function FunnelIntegrationApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    FunnelIntegrationApiRequestFactory.prototype.createFunnelIntegrationUsingPOST = function (createFunnelIntegrationRequest, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (createFunnelIntegrationRequest === null || createFunnelIntegrationRequest === undefined) {
                            throw new baseapi_1.RequiredError("FunnelIntegrationApi", "createFunnelIntegrationUsingPOST", "createFunnelIntegrationRequest");
                        }
    ...
    FunnelIntegrationApiRequestFactory.prototype.createIntegrationTriggerEventUsingPOST = function (createFunnelIntegrationTriggerEvents, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (createFunnelIntegrationTriggerEvents === null || createFunnelIntegrationTriggerEvents === undefined) {
                            throw new baseapi_1.RequiredError("FunnelIntegrationApi", "createIntegrationTriggerEventUsingPOST", "createFunnelIntegrationTriggerEvents");
                        }
    ...
    FunnelIntegrationApiRequestFactory.prototype.deleteFunnelIntegrationUsingPOST = function (deleteFunnelIntegrationRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (deleteFunnelIntegrationRequest === null || deleteFunnelIntegrationRequest === undefined) {
                            throw new baseapi_1.RequiredError("FunnelIntegrationApi", "deleteFunnelIntegrationUsingPOST", "deleteFunnelIntegrationRequest");
                        }
    ...
    return FunnelIntegrationApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.FunnelIntegrationApiRequestFactory = FunnelIntegrationApiRequestFactory;
var FunnelIntegrationApiResponseProcessor = (function () {
    function FunnelIntegrationApiResponseProcessor() {
    }
    FunnelIntegrationApiResponseProcessor.prototype.createFunnelIntegrationUsingPOSTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    FunnelIntegrationApiResponseProcessor.prototype.createIntegrationTriggerEventUsingPOSTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    FunnelIntegrationApiResponseProcessor.prototype.deleteFunnelIntegrationUsingPOSTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, _o, _p;
            return __generator(this, function (_q) {
                switch (_q.label) {
    ...
    return FunnelIntegrationApiResponseProcessor;
}());
exports.FunnelIntegrationApiResponseProcessor = FunnelIntegrationApiResponseProcessor;
//# sourceMappingURL=FunnelIntegrationApi.js.map