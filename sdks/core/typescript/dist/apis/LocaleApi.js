...
exports.LocaleApiResponseProcessor = exports.LocaleApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var LocaleApiRequestFactory = (function (_super) {
    __extends(LocaleApiRequestFactory, _super);
    function LocaleApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    LocaleApiRequestFactory.prototype.listCountriesUsingGET2 = function (_options) {
        var _a, _b, _c;
    ...
    LocaleApiRequestFactory.prototype.listProvincesForCountryUsingGET = function (countryCode, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (countryCode === null || countryCode === undefined) {
                            throw new baseapi_1.RequiredError("LocaleApi", "listProvincesForCountryUsingGET", "countryCode");
                        }
    ...
    return LocaleApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.LocaleApiRequestFactory = LocaleApiRequestFactory;
var LocaleApiResponseProcessor = (function () {
    function LocaleApiResponseProcessor() {
    }
    LocaleApiResponseProcessor.prototype.listCountriesUsingGET2WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    LocaleApiResponseProcessor.prototype.listProvincesForCountryUsingGETWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    return LocaleApiResponseProcessor;
}());
exports.LocaleApiResponseProcessor = LocaleApiResponseProcessor;
