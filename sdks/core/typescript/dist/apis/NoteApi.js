...
exports.NoteApiResponseProcessor = exports.NoteApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var NoteApiRequestFactory = (function (_super) {
    __extends(NoteApiRequestFactory, _super);
    function NoteApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    NoteApiRequestFactory.prototype.createNoteCustomFieldUsingPOST1 = function (customField, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (customField === null || customField === undefined) {
                            throw new baseapi_1.RequiredError("NoteApi", "createNoteCustomFieldUsingPOST1", "customField");
                        }
    ...
    NoteApiRequestFactory.prototype.createNoteUsingPOST1 = function (contactId, request, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (contactId === null || contactId === undefined) {
                            throw new baseapi_1.RequiredError("NoteApi", "createNoteUsingPOST1", "contactId");
                        }
                        if (request === null || request === undefined) {
                            throw new baseapi_1.RequiredError("NoteApi", "createNoteUsingPOST1", "request");
                        }
                        localVarPath = '/v2/contacts/{contact_id}/notes'
                        ...
                        requestContext.setHeaderParam("Content-Type", contentType);
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(request, "CreateNoteRequest", ""), contentType);
                        requestContext.setBody(serializedBody);
                        defaultAuth = ((_a = _options === null || _options === void 0 ? void 0 : _options.authMethods) === null || _a === void 0 ? void 0 : _a.default) || ((_c = (_b = this.configuration) === null || _b === void 0 ? void 0 : _b.authMethods) === null || _c === void 0 ? void 0 : _c.default);
                        if (!(defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication)) return [3, 2];
                        return [4, (defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication(requestContext))];
    ...
    NoteApiRequestFactory.prototype.deleteNoteUsingDELETE1 = function (contactId, noteId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (contactId === null || contactId === undefined) {
                            throw new baseapi_1.RequiredError("NoteApi", "deleteNoteUsingDELETE1", "contactId");
                        }
                        if (noteId === null || noteId === undefined) {
                            throw new baseapi_1.RequiredError("NoteApi", "deleteNoteUsingDELETE1", "noteId");
                        }
                        localVarPath = '/v2/contacts/{contact_id}/notes/{note_id}'
                            .replace('{' + 'contact_id' + '}', encodeURIComponent(String(contactId)))
    ...
    NoteApiRequestFactory.prototype.getNoteUsingGET1 = function (contactId, noteId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (contactId === null || contactId === undefined) {
                            throw new baseapi_1.RequiredError("NoteApi", "getNoteUsingGET1", "contactId");
                        }
                        if (noteId === null || noteId === undefined) {
                            throw new baseapi_1.RequiredError("NoteApi", "getNoteUsingGET1", "noteId");
                        }
                        localVarPath = '/v2/contacts/{contact_id}/notes/{note_id}'
                            .replace('{' + 'contact_id' + '}', encodeURIComponent(String(contactId)))
                            .replace('{' + 'note_id' + '}', encodeURIComponent(String(noteId)));
    ...
    NoteApiRequestFactory.prototype.listNotesUsingGET1 = function (contactId, filter, orderBy, pageSize, pageToken, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (contactId === null || contactId === undefined) {
                            throw new baseapi_1.RequiredError("NoteApi", "listNotesUsingGET1", "contactId");
                        }
                        localVarPath = '/v2/contacts/{contact_id}/notes'
                            .replace('{' + 'contact_id' + '}', encodeURIComponent(String(contactId)));
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
    ...
    NoteApiRequestFactory.prototype.retrieveNoteModelUsingGET1 = function (_options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
    ...
    NoteApiRequestFactory.prototype.updateNoteUsingPATCH = function (contactId, noteId, updateNoteRequest, updateMask, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (contactId === null || contactId === undefined) {
                            throw new baseapi_1.RequiredError("NoteApi", "updateNoteUsingPATCH", "contactId");
                        }
                        if (noteId === null || noteId === undefined) {
                            throw new baseapi_1.RequiredError("NoteApi", "updateNoteUsingPATCH", "noteId");
                        }
                        if (updateNoteRequest === null || updateNoteRequest === undefined) {
                            throw new baseapi_1.RequiredError("NoteApi", "updateNoteUsingPATCH", "updateNoteRequest");
                        }
                        localVarPath = '/v2/contacts/{contact_id}/notes/{note_id}'
                            .replace('{' + 'contact_id' + '}', encodeURIComponent(String(contactId)))
                            .replace('{' + 'note_id' + '}', encodeURIComponent(String(noteId)));
                        ...
                        requestContext.setHeaderParam("Content-Type", contentType);
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(updateNoteRequest, "UpdateNoteRequest", ""), contentType);
                        requestContext.setBody(serializedBody);
                        defaultAuth = ((_a = _options === null || _options === void 0 ? void 0 : _options.authMethods) === null || _a === void 0 ? void 0 : _a.default) || ((_c = (_b = this.configuration) === null || _b === void 0 ? void 0 : _b.authMethods) === null || _c === void 0 ? void 0 : _c.default);
                        if (!(defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication)) return [3, 2];
                        return [4, (defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication(requestContext))];
    ...
    NoteApiRequestFactory.prototype.updateNotesCustomFieldUsingPATCH = function (customFieldId, request, updateMask, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (customFieldId === null || customFieldId === undefined) {
                            throw new baseapi_1.RequiredError("NoteApi", "updateNotesCustomFieldUsingPATCH", "customFieldId");
                        }
                        if (request === null || request === undefined) {
                            throw new baseapi_1.RequiredError("NoteApi", "updateNotesCustomFieldUsingPATCH", "request");
                        }
    ...
    return NoteApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.NoteApiRequestFactory = NoteApiRequestFactory;
var NoteApiResponseProcessor = (function () {
    function NoteApiResponseProcessor() {
    }
    NoteApiResponseProcessor.prototype.createNoteCustomFieldUsingPOST1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    NoteApiResponseProcessor.prototype.createNoteUsingPOST1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
    ...
    NoteApiResponseProcessor.prototype.deleteNoteUsingDELETE1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
    ...
    NoteApiResponseProcessor.prototype.getNoteUsingGET1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    NoteApiResponseProcessor.prototype.listNotesUsingGET1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    NoteApiResponseProcessor.prototype.retrieveNoteModelUsingGET1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    NoteApiResponseProcessor.prototype.updateNoteUsingPATCHWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    NoteApiResponseProcessor.prototype.updateNotesCustomFieldUsingPATCHWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    return NoteApiResponseProcessor;
}());
exports.NoteApiResponseProcessor = NoteApiResponseProcessor;
