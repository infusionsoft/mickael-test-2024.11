...
exports.OpportunityApiResponseProcessor = exports.OpportunityApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var OpportunityApiRequestFactory = (function (_super) {
    __extends(OpportunityApiRequestFactory, _super);
    function OpportunityApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    OpportunityApiRequestFactory.prototype.createOpportunityCustomFieldsUsingPOST = function (customField, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (customField === null || customField === undefined) {
                            throw new baseapi_1.RequiredError("OpportunityApi", "createOpportunityCustomFieldsUsingPOST", "customField");
                        }
    ...
    OpportunityApiRequestFactory.prototype.createOpportunityStageUsingPOST = function (opportunityStage, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, defaultAuth;
            return __generator(this, function (_d) {
    ...
    OpportunityApiRequestFactory.prototype.createOpportunityUsingPOST1 = function (opportunity, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, defaultAuth;
            return __generator(this, function (_d) {
    ...
    OpportunityApiRequestFactory.prototype.deleteOpportunityStageUsingDELETE = function (stageId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (stageId === null || stageId === undefined) {
                            throw new baseapi_1.RequiredError("OpportunityApi", "deleteOpportunityStageUsingDELETE", "stageId");
                        }
    ...
    OpportunityApiRequestFactory.prototype.deleteOpportunityUsingDELETE = function (opportunityId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (opportunityId === null || opportunityId === undefined) {
                            throw new baseapi_1.RequiredError("OpportunityApi", "deleteOpportunityUsingDELETE", "opportunityId");
                        }
    ...
    OpportunityApiRequestFactory.prototype.getOpportunityStageUsingGET = function (stageId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (stageId === null || stageId === undefined) {
                            throw new baseapi_1.RequiredError("OpportunityApi", "getOpportunityStageUsingGET", "stageId");
                        }
                        localVarPath = '/v2/opportunities/stages/{stage_id}'
                            .replace('{' + 'stage_id' + '}', encodeURIComponent(String(stageId)));
    ...
    OpportunityApiRequestFactory.prototype.getOpportunityUsingGET1 = function (opportunityId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (opportunityId === null || opportunityId === undefined) {
                            throw new baseapi_1.RequiredError("OpportunityApi", "getOpportunityUsingGET1", "opportunityId");
                        }
                        localVarPath = '/v2/opportunities/{opportunity_id}'
                            .replace('{' + 'opportunity_id' + '}', encodeURIComponent(String(opportunityId)));
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
    ...
    OpportunityApiRequestFactory.prototype.listOpportunitiesUsingGET1 = function (fields, filter, orderBy, pageSize, pageToken, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpportunityApiRequestFactory.prototype.listOpportunityStagesUsingGET = function (filter, orderBy, pageSize, pageToken, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
    ...
    OpportunityApiRequestFactory.prototype.updateOpportunityCustomFieldUsingPATCH = function (customFieldId, request, updateMask, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (customFieldId === null || customFieldId === undefined) {
                            throw new baseapi_1.RequiredError("OpportunityApi", "updateOpportunityCustomFieldUsingPATCH", "customFieldId");
                        }
                        if (request === null || request === undefined) {
                            throw new baseapi_1.RequiredError("OpportunityApi", "updateOpportunityCustomFieldUsingPATCH", "request");
                        }
    ...
    OpportunityApiRequestFactory.prototype.updateOpportunityUsingPATCH = function (opportunityId, request, updateMask, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (opportunityId === null || opportunityId === undefined) {
                            throw new baseapi_1.RequiredError("OpportunityApi", "updateOpportunityUsingPATCH", "opportunityId");
                        }
                        if (request === null || request === undefined) {
                            throw new baseapi_1.RequiredError("OpportunityApi", "updateOpportunityUsingPATCH", "request");
                        }
                        localVarPath = '/v2/opportunities/{opportunity_id}'
                            .replace('{' + 'opportunity_id' + '}', encodeURIComponent(String(opportunityId)));
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.PATCH);
    ...
    return OpportunityApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.OpportunityApiRequestFactory = OpportunityApiRequestFactory;
var OpportunityApiResponseProcessor = (function () {
    function OpportunityApiResponseProcessor() {
    }
    OpportunityApiResponseProcessor.prototype.createOpportunityCustomFieldsUsingPOSTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpportunityApiResponseProcessor.prototype.createOpportunityStageUsingPOSTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
    ...
    OpportunityApiResponseProcessor.prototype.createOpportunityUsingPOST1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
    ...
    OpportunityApiResponseProcessor.prototype.deleteOpportunityStageUsingDELETEWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
    ...
    OpportunityApiResponseProcessor.prototype.deleteOpportunityUsingDELETEWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
    ...
    OpportunityApiResponseProcessor.prototype.getOpportunityStageUsingGETWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpportunityApiResponseProcessor.prototype.getOpportunityUsingGET1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    OpportunityApiResponseProcessor.prototype.listOpportunitiesUsingGET1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    OpportunityApiResponseProcessor.prototype.listOpportunityStagesUsingGETWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    OpportunityApiResponseProcessor.prototype.updateOpportunityCustomFieldUsingPATCHWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    OpportunityApiResponseProcessor.prototype.updateOpportunityUsingPATCHWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    return OpportunityApiResponseProcessor;
}());
exports.OpportunityApiResponseProcessor = OpportunityApiResponseProcessor;
