...
var PreReleaseApiRequestFactory = (function (_super) {
    ...
    PreReleaseApiRequestFactory.prototype.getCategoryDiscountUsingGET = function (discountId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (discountId === null || discountId === undefined) {
                            throw new baseapi_1.RequiredError("PreReleaseApi", "getCategoryDiscountUsingGET", "discountId");
                        }
...
var PreReleaseApiResponseProcessor = (function () {
    ...
    PreReleaseApiResponseProcessor.prototype.getCategoryDiscountUsingGETWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
