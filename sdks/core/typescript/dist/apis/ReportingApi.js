...
exports.ReportingApiResponseProcessor = exports.ReportingApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var ReportingApiRequestFactory = (function (_super) {
    __extends(ReportingApiRequestFactory, _super);
    function ReportingApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ReportingApiRequestFactory.prototype.runReportUsingPOST = function (reportId, fields, orderBy, pageSize, pageToken, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (reportId === null || reportId === undefined) {
                            throw new baseapi_1.RequiredError("ReportingApi", "runReportUsingPOST", "reportId");
                        }
                        localVarPath = '/v2/reporting/reports/{report_id}:run'
    ...
    return ReportingApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.ReportingApiRequestFactory = ReportingApiRequestFactory;
var ReportingApiResponseProcessor = (function () {
    function ReportingApiResponseProcessor() {
    }
    ReportingApiResponseProcessor.prototype.runReportUsingPOSTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return ReportingApiResponseProcessor;
}());
exports.ReportingApiResponseProcessor = ReportingApiResponseProcessor;
