...
exports.SalesApiResponseProcessor = exports.SalesApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var SalesApiRequestFactory = (function (_super) {
    __extends(SalesApiRequestFactory, _super);
    function SalesApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SalesApiRequestFactory.prototype.setMerchantGatewayAsDefaultUsingPOST = function (id, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (id === null || id === undefined) {
                            throw new baseapi_1.RequiredError("SalesApi", "setMerchantGatewayAsDefaultUsingPOST", "id");
                        }
                        localVarPath = '/v2/sales/merchants/{id}:setDefault'
    ...
    return SalesApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.SalesApiRequestFactory = SalesApiRequestFactory;
var SalesApiResponseProcessor = (function () {
    function SalesApiResponseProcessor() {
    }
    SalesApiResponseProcessor.prototype.setMerchantGatewayAsDefaultUsingPOSTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return SalesApiResponseProcessor;
}());
exports.SalesApiResponseProcessor = SalesApiResponseProcessor;
