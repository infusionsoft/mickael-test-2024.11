...
var SubscriptionsApiRequestFactory = (function (_super) {
    __extends(SubscriptionsApiRequestFactory, _super);
    function SubscriptionsApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SubscriptionsApiRequestFactory.prototype.cancelSubscriptionUsingPOST = function (subscriptionId, cancelSubscriptionsRequest, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (subscriptionId === null || subscriptionId === undefined) {
                            throw new baseapi_1.RequiredError("SubscriptionsApi", "cancelSubscriptionUsingPOST", "subscriptionId");
                        }
                        if (cancelSubscriptionsRequest === null || cancelSubscriptionsRequest === undefined) {
                            throw new baseapi_1.RequiredError("SubscriptionsApi", "cancelSubscriptionUsingPOST", "cancelSubscriptionsRequest");
                        }
    ...
    SubscriptionsApiRequestFactory.prototype.createSubscriptionCustomFieldUsingPOST = function (customField, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (customField === null || customField === undefined) {
                            throw new baseapi_1.RequiredError("SubscriptionsApi", "createSubscriptionCustomFieldUsingPOST", "customField");
                        }
    ...
    SubscriptionsApiRequestFactory.prototype.createSubscriptionV2UsingPOST = function (createSubscriptionV2, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (createSubscriptionV2 === null || createSubscriptionV2 === undefined) {
                            throw new baseapi_1.RequiredError("SubscriptionsApi", "createSubscriptionV2UsingPOST", "createSubscriptionV2");
                        }
                        ...
                        requestContext.setHeaderParam("Content-Type", contentType);
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(createSubscriptionV2, "CreateSubscriptionV2", ""), contentType);
                        requestContext.setBody(serializedBody);
                        defaultAuth = ((_a = _options === null || _options === void 0 ? void 0 : _options.authMethods) === null || _a === void 0 ? void 0 : _a.default) || ((_c = (_b = this.configuration) === null || _b === void 0 ? void 0 : _b.authMethods) === null || _c === void 0 ? void 0 : _c.default);
                        if (!(defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication)) return [3, 2];
                        return [4, (defaultAuth === null || defaultAuth === void 0 ? void 0 : defaultAuth.applySecurityAuthentication(requestContext))];
    ...
    SubscriptionsApiRequestFactory.prototype.retrieveSubscriptionCustomFieldModelUsingGET = function (_options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    SubscriptionsApiRequestFactory.prototype.updateSubscriptionCustomFieldUsingPATCH = function (customFieldId, request, updateMask, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (customFieldId === null || customFieldId === undefined) {
                            throw new baseapi_1.RequiredError("SubscriptionsApi", "updateSubscriptionCustomFieldUsingPATCH", "customFieldId");
                        }
                        if (request === null || request === undefined) {
                            throw new baseapi_1.RequiredError("SubscriptionsApi", "updateSubscriptionCustomFieldUsingPATCH", "request");
                        }
    ...
    return SubscriptionsApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.SubscriptionsApiRequestFactory = SubscriptionsApiRequestFactory;
var SubscriptionsApiResponseProcessor = (function () {
    function SubscriptionsApiResponseProcessor() {
    }
    SubscriptionsApiResponseProcessor.prototype.cancelSubscriptionUsingPOSTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SubscriptionsApiResponseProcessor.prototype.createSubscriptionCustomFieldUsingPOSTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SubscriptionsApiResponseProcessor.prototype.createSubscriptionV2UsingPOSTWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
    ...
    SubscriptionsApiResponseProcessor.prototype.retrieveSubscriptionCustomFieldModelUsingGETWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SubscriptionsApiResponseProcessor.prototype.updateSubscriptionCustomFieldUsingPATCHWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    return SubscriptionsApiResponseProcessor;
}());
