...
var UsersApiRequestFactory = (function (_super) {
    ...
    UsersApiRequestFactory.prototype.createUserUsingPOST1 = function (user, _options) {
        var _a, _b, _c;
    ...
    UsersApiRequestFactory.prototype.getUserByIdUsingGET = function (userId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (userId === null || userId === undefined) {
                            throw new baseapi_1.RequiredError("UsersApi", "getUserByIdUsingGET", "userId");
                        }
    ...
    UsersApiRequestFactory.prototype.getUserInfoUsingGET1 = function (_options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
    ...
    UsersApiRequestFactory.prototype.getUserSignatureUsingGET1 = function (userId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (userId === null || userId === undefined) {
                            throw new baseapi_1.RequiredError("UsersApi", "getUserSignatureUsingGET1", "userId");
                        }
    ...
    UsersApiRequestFactory.prototype.listUsersUsingGET1 = function (filter, orderBy, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
    ...
    UsersApiRequestFactory.prototype.patchUserUsingPATCH = function (userId, updateMask, user, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (userId === null || userId === undefined) {
                            throw new baseapi_1.RequiredError("UsersApi", "patchUserUsingPATCH", "userId");
                        }
                        localVarPath = '/v2/users/{user_id}'
                            .replace('{' + 'user_id' + '}', encodeURIComponent(String(userId)));
...
var UsersApiResponseProcessor = (function () {
    ...
    UsersApiResponseProcessor.prototype.createUserUsingPOST1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    UsersApiResponseProcessor.prototype.getUserByIdUsingGETWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    UsersApiResponseProcessor.prototype.getUserInfoUsingGET1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    UsersApiResponseProcessor.prototype.getUserSignatureUsingGET1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    UsersApiResponseProcessor.prototype.listUsersUsingGET1WithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    UsersApiResponseProcessor.prototype.patchUserUsingPATCHWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
