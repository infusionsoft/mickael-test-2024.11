...
var ObjectDiscountApi = (function () {
    function ObjectDiscountApi(configuration, requestFactory, responseProcessor) {
        this.api = new ObservableAPI_8.ObservableDiscountApi(configuration, requestFactory, responseProcessor);
    }
    ObjectDiscountApi.prototype.getCategoryDiscountUsingGETWithHttpInfo = function (param, options) {
        return this.api.getCategoryDiscountUsingGETWithHttpInfo(param.discountId, options).toPromise();
    };
    ObjectDiscountApi.prototype.getCategoryDiscountUsingGET = function (param, options) {
        return this.api.getCategoryDiscountUsingGET(param.discountId, options).toPromise();
    };
    return ObjectDiscountApi;
}());
exports.ObjectDiscountApi = ObjectDiscountApi;
...
var ObjectPreReleaseApi = (function () {
    ...
    ObjectPreReleaseApi.prototype.getCategoryDiscountUsingGETWithHttpInfo = function (param, options) {
        return this.api.getCategoryDiscountUsingGETWithHttpInfo(param.discountId, options).toPromise();
    };
    ObjectPreReleaseApi.prototype.getCategoryDiscountUsingGET = function (param, options) {
        return this.api.getCategoryDiscountUsingGET(param.discountId, options).toPromise();
    };
...
var ObjectSubscriptionPlansApi = (function () {
    ...
    ObjectSubscriptionPlansApi.prototype.createSubscriptionV2UsingPOSTWithHttpInfo = function (param, options) {
        return this.api.createSubscriptionV2UsingPOSTWithHttpInfo(param.createSubscriptionV2, options).toPromise();
    };
    ObjectSubscriptionPlansApi.prototype.createSubscriptionV2UsingPOST = function (param, options) {
