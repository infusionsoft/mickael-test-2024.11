...
export declare class ObservableDiscountApi {
    private requestFactory;
    private responseProcessor;
    private configuration;
    ...
    getCategoryDiscountUsingGETWithHttpInfo(discountId: string, _options?: Configuration): Observable<HttpInfo<CategoryDiscount>>;
    getCategoryDiscountUsingGET(discountId: string, _options?: Configuration): Observable<CategoryDiscount>;
}
