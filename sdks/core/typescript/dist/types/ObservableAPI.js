...
var DiscountApi_1 = require("../apis/DiscountApi");
var ObservableDiscountApi = (function () {
    function ObservableDiscountApi(configuration, requestFactory, responseProcessor) {
        this.configuration = configuration;
        this.requestFactory = requestFactory || new DiscountApi_1.DiscountApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new DiscountApi_1.DiscountApiResponseProcessor();
    }
    ObservableDiscountApi.prototype.getCategoryDiscountUsingGETWithHttpInfo = function (discountId, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getCategoryDiscountUsingGET(discountId, _options);
        var middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)(function (rsp) { return _this.responseProcessor.getCategoryDiscountUsingGETWithHttpInfo(rsp); }));
        }));
    };
    ObservableDiscountApi.prototype.getCategoryDiscountUsingGET = function (discountId, _options) {
        return this.getCategoryDiscountUsingGETWithHttpInfo(discountId, _options).pipe((0, rxjsStub_2.map)(function (apiResponse) { return apiResponse.data; }));
    };
    return ObservableDiscountApi;
}());
exports.ObservableDiscountApi = ObservableDiscountApi;
...
var ObservablePreReleaseApi = (function () {
    ...
    ObservablePreReleaseApi.prototype.getCategoryDiscountUsingGETWithHttpInfo = function (discountId, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getCategoryDiscountUsingGET(discountId, _options);
        var middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
    ...
    ObservablePreReleaseApi.prototype.getCategoryDiscountUsingGET = function (discountId, _options) {
        return this.getCategoryDiscountUsingGETWithHttpInfo(discountId, _options).pipe((0, rxjsStub_2.map)(function (apiResponse) { return apiResponse.data; }));
    };
...
var ObservableSubscriptionPlansApi = (function () {
    ...
    ObservableSubscriptionPlansApi.prototype.createSubscriptionV2UsingPOSTWithHttpInfo = function (createSubscriptionV2, _options) {
        var _this = this;
    ...
    ObservableSubscriptionPlansApi.prototype.createSubscriptionV2UsingPOST = function (createSubscriptionV2, _options) {
