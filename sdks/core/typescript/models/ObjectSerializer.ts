...
export * from '../models/CreateFileRequest';
...
export * from '../models/CreateUpdateDiscountRequest';
...
export * from '../models/UpdateFileRequest';
...
import { CreateFileRequest , CreateFileRequestFileAssociationEnum     } from '../models/CreateFileRequest';
...
import { CreatePatchContactRequest                     , CreatePatchContactRequestSourceTypeEnum        } from '../models/CreatePatchContactRequest';
import { CreatePatchTaskRequest      , CreatePatchTaskRequestPriorityEnum    , CreatePatchTaskRequestTypeEnum   } from '../models/CreatePatchTaskRequest';
...
import { CreateRestOrderItemRequest   , CreateRestOrderItemRequestProductTypeEnum    } from '../models/CreateRestOrderItemRequest';
...
import { OrderItemProduct          , OrderItemProductStatusEnum       } from '../models/OrderItemProduct';
...
import { PatchAffiliateRequest   , PatchAffiliateRequestStatusEnum   } from '../models/PatchAffiliateRequest';
...
let enumsMap: Set<string> = new Set<string>([
    ...
    "CreateFileRequestFileAssociationEnum",
...
let typeMap: {[index: string]: any} = {
    ...
    "ApplicationConfigurationModuleAffiliate": ApplicationConfigurationModuleAffiliate,
    "ApplicationConfigurationModuleAffiliateCommission": ApplicationConfigurationModuleAffiliateCommission,
    "ApplicationConfigurationModuleApplication": ApplicationConfigurationModuleApplication,
    "ApplicationConfigurationModuleAppointment": ApplicationConfigurationModuleAppointment,
    "ApplicationConfigurationModuleContact": ApplicationConfigurationModuleContact,
    "ApplicationConfigurationModuleContactAddressLabels": ApplicationConfigurationModuleContactAddressLabels,
    "ApplicationConfigurationModuleEcommerce": ApplicationConfigurationModuleEcommerce,
    "ApplicationConfigurationModuleEmail": ApplicationConfigurationModuleEmail,
    "ApplicationConfigurationModuleForms": ApplicationConfigurationModuleForms,
    "ApplicationConfigurationModuleFulfillment": ApplicationConfigurationModuleFulfillment,
    "ApplicationConfigurationModuleInvoice": ApplicationConfigurationModuleInvoice,
    "ApplicationConfigurationModuleNote": ApplicationConfigurationModuleNote,
    "ApplicationConfigurationModuleOpportunity": ApplicationConfigurationModuleOpportunity,
    "ApplicationConfigurationModuleOpportunityStates": ApplicationConfigurationModuleOpportunityStates,
    "ApplicationConfigurationModuleOpportunityStatesActive": ApplicationConfigurationModuleOpportunityStatesActive,
    "ApplicationConfigurationModuleOpportunityStatesLoss": ApplicationConfigurationModuleOpportunityStatesLoss,
    "ApplicationConfigurationModuleOpportunityStatesWin": ApplicationConfigurationModuleOpportunityStatesWin,
    ...
    "ContactUtmResponse": ContactUtmResponse,
    "Country": Country,
    ...
    "ListRestMerchantResponse": ListRestMerchantResponse,
    ...
    "RestPaymentGateway": RestPaymentGateway,
    ...
    "RestSubscriptionV2": RestSubscriptionV2,
    ...
    "UpdateOpportunityStageChecklistItem": UpdateOpportunityStageChecklistItem,
