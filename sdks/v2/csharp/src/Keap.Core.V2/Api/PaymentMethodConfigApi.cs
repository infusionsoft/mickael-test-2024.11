...
namespace Keap.Core.V2.Api
{
    ...
    /// </summary>
    public interface IPaymentMethodConfigApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IPaymentMethodConfigApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IPaymentMethodConfigApi : IPaymentMethodConfigApiSync, IPaymentMethodConfigApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PaymentMethodConfigApi : IPaymentMethodConfigApi
    {
        private Keap.Core.V2.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodConfigApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PaymentMethodConfigApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public PaymentMethodConfigApi(string basePath)
        {
        ...
        /// <returns></returns>
        public PaymentMethodConfigApi(Keap.Core.V2.Client.Configuration configuration)
        {
        ...
        public PaymentMethodConfigApi(Keap.Core.V2.Client.ISynchronousClient client, Keap.Core.V2.Client.IAsynchronousClient asyncClient, Keap.Core.V2.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Keap.Core.V2.Client.ApiResponse<PaymentMethodConfig> localVarResponse = CreatePaymentMethodConfigUsingPOSTWithHttpInfo(createPaymentMethodConfigRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentMethodConfig</returns>
        public Keap.Core.V2.Client.ApiResponse<PaymentMethodConfig> CreatePaymentMethodConfigUsingPOSTWithHttpInfo(CreatePaymentMethodConfigRequest createPaymentMethodConfigRequest, int operationIndex = 0)
        {
            // verify the required parameter 'createPaymentMethodConfigRequest' is set
            if (createPaymentMethodConfigRequest == null)
            {
                throw new Keap.Core.V2.Client.ApiException(400, "Missing required parameter 'createPaymentMethodConfigRequest' when calling PaymentMethodConfigApi->CreatePaymentMethodConfigUsingPOST");
            }
            ...
            var localVarResponse = this.Client.Post<PaymentMethodConfig>("/v2/paymentMethodConfigs", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CreatePaymentMethodConfigUsingPOST", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            Keap.Core.V2.Client.ApiResponse<PaymentMethodConfig> localVarResponse = await CreatePaymentMethodConfigUsingPOSTWithHttpInfoAsync(createPaymentMethodConfigRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PaymentMethodConfig)</returns>
        public async System.Threading.Tasks.Task<Keap.Core.V2.Client.ApiResponse<PaymentMethodConfig>> CreatePaymentMethodConfigUsingPOSTWithHttpInfoAsync(CreatePaymentMethodConfigRequest createPaymentMethodConfigRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'createPaymentMethodConfigRequest' is set
            if (createPaymentMethodConfigRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<PaymentMethodConfig>("/v2/paymentMethodConfigs", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
