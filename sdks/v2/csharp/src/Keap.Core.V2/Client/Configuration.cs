...
namespace Keap.Core.V2.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.0.146";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("core-service-v2-csharp/0.0.146");
        ...
        {
            string report = "C# SDK (Keap.Core.V2) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2.70.0.772488\n";
            report += "    SDK Package Version: 0.0.146\n";
