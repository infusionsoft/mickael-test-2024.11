...
namespace Keap.Core.V2.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.0.172";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("core-service-v2-csharp/0.0.172");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.70.0.778988\n";
            report += "    SDK Package Version: 0.0.172\n";
