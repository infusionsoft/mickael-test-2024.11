...
namespace Keap.Core.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AffiliateAddToProgramRequest")]
    public partial class AffiliateAddToProgramRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AffiliateAddToProgramRequest" /> class.
        /// </summary>
        /// <param name="affiliateProgramId">affiliateProgramId.</param>
        public AffiliateAddToProgramRequest(string affiliateProgramId = default(string))
        {
