...
namespace Keap.Core.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationConfigurationModuleAppointment")]
    public partial class ApplicationConfigurationModuleAppointment : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationConfigurationModuleAppointment" /> class.
        /// </summary>
        ...
        public ApplicationConfigurationModuleAppointment(string appointmentTypes = default(string), bool shareOpportunityWithRelatedUser = default(bool))
        {
