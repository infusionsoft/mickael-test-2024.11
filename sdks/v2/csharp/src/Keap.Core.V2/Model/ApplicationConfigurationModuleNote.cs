...
namespace Keap.Core.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationConfigurationModuleNote")]
    public partial class ApplicationConfigurationModuleNote : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationConfigurationModuleNote" /> class.
        /// </summary>
        ...
        public ApplicationConfigurationModuleNote(string appointmentTypes = default(string), bool shareOpportunityWithRelatedUser = default(bool))
        {
