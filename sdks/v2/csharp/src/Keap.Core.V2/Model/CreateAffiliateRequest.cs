...
namespace Keap.Core.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateAffiliateRequest")]
    public partial class CreateAffiliateRequest : IValidatableObject
    {
        /// <summary>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAffiliateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAffiliateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAffiliateRequest" /> class.
        /// </summary>
        ...
        public CreateAffiliateRequest(string code = default(string), string contactId = default(string), string name = default(string), StatusEnum status = default(StatusEnum))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for CreateAffiliateRequest and cannot be null");
            }
            this.Code = code;
            // to ensure "contactId" is required (not null)
            if (contactId == null)
            {
                throw new ArgumentNullException("contactId is a required property for CreateAffiliateRequest and cannot be null");
            }
