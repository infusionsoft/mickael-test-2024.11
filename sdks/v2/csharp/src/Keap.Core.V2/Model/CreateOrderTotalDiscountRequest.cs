...
namespace Keap.Core.V2.Model
{
    ...
    public partial class CreateOrderTotalDiscountRequest : IValidatableObject
    {
        ...
        public CreateOrderTotalDiscountRequest(bool applyToCommissions = default(bool), List<DiscountCriteria> criteria = default(List<DiscountCriteria>), string description = default(string), DiscountStrategyEnum? discountStrategy = default(DiscountStrategyEnum?), DiscountTypeEnum discountType = default(DiscountTypeEnum), double discountValue = default(double), string name = default(string))
        {
