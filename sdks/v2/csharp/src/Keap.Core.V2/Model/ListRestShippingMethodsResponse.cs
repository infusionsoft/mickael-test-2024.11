...
namespace Keap.Core.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListRestShippingMethodsResponse")]
    public partial class ListRestShippingMethodsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListRestShippingMethodsResponse" /> class.
        /// </summary>
        /// <param name="nextPageToken">nextPageToken.</param>
        /// <param name="shippingMethods">shippingMethods.</param>
        public ListRestShippingMethodsResponse(string nextPageToken = default(string), List<ShippingMethod> shippingMethods = default(List<ShippingMethod>))
        {
