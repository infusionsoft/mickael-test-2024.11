...
namespace Keap.Core.V2.Model
{
    ...
    public partial class PaymentMethodList : IValidatableObject
    {
        /// <summary>
        ...
        public PaymentMethodList(string nextPageToken = default(string), List<RestPaymentMethod> records = default(List<RestPaymentMethod>))
        {
        ...
        public List<RestPaymentMethod> Records { get; set; }
