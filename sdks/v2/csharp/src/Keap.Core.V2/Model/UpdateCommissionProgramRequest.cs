...
namespace Keap.Core.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateCommissionProgramRequest")]
    public partial class UpdateCommissionProgramRequest : IValidatableObject
    {
        /// <summary>
        ...
        public UpdateCommissionProgramRequest(string name = default(string), string notes = default(string), int priority = default(int))
        {
