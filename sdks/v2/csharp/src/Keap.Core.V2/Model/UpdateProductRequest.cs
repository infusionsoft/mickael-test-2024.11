...
namespace Keap.Core.V2.Model
{
    ...
    public partial class UpdateProductRequest : IValidatableObject
    {
        ...
        public UpdateProductRequest(bool active = default(bool), bool cityTaxable = default(bool), bool countryTaxable = default(bool), string description = default(string), string name = default(string), long price = default(long), string shortDescription = default(string), string sku = default(string), bool stateTaxable = default(bool), bool storefrontHidden = default(bool), bool subscriptionOnly = default(bool), bool taxable = default(bool), double weight = default(double))
        {
            this.Active = active;
