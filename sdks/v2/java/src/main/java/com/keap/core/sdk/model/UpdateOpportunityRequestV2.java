 ...
 */
@JsonPropertyOrder({
  UpdateOpportunityRequestV2.JSON_PROPERTY_AFFILIATE_ID,
  UpdateOpportunityRequestV2.JSON_PROPERTY_CONTACT_ID,
  UpdateOpportunityRequestV2.JSON_PROPERTY_CUSTOM_FIELDS,
  UpdateOpportunityRequestV2.JSON_PROPERTY_ESTIMATED_CLOSE_TIME,
  UpdateOpportunityRequestV2.JSON_PROPERTY_INCLUDE_IN_FORECAST,
  UpdateOpportunityRequestV2.JSON_PROPERTY_NEXT_ACTION_NOTES,
  UpdateOpportunityRequestV2.JSON_PROPERTY_NEXT_ACTION_TIME,
  UpdateOpportunityRequestV2.JSON_PROPERTY_OPPORTUNITY_NOTES,
  UpdateOpportunityRequestV2.JSON_PROPERTY_OPPORTUNITY_TITLE,
  UpdateOpportunityRequestV2.JSON_PROPERTY_PROJECTED_REVENUE_HIGH,
  UpdateOpportunityRequestV2.JSON_PROPERTY_PROJECTED_REVENUE_LOW,
  UpdateOpportunityRequestV2.JSON_PROPERTY_STAGE_ID,
  UpdateOpportunityRequestV2.JSON_PROPERTY_USER_ID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class UpdateOpportunityRequestV2 implements Serializable {
  ...
  public UpdateOpportunityRequestV2() { 
  }

  public UpdateOpportunityRequestV2 affiliateId(@jakarta.annotation.Nullable String affiliateId) {
  ...
  public UpdateOpportunityRequestV2 contactId(@jakarta.annotation.Nullable String contactId) {
  ...
  public UpdateOpportunityRequestV2 customFields(@jakarta.annotation.Nullable List<@Valid CustomField> customFields) {
    this.customFields = customFields;
    return this;
  }

  public UpdateOpportunityRequestV2 addCustomFieldsItem(CustomField customFieldsItem) {
  ...
  public UpdateOpportunityRequestV2 estimatedCloseTime(@jakarta.annotation.Nullable String estimatedCloseTime) {
  ...
  public UpdateOpportunityRequestV2 includeInForecast(@jakarta.annotation.Nullable Boolean includeInForecast) {
  ...
  public UpdateOpportunityRequestV2 nextActionNotes(@jakarta.annotation.Nullable String nextActionNotes) {
  ...
  public UpdateOpportunityRequestV2 nextActionTime(@jakarta.annotation.Nullable String nextActionTime) {
  ...
  public UpdateOpportunityRequestV2 opportunityNotes(@jakarta.annotation.Nullable String opportunityNotes) {
  ...
  public UpdateOpportunityRequestV2 opportunityTitle(@jakarta.annotation.Nullable String opportunityTitle) {
  ...
  public UpdateOpportunityRequestV2 projectedRevenueHigh(@jakarta.annotation.Nullable Double projectedRevenueHigh) {
  ...
  public UpdateOpportunityRequestV2 projectedRevenueLow(@jakarta.annotation.Nullable Double projectedRevenueLow) {
  ...
  public UpdateOpportunityRequestV2 stageId(@jakarta.annotation.Nullable String stageId) {
  ...
  public UpdateOpportunityRequestV2 userId(@jakarta.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  /**
   * Return true if this UpdateOpportunityRequestV2 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateOpportunityRequestV2 updateOpportunityRequestV2 = (UpdateOpportunityRequestV2) o;
    return Objects.equals(this.affiliateId, updateOpportunityRequestV2.affiliateId) &&
        Objects.equals(this.contactId, updateOpportunityRequestV2.contactId) &&
        Objects.equals(this.customFields, updateOpportunityRequestV2.customFields) &&
        Objects.equals(this.estimatedCloseTime, updateOpportunityRequestV2.estimatedCloseTime) &&
        Objects.equals(this.includeInForecast, updateOpportunityRequestV2.includeInForecast) &&
        Objects.equals(this.nextActionNotes, updateOpportunityRequestV2.nextActionNotes) &&
        Objects.equals(this.nextActionTime, updateOpportunityRequestV2.nextActionTime) &&
        Objects.equals(this.opportunityNotes, updateOpportunityRequestV2.opportunityNotes) &&
        Objects.equals(this.opportunityTitle, updateOpportunityRequestV2.opportunityTitle) &&
        Objects.equals(this.projectedRevenueHigh, updateOpportunityRequestV2.projectedRevenueHigh) &&
        Objects.equals(this.projectedRevenueLow, updateOpportunityRequestV2.projectedRevenueLow) &&
        Objects.equals(this.stageId, updateOpportunityRequestV2.stageId) &&
        Objects.equals(this.userId, updateOpportunityRequestV2.userId);
  }
  ...
  private String toIndentedString(Object o) {
    ...
    public static class Builder {
        ...
        private UpdateOpportunityRequestV2 instance;
    
        public Builder() {
          this(new UpdateOpportunityRequestV2());
        }
    
        protected Builder(UpdateOpportunityRequestV2 instance) {
          this.instance = instance;
        }
    
        public UpdateOpportunityRequestV2.Builder affiliateId(String affiliateId) {
              this.instance.affiliateId = affiliateId;
          return this;
        }
            public UpdateOpportunityRequestV2.Builder contactId(String contactId) {
              this.instance.contactId = contactId;
          return this;
        }
            public UpdateOpportunityRequestV2.Builder customFields(List<@Valid CustomField> customFields) {
              this.instance.customFields = customFields;
          return this;
        }
            public UpdateOpportunityRequestV2.Builder estimatedCloseTime(String estimatedCloseTime) {
              this.instance.estimatedCloseTime = estimatedCloseTime;
          return this;
        }
            public UpdateOpportunityRequestV2.Builder includeInForecast(Boolean includeInForecast) {
              this.instance.includeInForecast = includeInForecast;
          return this;
        }
            public UpdateOpportunityRequestV2.Builder nextActionNotes(String nextActionNotes) {
              this.instance.nextActionNotes = nextActionNotes;
          return this;
        }
            public UpdateOpportunityRequestV2.Builder nextActionTime(String nextActionTime) {
              this.instance.nextActionTime = nextActionTime;
          return this;
        }
            public UpdateOpportunityRequestV2.Builder opportunityNotes(String opportunityNotes) {
              this.instance.opportunityNotes = opportunityNotes;
          return this;
        }
            public UpdateOpportunityRequestV2.Builder opportunityTitle(String opportunityTitle) {
              this.instance.opportunityTitle = opportunityTitle;
          return this;
        }
            public UpdateOpportunityRequestV2.Builder projectedRevenueHigh(Double projectedRevenueHigh) {
              this.instance.projectedRevenueHigh = projectedRevenueHigh;
          return this;
        }
            public UpdateOpportunityRequestV2.Builder projectedRevenueLow(Double projectedRevenueLow) {
              this.instance.projectedRevenueLow = projectedRevenueLow;
          return this;
        }
            public UpdateOpportunityRequestV2.Builder stageId(String stageId) {
              this.instance.stageId = stageId;
          return this;
        }
            public UpdateOpportunityRequestV2.Builder userId(String userId) {
        ...
        /**
        * returns a built UpdateOpportunityRequestV2 instance.
        *
        * The builder is not reusable.
        */
        public UpdateOpportunityRequestV2 build() {
          try {
      ...
      */
      public static UpdateOpportunityRequestV2.Builder builder() {
        return new UpdateOpportunityRequestV2.Builder();
      }
    
      /**
      * Create a builder with a shallow copy of this instance.
      */
      public UpdateOpportunityRequestV2.Builder toBuilder() {
        return new UpdateOpportunityRequestV2.Builder()
