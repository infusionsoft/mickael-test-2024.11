...
* @alias module:keap.core.v2/ApiClient
* @class
*/
class ApiClient {
    /**
    ...
    constructor(basePath = 'https://api.keap.com/crm/rest') {
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'core-service-v2-javascript/0.0.150'
        };
    ...
    * @param {module:keap.core.v2/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:keap.core.v2/ApiClient}
*/
