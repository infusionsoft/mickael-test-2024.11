 ...
 * @module keap.core.v2/model/ApplicationConfigurationModuleForms
 */
class ApplicationConfigurationModuleForms {
    /**
     * Constructs a new <code>ApplicationConfigurationModuleForms</code>.
     * @alias module:keap.core.v2/model/ApplicationConfigurationModuleForms
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/ApplicationConfigurationModuleForms} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/ApplicationConfigurationModuleForms} The populated <code>ApplicationConfigurationModuleForms</code> instance.
     */
