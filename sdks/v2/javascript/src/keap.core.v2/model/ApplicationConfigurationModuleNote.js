 ...
 * @module keap.core.v2/model/ApplicationConfigurationModuleNote
 */
class ApplicationConfigurationModuleNote {
    /**
     * Constructs a new <code>ApplicationConfigurationModuleNote</code>.
     * @alias module:keap.core.v2/model/ApplicationConfigurationModuleNote
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/ApplicationConfigurationModuleNote} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/ApplicationConfigurationModuleNote} The populated <code>ApplicationConfigurationModuleNote</code> instance.
     */
