 ...
 * @module keap.core.v2/model/BaseListResponseDeal
 */
class BaseListResponseDeal {
    /**
     * Constructs a new <code>BaseListResponseDeal</code>.
     * The list responses.
     * @alias module:keap.core.v2/model/BaseListResponseDeal
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/BaseListResponseDeal} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/BaseListResponseDeal} The populated <code>BaseListResponseDeal</code> instance.
     */
