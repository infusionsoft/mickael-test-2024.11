 ...
 * @module keap.core.v2/model/BaseListResponsePipeline
 */
class BaseListResponsePipeline {
    /**
     * Constructs a new <code>BaseListResponsePipeline</code>.
     * The list responses.
     * @alias module:keap.core.v2/model/BaseListResponsePipeline
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/BaseListResponsePipeline} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/BaseListResponsePipeline} The populated <code>BaseListResponsePipeline</code> instance.
     */
