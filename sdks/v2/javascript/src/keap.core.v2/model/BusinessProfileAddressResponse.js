 ...
 * @module keap.core.v2/model/BusinessProfileAddressResponse
 */
class BusinessProfileAddressResponse {
    /**
     * Constructs a new <code>BusinessProfileAddressResponse</code>.
     * @alias module:keap.core.v2/model/BusinessProfileAddressResponse
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/BusinessProfileAddressResponse} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/BusinessProfileAddressResponse} The populated <code>BusinessProfileAddressResponse</code> instance.
     */
