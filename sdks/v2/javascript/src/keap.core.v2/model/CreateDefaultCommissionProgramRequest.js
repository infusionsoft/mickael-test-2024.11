 ...
 * @module keap.core.v2/model/CreateDefaultCommissionProgramRequest
 */
class CreateDefaultCommissionProgramRequest {
    /**
     * Constructs a new <code>CreateDefaultCommissionProgramRequest</code>.
     * @alias module:keap.core.v2/model/CreateDefaultCommissionProgramRequest
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/CreateDefaultCommissionProgramRequest} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/CreateDefaultCommissionProgramRequest} The populated <code>CreateDefaultCommissionProgramRequest</code> instance.
     */
