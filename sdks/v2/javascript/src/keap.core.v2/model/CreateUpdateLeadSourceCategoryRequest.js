 ...
 * @module keap.core.v2/model/CreateUpdateLeadSourceCategoryRequest
 */
class CreateUpdateLeadSourceCategoryRequest {
    /**
     * Constructs a new <code>CreateUpdateLeadSourceCategoryRequest</code>.
     * @alias module:keap.core.v2/model/CreateUpdateLeadSourceCategoryRequest
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/CreateUpdateLeadSourceCategoryRequest} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/CreateUpdateLeadSourceCategoryRequest} The populated <code>CreateUpdateLeadSourceCategoryRequest</code> instance.
     */
