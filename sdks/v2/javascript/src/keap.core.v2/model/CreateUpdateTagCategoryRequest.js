 ...
 * @module keap.core.v2/model/CreateUpdateTagCategoryRequest
 */
class CreateUpdateTagCategoryRequest {
    /**
     * Constructs a new <code>CreateUpdateTagCategoryRequest</code>.
     * @alias module:keap.core.v2/model/CreateUpdateTagCategoryRequest
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/CreateUpdateTagCategoryRequest} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/CreateUpdateTagCategoryRequest} The populated <code>CreateUpdateTagCategoryRequest</code> instance.
     */
