 ...
 * @module keap.core.v2/model/CustomField
 */
class CustomField {
    /**
     * Constructs a new <code>CustomField</code>.
     * @alias module:keap.core.v2/model/CustomField
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/CustomField} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/CustomField} The populated <code>CustomField</code> instance.
     */
