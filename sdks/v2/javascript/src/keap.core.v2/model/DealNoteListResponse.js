 ...
 * @module keap.core.v2/model/DealNoteListResponse
 */
class DealNoteListResponse {
    /**
     * Constructs a new <code>DealNoteListResponse</code>.
     * Response model for a list of deal notes.
     * @alias module:keap.core.v2/model/DealNoteListResponse
     * @implements module:keap.core.v2/model/BaseListResponseDealNote
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/DealNoteListResponse} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/DealNoteListResponse} The populated <code>DealNoteListResponse</code> instance.
     */
 ...
 * @member {Array.<module:keap.core.v2/model/DealNote>} notes
 */
