 ...
 * @module keap.core.v2/model/ListAutomationCategoryResponse
 */
class ListAutomationCategoryResponse {
    /**
     * Constructs a new <code>ListAutomationCategoryResponse</code>.
     * @alias module:keap.core.v2/model/ListAutomationCategoryResponse
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/ListAutomationCategoryResponse} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/ListAutomationCategoryResponse} The populated <code>ListAutomationCategoryResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.core.v2/model/AutomationCategory>} automation_categories
 */
