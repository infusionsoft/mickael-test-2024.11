 ...
 * @module keap.core.v2/model/ListCompaniesResponse
 */
class ListCompaniesResponse {
    /**
     * Constructs a new <code>ListCompaniesResponse</code>.
     * @alias module:keap.core.v2/model/ListCompaniesResponse
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/ListCompaniesResponse} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/ListCompaniesResponse} The populated <code>ListCompaniesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.core.v2/model/Company>} companies
 */
