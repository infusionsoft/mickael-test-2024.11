 ...
 * @module keap.core.v2/model/ListFilesResponse
 */
class ListFilesResponse {
    /**
     * Constructs a new <code>ListFilesResponse</code>.
     * @alias module:keap.core.v2/model/ListFilesResponse
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/ListFilesResponse} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/ListFilesResponse} The populated <code>ListFilesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.core.v2/model/FileMetadata>} files
 */
