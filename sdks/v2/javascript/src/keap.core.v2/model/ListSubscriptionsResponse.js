 ...
 * @module keap.core.v2/model/ListSubscriptionsResponse
 */
class ListSubscriptionsResponse {
    /**
     * Constructs a new <code>ListSubscriptionsResponse</code>.
     * @alias module:keap.core.v2/model/ListSubscriptionsResponse
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/ListSubscriptionsResponse} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/ListSubscriptionsResponse} The populated <code>ListSubscriptionsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.core.v2/model/RestSubscriptionV2>} subscriptions
 */
