 ...
 * @module keap.core.v2/model/ListTasksResponse
 */
class ListTasksResponse {
    /**
     * Constructs a new <code>ListTasksResponse</code>.
     * @alias module:keap.core.v2/model/ListTasksResponse
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/ListTasksResponse} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/ListTasksResponse} The populated <code>ListTasksResponse</code> instance.
     */
...
/**
 * @member {Array.<module:keap.core.v2/model/Task>} tasks
 */
