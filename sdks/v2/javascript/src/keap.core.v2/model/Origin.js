 ...
 * @module keap.core.v2/model/Origin
 */
class Origin {
    /**
     * Constructs a new <code>Origin</code>.
     * @alias module:keap.core.v2/model/Origin
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/Origin} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/Origin} The populated <code>Origin</code> instance.
     */
