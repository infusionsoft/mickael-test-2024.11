...
class Owner {
     ...
     * @param {module:keap.core.v2/model/Owner} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/Owner} The populated <code>Owner</code> instance.
     */
