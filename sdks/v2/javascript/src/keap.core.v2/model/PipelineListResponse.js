 ...
 * @module keap.core.v2/model/PipelineListResponse
 */
class PipelineListResponse {
    /**
     * Constructs a new <code>PipelineListResponse</code>.
     * Response for a list of pipelines.
     * @alias module:keap.core.v2/model/PipelineListResponse
     * @implements module:keap.core.v2/model/BaseListResponsePipeline
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/PipelineListResponse} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/PipelineListResponse} The populated <code>PipelineListResponse</code> instance.
     */
 ...
 * @member {Array.<module:keap.core.v2/model/Pipeline>} pipelines
 */
