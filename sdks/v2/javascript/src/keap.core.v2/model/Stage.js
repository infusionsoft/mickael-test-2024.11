 ...
 * @module keap.core.v2/model/Stage
 */
class Stage {
    /**
     * Constructs a new <code>Stage</code>.
     * Represents a stage in a pipeline.
     * @alias module:keap.core.v2/model/Stage
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/Stage} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/Stage} The populated <code>Stage</code> instance.
     */
