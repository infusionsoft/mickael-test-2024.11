 ...
 * @module keap.core.v2/model/SubscriptionCommissionProgram
 */
class SubscriptionCommissionProgram {
    /**
     * Constructs a new <code>SubscriptionCommissionProgram</code>.
     * @alias module:keap.core.v2/model/SubscriptionCommissionProgram
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/SubscriptionCommissionProgram} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/SubscriptionCommissionProgram} The populated <code>SubscriptionCommissionProgram</code> instance.
     */
