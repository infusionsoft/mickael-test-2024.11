 ...
 * @module keap.core.v2/model/SubscriptionPlanInterest
 */
class SubscriptionPlanInterest {
    /**
     * Constructs a new <code>SubscriptionPlanInterest</code>.
     * @alias module:keap.core.v2/model/SubscriptionPlanInterest
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/SubscriptionPlanInterest} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/SubscriptionPlanInterest} The populated <code>SubscriptionPlanInterest</code> instance.
     */
