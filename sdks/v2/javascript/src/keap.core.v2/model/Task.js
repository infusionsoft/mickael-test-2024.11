 ...
 * @module keap.core.v2/model/Task
 */
class Task {
    /**
     * Constructs a new <code>Task</code>.
     * @alias module:keap.core.v2/model/Task
     */
    constructor() { 
     ...
     * @param {module:keap.core.v2/model/Task} obj Optional instance to populate.
     * @return {module:keap.core.v2/model/Task} The populated <code>Task</code> instance.
     */
...
/**
 * @member {module:keap.core.v2/model/Task.PriorityEnum} priority
 */
...
/**
 * @member {module:keap.core.v2/model/Task.TypeEnum} type
 */
