...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const FIELD_ADDRESS_FIELD_UNSPECIFIED = 'ADDRESS_FIELD_UNSPECIFIED';
    ...
    {
        return [
            self::FIELD_ADDRESS_FIELD_UNSPECIFIED,
            self::FIELD_BILLING,
            self::FIELD_SHIPPING,
            self::FIELD_OTHER,
        ];
    ...
    */
     ...
     * Sets country_code
     *
     * @param string|null $country_code An ISO 3166-2 Country Code (https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3)
     *
     * @return self
     */
     ...
     * Sets region_code
     *
     * @param string|null $region_code An ISO 3166-2 Province Code, such as one of the US States (https://en.wikipedia.org/wiki/ISO_3166-2:US)
     *
     * @return self
     */
