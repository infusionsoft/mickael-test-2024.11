...
/**
 * ApplicationConfigurationModuleAffiliateCommission Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationConfigurationModuleAffiliateCommission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationConfigurationModuleAffiliateCommission';
    ...
    protected static $setters = [
        ...
        'levels' => 'setLevels',
        'participant_types' => 'setParticipantTypes'
    ];
    ...
    protected static $getters = [
        ...
        'levels' => 'getLevels',
        'participant_types' => 'getParticipantTypes'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('participant_types', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets participant_types
     *
     * @return string|null
     */
    public function getParticipantTypes()
    {
        return $this->container['participant_types'];
    }

    /**
     * Sets participant_types
     *
     * @param string|null $participant_types participant_types
     *
     * @return self
     */
    public function setParticipantTypes($participant_types)
    {
        if (is_null($participant_types)) {
            throw new \InvalidArgumentException('non-nullable participant_types cannot be null');
        }
        $this->container['participant_types'] = $participant_types;
