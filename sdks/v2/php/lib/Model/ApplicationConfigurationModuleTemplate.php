...
/**
 * ApplicationConfigurationModuleTemplate Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationConfigurationModuleTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationConfigurationModuleTemplate';
    ...
    {
        $this->setIfExists('default_country_code', $data ?? [], null);
    ...
    */
     ...
     *
     * @param int|null $default_country_code default_country_code
     *
     * @return self
     */
    public function setDefaultCountryCode($default_country_code)
    {
        if (is_null($default_country_code)) {
            throw new \InvalidArgumentException('non-nullable default_country_code cannot be null');
        }
     ...
     *
     * @param string|null $default_user_id default_user_id
     *
     * @return self
     */
    public function setDefaultUserId($default_user_id)
    {
        if (is_null($default_user_id)) {
            throw new \InvalidArgumentException('non-nullable default_user_id cannot be null');
        }
