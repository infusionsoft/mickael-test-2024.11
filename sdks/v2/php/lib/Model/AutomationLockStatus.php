...
/**
 * AutomationLockStatus Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class AutomationLockStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AutomationLockStatus';
    ...
    protected static $setters = [
        'locked' => 'setLocked',
        'user_firstname' => 'setUserFirstname',
        'user_id' => 'setUserId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('user_firstname', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['user_firstname'];
    }

    /**
     * Sets user_firstname
     *
     * @param string|null $user_firstname user_firstname
     *
     * @return self
     */
    public function setUserFirstname($user_firstname)
    {
        if (is_null($user_firstname)) {
            throw new \InvalidArgumentException('non-nullable user_firstname cannot be null');
        }
        $this->container['user_firstname'] = $user_firstname;
