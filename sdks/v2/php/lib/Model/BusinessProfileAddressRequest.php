...
/**
 * BusinessProfileAddressRequest Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class BusinessProfileAddressRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessProfileAddressRequest';
    ...
    */
     ...
     * Sets country_code
     *
     * @param string $country_code An ISO 3166-1 Country Code (https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3)
     *
     * @return self
     */
     ...
     * Sets locality
     *
     * @param string $locality The municipality to which the address belongs
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string $region The long-name descriptive version of the Region Code
     *
     * @return self
     */
