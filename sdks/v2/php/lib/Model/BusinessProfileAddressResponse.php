...
/**
 * BusinessProfileAddressResponse Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class BusinessProfileAddressResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessProfileAddressResponse';
    ...
    */
     ...
     * Sets country_code
     *
     * @param string|null $country_code An ISO 3166-1 Country Code (https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3)
     *
     * @return self
     */
