...
/**
 * CreateCategoryDiscountRequest Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class CreateCategoryDiscountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCategoryDiscountRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_category_ids'] === null) {
            $invalidProperties[] = "'product_category_ids' can't be null";
        }
     ...
     *
     * @param string[] $product_category_ids product_category_ids
     *
     * @return self
     */
