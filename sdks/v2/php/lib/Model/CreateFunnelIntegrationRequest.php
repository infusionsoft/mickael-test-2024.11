...
class CreateFunnelIntegrationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'context' => 'string',
        'enabled' => 'bool',
        'funnel_integration_actions' => '\Keap\Core\V2\Model\FunnelIntegrationAction[]',
        'funnel_integration_triggers' => '\Keap\Core\V2\Model\FunnelIntegrationAction[]',
        'name' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \Keap\Core\V2\Model\FunnelIntegrationAction[]|null
     */
     ...
     *
     * @param \Keap\Core\V2\Model\FunnelIntegrationAction[]|null $funnel_integration_actions The list of actions that will be installed with the integration.
     *
     * @return self
     */
     ...
     *
     * @param \Keap\Core\V2\Model\FunnelIntegrationAction[]|null $funnel_integration_triggers The list of triggers that will be installed with the integration.
     *
     * @return self
     */
