...
/**
 * CreateRestOrderItemRequest Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class CreateRestOrderItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateRestOrderItemRequest';
    ...
    */
     ...
     * Sets price
     *
     * @param float|null $price Overridable price of the product. If not specified, the default will be used. Must be greater than or equal to 0.
     *
     * @return self
     */
     ...
     * Sets product_id
     *
     * @param string $product_id The id of the product to be added to the order.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int $quantity Quantity must be greater than or equal to 1
     *
     * @return self
     */
