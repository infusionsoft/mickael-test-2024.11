...
/**
 * CreateStageRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateStageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateStageRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateStageRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets pipeline_id
     *
     * @param string $pipeline_id The ID of the pipeline to which the stage belongs.
     *
     * @return self
     */
    public function setPipelineId($pipeline_id)
    {
        ...
        if ((mb_strlen($pipeline_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $pipeline_id when calling CreateStageRequest., must be bigger than or equal to 1.');
        }
