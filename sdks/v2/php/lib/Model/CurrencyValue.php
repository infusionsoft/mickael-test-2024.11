 ...
 */
class CurrencyValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CurrencyValue';
    ...
    */
     ...
     * Sets amount
     *
     * @param int|null $amount The price amount in the smallest currency unit
     *
     * @return self
     */
     ...
     * Sets currency_code
     *
     * @param string|null $currency_code Three-letter ISO currency code
     *
     * @return self
     */
     ...
     *
     * @param string|null $formatted_amount The product amount formatted using the tenant's currency locale
     *
     * @return self
     */
