...
class EmailSendRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets attachments
     *
     * @return \Keap\Core\V2\Model\EmailSendRequestAttachment[]|null
     */
     ...
     * Sets attachments
     *
     * @param \Keap\Core\V2\Model\EmailSendRequestAttachment[]|null $attachments Attachments to be sent with each copy of the email, maximum of 10 with size of 1MB each
     *
     * @return self
     */
     ...
     * Sets contacts
     *
     * @param string[] $contacts An array of Contact Ids to receive the email
     *
     * @return self
     */
     ...
     * Sets html_content
     *
     * @param string|null $html_content The HTML-formatted content of the email, encoded in Base64
     *
     * @return self
     */
     ...
     * Sets plain_content
     *
     * @param string|null $plain_content The plain-text content of the email, encoded in Base64
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param string $user_id The infusionsoft user to send the email on behalf of
     *
     * @return self
     */
