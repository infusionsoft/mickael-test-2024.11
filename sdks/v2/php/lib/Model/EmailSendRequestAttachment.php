...
/**
 * EmailSendRequestAttachment Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class EmailSendRequestAttachment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailSendRequestAttachment';
    ...
    */
     ...
     * Sets file_data
     *
     * @param string|null $file_data The content of the attachment, encoded in Base64
     *
     * @return self
     */
     ...
     * Sets file_name
     *
     * @param string|null $file_name The filename of the attached file, including extension
     *
     * @return self
     */
