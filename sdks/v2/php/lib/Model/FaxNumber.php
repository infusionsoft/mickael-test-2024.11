 ...
 */
class FaxNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FaxNumber';
    ...
    public const FIELD_FAX_NUMBER_FIELD_UNSPECIFIED = 'FAX_NUMBER_FIELD_UNSPECIFIED';
    public const FIELD_FAX1 = 'FAX1';
    public const FIELD_FAX2 = 'FAX2';
    ...
    {
        return [
            self::FIELD_FAX_NUMBER_FIELD_UNSPECIFIED,
            self::FIELD_FAX1,
            self::FIELD_FAX2,
        ];
    }
