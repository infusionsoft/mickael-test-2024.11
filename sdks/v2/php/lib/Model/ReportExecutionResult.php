...
class ReportExecutionResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'page_token' => 'string',
        'results' => '\Keap\Core\V2\Model\ReportEntryRecord[]'
    ];
    ...
    */
     ...
     * Gets results
     *
     * @return \Keap\Core\V2\Model\ReportEntryRecord[]|null
     */
     ...
     * Sets results
     *
     * @param \Keap\Core\V2\Model\ReportEntryRecord[]|null $results results
     *
     * @return self
     */
