...
class RestCreateOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'order_items' => '\Keap\Core\V2\Model\CreateRestOrderItemRequest[]',
        'order_time' => 'string',
        'order_title' => 'string',
        'order_type' => 'string',
        'promo_codes' => 'string[]',
    ...
    */
     ...
     * Gets order_items
     *
     * @return \Keap\Core\V2\Model\CreateRestOrderItemRequest[]
     */
     ...
     * Sets order_items
     *
     * @param \Keap\Core\V2\Model\CreateRestOrderItemRequest[] $order_items order_items
     *
     * @return self
     */
