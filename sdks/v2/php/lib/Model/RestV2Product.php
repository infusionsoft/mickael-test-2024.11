...
class RestV2Product implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'id' => 'string',
        'inventory' => '\Keap\Core\V2\Model\ProductInventory',
        'name' => 'string',
        'options' => '\Keap\Core\V2\Model\ProductOptions[]',
        ...
        'subscription_plans' => '\Keap\Core\V2\Model\SubscriptionPlan[]',
        'taxable' => 'bool',
        'weight' => 'float'
    ];
    ...
    */
     ...
     * Gets inventory
     *
     * @return \Keap\Core\V2\Model\ProductInventory|null
     */
     ...
     * Sets inventory
     *
     * @param \Keap\Core\V2\Model\ProductInventory|null $inventory inventory
     *
     * @return self
     */
     ...
     * Gets options
     *
     * @return \Keap\Core\V2\Model\ProductOptions[]|null
     */
     ...
     * Sets options
     *
     * @param \Keap\Core\V2\Model\ProductOptions[]|null $options List of product options. Can be empty.
     *
     * @return self
     */
     ...
     *
     * @param \Keap\Core\V2\Model\SubscriptionPlan[]|null $subscription_plans List of subscription plans associated with the product. Can be empty.
     *
     * @return self
     */
