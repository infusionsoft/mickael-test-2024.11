 ...
 */
class Sequence implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Sequence';
    ...
    protected static $openAPITypes = [
        ...
        'historical_contact_count' => '\Keap\Core\V2\Model\HistoricalCounts',
        'id' => 'string',
        'name' => 'string',
        'paths' => '\Keap\Core\V2\Model\SequencePath[]'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'active_contact_count_completed' => false,
        'historical_contact_count' => false,
        'id' => false,
        'name' => false,
        'paths' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('active_contact_count_completed', $data ?? [], null);
        $this->setIfExists('historical_contact_count', $data ?? [], null);
    ...
    */
     ...
     *
     * @param int|null $active_contact_count_completed active_contact_count_completed
     *
     * @return self
     */
    public function setActiveContactCountCompleted($active_contact_count_completed)
    {
        if (is_null($active_contact_count_completed)) {
            throw new \InvalidArgumentException('non-nullable active_contact_count_completed cannot be null');
        }
     ...
     *
     * @param \Keap\Core\V2\Model\HistoricalCounts|null $historical_contact_count historical_contact_count
     *
     * @return self
     */
    public function setHistoricalContactCount($historical_contact_count)
    {
        if (is_null($historical_contact_count)) {
            throw new \InvalidArgumentException('non-nullable historical_contact_count cannot be null');
        }
     ...
     * Gets paths
     *
     * @return \Keap\Core\V2\Model\SequencePath[]|null
     */
     ...
     * Sets paths
     *
     * @param \Keap\Core\V2\Model\SequencePath[]|null $paths paths
     *
     * @return self
     */
