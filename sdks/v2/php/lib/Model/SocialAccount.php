...
class SocialAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TYPE_SOCIAL_ACCOUNT_TYPE_UNSPECIFIED = 'SOCIAL_ACCOUNT_TYPE_UNSPECIFIED';
    public const TYPE_FACEBOOK = 'FACEBOOK';
    public const TYPE_LINKED_IN = 'LINKED_IN';
    public const TYPE_TWITTER = 'TWITTER';
    public const TYPE_INSTAGRAM = 'INSTAGRAM';
    public const TYPE_SNAPCHAT = 'SNAPCHAT';
    ...
    {
        return [
            self::TYPE_SOCIAL_ACCOUNT_TYPE_UNSPECIFIED,
            self::TYPE_FACEBOOK,
            self::TYPE_LINKED_IN,
            self::TYPE_TWITTER,
            self::TYPE_INSTAGRAM,
