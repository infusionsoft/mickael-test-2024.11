...
class StageDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'checklist_items' => '\Keap\Core\V2\Model\CheckListItemDetails[]',
        'probability' => 'int',
        'stage_order' => 'int',
        'target_num_days' => 'int'
    ];
    ...
    */
     ...
     *
     * @return \Keap\Core\V2\Model\CheckListItemDetails[]|null
     */
     ...
     *
     * @param \Keap\Core\V2\Model\CheckListItemDetails[]|null $checklist_items checklist_items
     *
     * @return self
     */
