...
/**
 * SubscriptionPlanInterest Class Doc Comment
 *
 * @category Class
 * @package  Keap\Core\V2
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionPlanInterest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionPlanInterest';
    ...
    */
     ...
     *
     * @param int|null $discount_percent The percent to discount the product. Percent represented in a whole number, for example 10 is 10%
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity The quantity of product.
     *
     * @return self
     */
