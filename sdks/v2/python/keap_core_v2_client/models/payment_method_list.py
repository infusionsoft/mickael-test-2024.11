...
class PaymentMethodList(BaseModel):
    ...
    records: Optional[List[RestPaymentMethod]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [RestPaymentMethod.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
