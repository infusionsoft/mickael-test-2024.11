...
class RestCreateOrderRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contact_id", "lead_affiliate_id", "order_items", "order_time", "order_title", "order_type", "promo_codes", "sales_affiliate_id", "shipping_address"]
