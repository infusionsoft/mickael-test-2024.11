    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "cycleType",
            "baseName": "cycle_type",
            "type": "CreateSubscriptionPlanRequestCycleTypeEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return CreateSubscriptionPlanRequest.attributeTypeMap;
    }
...
export enum CreateSubscriptionPlanRequestCycleTypeEnum {
    Daily = 'DAILY',
    Weekly = 'WEEKLY',
    Monthly = 'MONTHLY',
    Yearly = 'YEARLY'
